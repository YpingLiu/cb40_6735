            ...
            if (prBssInfo->eCurrentOPMode == OP_MODE_INFRASTRUCTURE) {
                ...
                if(prStaRec) {
                    for(eAci = 0; eAci < WMM_AC_INDEX_NUM; eAci++) {
                        prQueryBssStatistics->arLinkStatistics[eAci].u4TxMsdu = prStaRec->arLinkStatistics[eAci].u4TxMsdu;
                        prQueryBssStatistics->arLinkStatistics[eAci].u4RxMsdu = prStaRec->arLinkStatistics[eAci].u4RxMsdu;
                        prQueryBssStatistics->arLinkStatistics[eAci].u4TxDropMsdu =
                                    prStaRec->arLinkStatistics[eAci].u4TxDropMsdu + prBssInfo->arLinkStatistics[eAci].u4TxDropMsdu;
                        prQueryBssStatistics->arLinkStatistics[eAci].u4TxFailMsdu = prStaRec->arLinkStatistics[eAci].u4TxFailMsdu;
                    prQueryBssStatistics->arLinkStatistics[eAci].u4TxRetryMsdu = prStaRec->arLinkStatistics[eAci].u4TxRetryMsdu;
                    }        
                }
            }
...
VOID
wlanDumpBssStatistics(IN P_ADAPTER_T prAdapter,
        UINT_8 ucBssIdx)
{
    P_BSS_INFO_T prBssInfo;
	P_STA_RECORD_T prStaRec;
    ...
    if (prBssInfo->eCurrentOPMode == OP_MODE_INFRASTRUCTURE) {
        ...
        if(prStaRec) {
            for(eAci = 0; eAci < WMM_AC_INDEX_NUM; eAci++) {
                ...
                prBssInfo->arLinkStatistics[eAci].u4TxDropMsdu += prStaRec->arLinkStatistics[eAci].u4TxDropMsdu;  
                prBssInfo->arLinkStatistics[eAci].u4TxFailMsdu = prStaRec->arLinkStatistics[eAci].u4TxFailMsdu;
                prBssInfo->arLinkStatistics[eAci].u4TxRetryMsdu = prStaRec->arLinkStatistics[eAci].u4TxRetryMsdu; 
            }        
        }
    }
#else
			  ...
			  IN UINT_32 u4QueryBufferLen, OUT PUINT_32 pu4QueryInfoLen)
{
	...
	do {
        ...
        *pu4QueryInfoLen = sizeof(PARAM_GET_STA_STA_STATISTICS);
        ...
        for(eAci = 0; eAci < WMM_AC_INDEX_NUM; eAci++) {
            prQueryStaStatistics->arLinkStatistics[eAci].u4TxMsdu = prStaRec->arLinkStatistics[eAci].u4TxMsdu;
            prQueryStaStatistics->arLinkStatistics[eAci].u4RxMsdu = prStaRec->arLinkStatistics[eAci].u4RxMsdu;  
            prQueryStaStatistics->arLinkStatistics[eAci].u4TxDropMsdu = prStaRec->arLinkStatistics[eAci].u4TxDropMsdu;  
        }
