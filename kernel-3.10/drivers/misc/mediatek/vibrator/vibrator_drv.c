...
//////////@20160328 for battery led start
#ifdef CB04_6735_35U
static int poweroff_flag;
int get_poweroff_flag(void)
{
	return poweroff_flag;
}
void reset_poweroff_flag(void)
{
	poweroff_flag = 1;
	return ;
}
...
//////////@20160328 for battery led start
#ifdef CB04_6735_35U
//	printk("[vibrator][power-off]:shutdown_flag=%d,poweroff_flag=%d\n",shutdown_flag,poweroff_flag);
	if (value == 1) {
		poweroff_flag = poweroff_flag ? 0 : 1;
	}
#endif
//////////@20160328 for battery led end
