...
/////////@20160328 for battery led start
#ifndef CB04_6735_35U
#define CB04_6735_35U
#endif
/////////@20160328 for battery led end
...
unsigned long get_dim_layer_mva_addr(void)
{
    if(dim_layer_mva == 0){
        int frame_buffer_size =
                ALIGN_TO(DISP_GetScreenWidth(), MTK_FB_ALIGNMENT) * DISP_GetScreenHeight() * 4;
...
/////////@20160328 for battery led start
#ifdef CB04_6735_35U
extern void reset_poweroff_flag(void);
#endif
/////////@20160328 for battery led end
int primary_display_resume(void)
{
      ...
      DISPCHECK("ESD check start[end]\n");
        ...
        #ifdef CB04_6735_35U
        reset_poweroff_flag(); // reset power off flags
        #endif
...
int primary_display_switch_mode(int sess_mode, unsigned int session, int force)
{
    ...
    MMProfileLogEx(ddp_mmp_get_events()->primary_switch_mode, MMProfileFlagStart, pgc->session_mode, sess_mode);
        ...
        {
            #ifndef CONFIG_ICN6202   //henry add lvdstomipi
            /* dl to dc*/
