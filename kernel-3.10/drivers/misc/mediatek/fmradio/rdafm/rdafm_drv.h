...
//#define _IIC_GPIO_SIMULATOR_			1


#ifdef _IIC_GPIO_SIMULATOR_
/* GPIO definition */
#define RDA_I2C_SDA                     (GPIO114 | 0x80000000)              //I2C data pin
#define RDA_I2C_SCL                     (GPIO115 | 0x80000000)              //I2C clock pin

#else
//customer need customize the I2C channel
//#define RDA_I2C_CHANNEL          		0
#define RDA_I2C_CHANNEL          		3
