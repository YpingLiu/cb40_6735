...
#ifdef CONFIG_OF
static struct device_node *gpio_node = NULL;
static struct device_node *infracfg_ao_node = NULL;
static struct device_node *infracfg_node = NULL;
static struct device_node *pericfg_node = NULL;
static struct device_node *emi_node = NULL;
static struct device_node *toprgu_node = NULL;
static struct device_node *apmixed_node = NULL;
static struct device_node *topckgen_node = NULL;
...
#else
	sdr_write8(PWR_GPIO, (l_val & PWR_MASK_VOL_18_MASK & PWR_MASK_VOL_33_MASK & PWR_MASK_EN_MASK));
#endif
	l_val = sdr_read16(PWR_GPIO);
	pr_debug("[%s]: pwr gpio = 0x%x\n", __func__, l_val);
	return true;
...
void msdc_dump_padctl(struct msdc_host *host)
{
	switch (host->id) {
		case 0:
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_MODE18_ADDR,sdr_read32(MSDC0_GPIO_MODE18_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_MODE19_ADDR,sdr_read32(MSDC0_GPIO_MODE19_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_IES_G5_ADDR,sdr_read32(MSDC0_GPIO_IES_G5_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_SMT_G5_ADDR,sdr_read32(MSDC0_GPIO_SMT_G5_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_TDSEL0_G5_ADDR,sdr_read32(MSDC0_GPIO_TDSEL0_G5_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_RDSEL0_G5_ADDR,sdr_read32(MSDC0_GPIO_RDSEL0_G5_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_DRV0_G5_ADDR,sdr_read32(MSDC0_GPIO_DRV0_G5_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_PUPD0_G5_ADDR,sdr_read32(MSDC0_GPIO_PUPD0_G5_ADDR));
			pr_err("0:GPIO[%p]=0x%.8x\n",MSDC0_GPIO_PUPD1_G5_ADDR,sdr_read32(MSDC0_GPIO_PUPD1_G5_ADDR));
			break;
		case 1:
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_MODE17_ADDR,sdr_read32(MSDC1_GPIO_MODE17_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_MODE18_ADDR,sdr_read32(MSDC1_GPIO_MODE18_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_IES_G4_ADDR,sdr_read32(MSDC1_GPIO_IES_G4_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_SMT_G4_ADDR,sdr_read32(MSDC1_GPIO_SMT_G4_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_TDSEL0_G4_ADDR,sdr_read32(MSDC1_GPIO_TDSEL0_G4_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_RDSEL0_G4_ADDR,sdr_read32(MSDC1_GPIO_RDSEL0_G4_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_DRV0_G4_ADDR,sdr_read32(MSDC1_GPIO_DRV0_G4_ADDR));
			pr_err("1:GPIO[%p]=0x%.8x\n",MSDC1_GPIO_PUPD0_G4_ADDR,sdr_read32(MSDC1_GPIO_PUPD0_G4_ADDR));
			break;
#ifdef CFG_DEV_MSDC2
		case 2:
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_MODE20_ADDR,sdr_read32(MSDC2_GPIO_MODE20_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_MODE21_ADDR,sdr_read32(MSDC2_GPIO_MODE21_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_IES_G0_ADDR,sdr_read32(MSDC2_GPIO_IES_G0_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_SMT_G0_ADDR,sdr_read32(MSDC2_GPIO_SMT_G0_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_TDSEL0_G0_ADDR,sdr_read32(MSDC2_GPIO_TDSEL0_G0_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_RDSEL0_G0_ADDR,sdr_read32(MSDC2_GPIO_RDSEL0_G0_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_DRV0_G0_ADDR,sdr_read32(MSDC2_GPIO_DRV0_G0_ADDR));
			pr_err("2:GPIO[%p]=0x%.8x\n",MSDC2_GPIO_PUPD0_G0_ADDR,sdr_read32(MSDC2_GPIO_PUPD0_G0_ADDR));
			break;
#endif
	}
}
...
void msdc_dump_register(struct msdc_host *host)
{
    ...
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_CFG,       sdr_read32(MSDC_CFG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_IOCON,     sdr_read32(MSDC_IOCON));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_PS,        sdr_read32(MSDC_PS));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_INT,       sdr_read32(MSDC_INT));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_INTEN,     sdr_read32(MSDC_INTEN));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_FIFOCS,    sdr_read32(MSDC_FIFOCS));
    SIMPLE_INIT_MSG("R[%x]=not read", OFFSET_MSDC_TXDATA);
    SIMPLE_INIT_MSG("R[%x]=not read", OFFSET_MSDC_RXDATA);
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_CFG,        sdr_read32(SDC_CFG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_CMD,        sdr_read32(SDC_CMD));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_ARG,        sdr_read32(SDC_ARG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_STS,        sdr_read32(SDC_STS));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_RESP0,      sdr_read32(SDC_RESP0));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_RESP1,      sdr_read32(SDC_RESP1));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_RESP2,      sdr_read32(SDC_RESP2));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_RESP3,      sdr_read32(SDC_RESP3));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_BLK_NUM,    sdr_read32(SDC_BLK_NUM));
	SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_VOL_CHG,    sdr_read32(SDC_VOL_CHG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_CSTS,       sdr_read32(SDC_CSTS));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_CSTS_EN,    sdr_read32(SDC_CSTS_EN));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_DCRC_STS,   sdr_read32(SDC_DCRC_STS));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC_CFG0,      sdr_read32(EMMC_CFG0));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC_CFG1,      sdr_read32(EMMC_CFG1));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC_STS,       sdr_read32(EMMC_STS));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC_IOCON,     sdr_read32(EMMC_IOCON));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_ACMD_RESP,  sdr_read32(SDC_ACMD_RESP));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_ACMD19_TRG, sdr_read32(SDC_ACMD19_TRG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDC_ACMD19_STS, sdr_read32(SDC_ACMD19_STS));
	SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DMA_SA_HIGH4BIT, sdr_read32(MSDC_DMA_SA_HIGH4BIT));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DMA_SA,    sdr_read32(MSDC_DMA_SA));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DMA_CA,    sdr_read32(MSDC_DMA_CA));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DMA_CTRL,  sdr_read32(MSDC_DMA_CTRL));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DMA_CFG,   sdr_read32(MSDC_DMA_CFG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DMA_LEN,   sdr_read32(MSDC_DMA_LEN));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DBG_SEL,   sdr_read32(MSDC_DBG_SEL));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DBG_OUT,   sdr_read32(MSDC_DBG_OUT));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_PATCH_BIT0,sdr_read32(MSDC_PATCH_BIT0));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_PATCH_BIT1,sdr_read32(MSDC_PATCH_BIT1));
	SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_PATCH_BIT2,sdr_read32(MSDC_PATCH_BIT2));

    if ( (host->id == 2) || (host->id == 3) ) {
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_DAT0_TUNE_CRC,sdr_read32(DAT0_TUNE_CRC));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_DAT0_TUNE_CRC,sdr_read32(DAT1_TUNE_CRC));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_DAT0_TUNE_CRC,sdr_read32(DAT2_TUNE_CRC));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_DAT0_TUNE_CRC,sdr_read32(DAT3_TUNE_CRC));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_CMD_TUNE_CRC,sdr_read32(CMD_TUNE_CRC));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_SDIO_TUNE_WIND,sdr_read32(SDIO_TUNE_WIND));
    }

    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_PAD_TUNE0,  sdr_read32(MSDC_PAD_TUNE0));
	SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_PAD_TUNE1,  sdr_read32(MSDC_PAD_TUNE1));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DAT_RDDLY0,sdr_read32(MSDC_DAT_RDDLY0));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DAT_RDDLY1,sdr_read32(MSDC_DAT_RDDLY1));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DAT_RDDLY2,sdr_read32(MSDC_DAT_RDDLY2));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_DAT_RDDLY3,sdr_read32(MSDC_DAT_RDDLY3));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_HW_DBG,    sdr_read32(MSDC_HW_DBG));
    SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_MSDC_VERSION,   sdr_read32(MSDC_VERSION));
    if(host->id == 0) {
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_PAD_DS_TUNE,     sdr_read32(EMMC50_PAD_DS_TUNE));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_PAD_CMD_TUNE,    sdr_read32(EMMC50_PAD_CMD_TUNE));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_PAD_DAT01_TUNE,  sdr_read32(EMMC50_PAD_DAT01_TUNE));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_PAD_DAT23_TUNE,  sdr_read32(EMMC50_PAD_DAT23_TUNE));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_PAD_DAT45_TUNE,  sdr_read32(EMMC50_PAD_DAT45_TUNE));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_PAD_DAT67_TUNE,  sdr_read32(EMMC50_PAD_DAT67_TUNE));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_CFG0,            sdr_read32(EMMC50_CFG0));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_CFG1,            sdr_read32(EMMC50_CFG1));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_CFG2,            sdr_read32(EMMC50_CFG2));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_CFG3,            sdr_read32(EMMC50_CFG3));
        SIMPLE_INIT_MSG("R[%x]=0x%.8x", OFFSET_EMMC50_CFG4,            sdr_read32(EMMC50_CFG4));
    }
}
...
static void msdc_dump_clock_sts(struct msdc_host *host)
{
	...
	if(apmixed_reg_base1 && topckgen_reg_base && pericfg_reg_base){ 
		pr_err(" MSDCPLL_PWR_CON0[0x%p][bit0~1 should be 2b'01]=0x%x\n", 
			(apmixed_reg_base1 + MSDC_MSDCPLL_PWR_CON0_OFFSET),sdr_read32(apmixed_reg_base1 + MSDC_MSDCPLL_PWR_CON0_OFFSET));
		pr_err(" MSDCPLL_CON0    [0x%p][bit0 should be 1b'1]=0x%x\n", 
			(apmixed_reg_base1 + MSDC_MSDCPLL_CON0_OFFSET),sdr_read32(apmixed_reg_base1 + MSDC_MSDCPLL_CON0_OFFSET));
		pr_err(" CLK_CFG_2       [0x%p][bit[31:24]should be 0x01]=0x%x\n", 
			(topckgen_reg_base + MSDC_CLK_CFG_2_OFFSET),sdr_read32(topckgen_reg_base + MSDC_CLK_CFG_2_OFFSET));
		pr_err(" CLK_CFG_3       [0x%p][bit[15:0]should be 0x0202]=0x%x\n", 
			(topckgen_reg_base + MSDC_CLK_CFG_3_OFFSET),sdr_read32(topckgen_reg_base + MSDC_CLK_CFG_3_OFFSET));
		pr_err(" PERI_PDN_STA0   [0x%p][bit13=msdc0, bit14=msdc1,0:on,1:off]=0x%x\n",
			(pericfg_reg_base + MSDC_PERI_PDN_STA0_OFFSET), sdr_read32(pericfg_reg_base + MSDC_PERI_PDN_STA0_OFFSET));
	}else
...
static void msdc_dump_ldo_sts(struct msdc_host *host)
{
    ...
    switch(host->id){
        case 0:
            ...
            SIMPLE_INIT_MSG(" VEMC_EN[0x0A24]=0x%x, should:bit1=1, VEMC_VOL[0x0A64]=0x%x,should:[bit[5:4]=2b'10]\n", ldo_en, ldo_vol);
            break;
        case 1:
            pwrap_read( 0x0A20, &ldo_en );
            pwrap_read( 0x0A6A, &ldo_vol );
            SIMPLE_INIT_MSG(" VMC_EN[0x0A20]=0x%x,  should:bit1=1, VMC_VOL[0x0A6A]=0x%x,should:bit[5:4]=2b'11(3.3V),2b'00(1.8V)\n", ldo_en, ldo_vol);
            pwrap_read( 0x0A1C, &ldo_en );
            pwrap_read( 0x0A66, &ldo_vol );
            SIMPLE_INIT_MSG(" VMCH_EN[0x0A1C]==0x%x,should:bit1=1, VMCH_VOL[0x0A66]=0x%x,should:bit[5:4]=2b'10(3.3V)\n", ldo_en, ldo_vol);
            break;
        default:
            break;
    }
...
static void dump_emi_info(void)
{
	...
	if(emi_reg_base){
		pr_err("=============== EMI INFO ============="); 
		pr_err("before, reg[0x102034e8]=0x%x", sdr_read32(emi_reg_base + 0x4e8));  
		pr_err("before, reg[0x10203400]=0x%x", sdr_read32(emi_reg_base + 0x400));	
		...
		for(i = 0; i < 5; i++){
			for(addr = 0; addr < 0x78; addr += 4){
				pr_err("reg[0x%x]=0x%x", (0x10203500 + addr), sdr_read32((emi_reg_base + 0x500 + addr))); 
				if(addr % 0x10 == 0) 
					mdelay(1);
			}
		}
...
#ifndef FPGA_PLATFORM
//extern bool hwPowerSetVoltage(MT65XX_POWER powerId,int powerVOlt,char*mode_name);
...
void msdc_set_pin_mode(struct msdc_host *host)
{
	switch(host->id){
		case 0:
			sdr_set_field(MSDC0_GPIO_MODE18_ADDR,MSDC0_MODE_CMD_MASK | MSDC0_MODE_DSL_MASK| MSDC0_MODE_CLK_MASK | \
						  MSDC0_MODE_DAT0_MASK | MSDC0_MODE_DAT1_MASK | MSDC0_MODE_DAT2_MASK | MSDC0_MODE_DAT3_MASK	| \
						  MSDC0_MODE_DAT4_MASK,0x492449);
			sdr_set_field(MSDC0_GPIO_MODE19_ADDR,MSDC0_MODE_DAT5_MASK | MSDC0_MODE_DAT6_MASK | MSDC0_MODE_DAT7_MASK | \
						  MSDC0_MODE_RSTB_MASK, 0x249);
			break;
		case 1:
			sdr_set_field(MSDC1_GPIO_MODE17_ADDR,MSDC1_MODE_CMD_MASK | MSDC1_MODE_CLK_MASK | MSDC1_MODE_DAT0_MASK | \
						  MSDC1_MODE_DAT1_MASK, 0x249);
			sdr_set_field(MSDC1_GPIO_MODE18_ADDR,MSDC1_MODE_DAT2_MASK | MSDC1_MODE_DAT2_MASK, 0x9);
			break;
#ifdef CFG_DEV_MSDC2 //FIXME: For 6630

		case 2:
			sdr_set_field(MSDC2_GPIO_MODE20_ADDR,MSDC2_MODE_CMD_MASK | MSDC2_MODE_CLK_MASK , 0x9);
			sdr_set_field(MSDC2_GPIO_MODE21_ADDR,MSDC2_MODE_DAT0_MASK | MSDC2_MODE_DAT1_MASK |MSDC2_MODE_DAT2_MASK | \
...
void msdc_set_ies(struct msdc_host *host)
{
	switch(host->id){
		case 0:
			sdr_set_field(MSDC0_GPIO_IES_G5_ADDR,MSDC0_IES_ALL_MASK,0x1F);
			break;
		case 1:
			sdr_set_field(MSDC1_GPIO_IES_G4_ADDR,MSDC1_IES_ALL_MASK,0x7);
			break;
#ifdef CFG_DEV_MSDC2 //FIXME: For 6630
		case 2:
			sdr_set_field(MSDC2_GPIO_IES_G0_ADDR,MSDC2_IES_ALL_MASK,0x7);
			break;
#endif
		default:
			pr_err("error...[%s] host->id out of range!!!\n",__func__);
...
void msdc_set_tdsel(struct msdc_host *host, bool sleep)
{
	switch(host->id){
		...
		case 1:
			if(sleep)
				sdr_set_field(MSDC1_GPIO_TDSEL0_G4_ADDR,MSDC1_TDSEL_ALL_MASK,0xFFF);
			else
				sdr_set_field(MSDC1_GPIO_TDSEL0_G4_ADDR,MSDC1_TDSEL_ALL_MASK,0xAAA);
			break;
#ifdef CFG_DEV_MSDC2 //FIXME: For 6630
	...
	switch(host->id){
		...
		case 1:
			if(sd_18)
				...
				sdr_set_field(MSDC1_GPIO_RDSEL0_G4_ADDR,MSDC1_RDSEL_ALL_MASK,0xC30C);
			break;
#ifdef CFG_DEV_MSDC2 //FIXME: For 6630
...
void msdc_set_rdtdsel_dbg(struct msdc_host *host, bool rdsel, u32 value)
{
	if(rdsel){
		switch(host->id){
			case 0:
				sdr_set_field(MSDC0_GPIO_RDSEL0_G5_ADDR,MSDC0_RDSEL_CMD_MASK,value);
				sdr_set_field(MSDC0_GPIO_RDSEL0_G5_ADDR,MSDC0_RDSEL_DSL_MASK,value);
				sdr_set_field(MSDC0_GPIO_RDSEL0_G5_ADDR,MSDC0_RDSEL_CLK_MASK,value);
				sdr_set_field(MSDC0_GPIO_RDSEL0_G5_ADDR,MSDC0_RDSEL_DAT_MASK,value);
				sdr_set_field(MSDC0_GPIO_RDSEL0_G5_ADDR,MSDC0_RDSEL_RSTB_MASK,value);
				break;
			case 1:
				sdr_set_field(MSDC1_GPIO_RDSEL0_G4_ADDR,MSDC1_RDSEL_CMD_MASK,value);
				sdr_set_field(MSDC1_GPIO_RDSEL0_G4_ADDR,MSDC1_RDSEL_CLK_MASK,value);
				sdr_set_field(MSDC1_GPIO_RDSEL0_G4_ADDR,MSDC1_RDSEL_DAT_MASK,value);
				break;
			case 2:
				sdr_set_field(MSDC2_GPIO_RDSEL0_G0_ADDR,MSDC2_RDSEL_CMD_MASK,value);
				sdr_set_field(MSDC2_GPIO_RDSEL0_G0_ADDR,MSDC2_RDSEL_CLK_MASK,value);
				sdr_set_field(MSDC2_GPIO_RDSEL0_G0_ADDR,MSDC2_RDSEL_DAT_MASK,value);
				break;
		}
	}else{
		switch(host->id){
			case 0:
				sdr_set_field(MSDC0_GPIO_TDSEL0_G5_ADDR,MSDC0_TDSEL_CMD_MASK,value);
				sdr_set_field(MSDC0_GPIO_TDSEL0_G5_ADDR,MSDC0_TDSEL_DSL_MASK,value);
				sdr_set_field(MSDC0_GPIO_TDSEL0_G5_ADDR,MSDC0_TDSEL_CLK_MASK,value);
				sdr_set_field(MSDC0_GPIO_TDSEL0_G5_ADDR,MSDC0_TDSEL_DAT_MASK,value);
				sdr_set_field(MSDC0_GPIO_TDSEL0_G5_ADDR,MSDC0_TDSEL_RSTB_MASK,value);
				break;
			case 1:
				sdr_set_field(MSDC1_GPIO_TDSEL0_G4_ADDR,MSDC1_TDSEL_CMD_MASK,value);
				sdr_set_field(MSDC1_GPIO_TDSEL0_G4_ADDR,MSDC1_TDSEL_CLK_MASK,value);
				sdr_set_field(MSDC1_GPIO_TDSEL0_G4_ADDR,MSDC1_TDSEL_DAT_MASK,value);
				break;
			case 2:
				sdr_set_field(MSDC2_GPIO_TDSEL0_G0_ADDR,MSDC2_TDSEL_CMD_MASK,value);
				sdr_set_field(MSDC2_GPIO_TDSEL0_G0_ADDR,MSDC2_TDSEL_CLK_MASK,value);
				sdr_set_field(MSDC2_GPIO_TDSEL0_G0_ADDR,MSDC2_TDSEL_DAT_MASK,value);
				break;
		}
	}
}
void msdc_get_rdtdsel_dbg(struct msdc_host *host, bool rdsel, u32 *value)
{
	if(rdsel){
		switch(host->id){
			case 0:
				sdr_get_field(MSDC0_GPIO_RDSEL0_G5_ADDR,MSDC0_RDSEL_CMD_MASK,*value);
				break;
			case 1:
				sdr_get_field(MSDC1_GPIO_RDSEL0_G4_ADDR,MSDC1_RDSEL_CMD_MASK,*value);
				break;
			case 2:
				sdr_get_field(MSDC2_GPIO_RDSEL0_G0_ADDR,MSDC2_RDSEL_CMD_MASK,*value);
				break;
		}
	}else{
		switch(host->id){
			case 0:
				sdr_get_field(MSDC0_GPIO_TDSEL0_G5_ADDR,MSDC0_TDSEL_CMD_MASK,*value);
				break;
			case 1:
				sdr_get_field(MSDC1_GPIO_TDSEL0_G4_ADDR,MSDC1_TDSEL_CMD_MASK,*value);
				break;
			case 2:
				sdr_get_field(MSDC2_GPIO_TDSEL0_G0_ADDR,MSDC2_TDSEL_CMD_MASK,*value);
				break;
		}
	}
}
...
void msdc_set_driving(struct msdc_host *host, struct msdc_hw *hw, bool sd_18)
{
	switch(host->id){
		case 0:
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_CMD_MASK,hw->cmd_drv);
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_DSL_MASK,hw->ds_drv);
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_CLK_MASK,hw->clk_drv);
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_DAT_MASK,hw->dat_drv);
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_RSTB_MASK,hw->rst_drv);
			break;
		case 1:
			if(sd_18){
				sdr_set_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_CMD_MASK,hw->cmd_drv_sd_18);
				sdr_set_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_CLK_MASK,hw->clk_drv_sd_18);
				sdr_set_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_DAT_MASK,hw->dat_drv_sd_18);
			} else {
				sdr_set_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_CMD_MASK,hw->cmd_drv);
				sdr_set_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_CLK_MASK,hw->clk_drv);
				sdr_set_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_DAT_MASK,hw->dat_drv);
			}
			break;
#ifdef CFG_DEV_MSDC2
		case 2:
			sdr_set_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_CMD_MASK,hw->cmd_drv);
			sdr_set_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_CLK_MASK,hw->clk_drv);
			sdr_set_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_DAT_MASK,hw->dat_drv);
			break;
...
void msdc_get_driving(struct msdc_host *host, struct msdc_ioctl *msdc_ctl)
{
	switch(host->id){
		case 0:
			sdr_get_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_CMD_MASK,msdc_ctl->cmd_pu_driving);
			sdr_get_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_DSL_MASK,msdc_ctl->ds_pu_driving);
			sdr_get_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_CLK_MASK,msdc_ctl->clk_pu_driving);
			sdr_get_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_DAT_MASK,msdc_ctl->dat_pu_driving);
			sdr_get_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_RSTB_MASK,msdc_ctl->rst_pu_driving);
			break;
		case 1:
			sdr_get_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_CMD_MASK,msdc_ctl->cmd_pu_driving);
			sdr_get_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_CLK_MASK,msdc_ctl->clk_pu_driving);
			sdr_get_field(MSDC1_GPIO_DRV0_G4_ADDR,MSDC1_DRV_DAT_MASK,msdc_ctl->dat_pu_driving);
			msdc_ctl->rst_pu_driving = 0;
			msdc_ctl->ds_pu_driving = 0;
			break;
#ifdef CFG_DEV_MSDC2 //FIXME: For 6630
		case 2:
			sdr_get_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_CMD_MASK,msdc_ctl->cmd_pu_driving);
			sdr_get_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_CLK_MASK,msdc_ctl->clk_pu_driving);
			sdr_get_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_DAT_MASK,msdc_ctl->dat_pu_driving);
			msdc_ctl->rst_pu_driving = 0;
			msdc_ctl->ds_pu_driving = 0;
			break;
#endif
	...
	switch(host->id){
		case 0:
			if(MSDC_PIN_PULL_NONE == mode){			// high-Z
				sdr_set_field(MSDC0_GPIO_PUPD0_G5_ADDR,MSDC0_PUPD_CMD_DSL_CLK_DAT04_MASK,0x44444444);
				sdr_set_field(MSDC0_GPIO_PUPD1_G5_ADDR,MSDC0_PUPD_DAT567_MASK,0x444);
			} else if(MSDC_PIN_PULL_DOWN == mode){	// cmd/clk/dat/(rstb)/dsl:pd-50k
				sdr_set_field(MSDC0_GPIO_PUPD0_G5_ADDR,MSDC0_PUPD_CMD_DSL_CLK_DAT04_MASK,0x66666666);
				sdr_set_field(MSDC0_GPIO_PUPD1_G5_ADDR,MSDC0_PUPD_DAT567_MASK,0x666);

			} else if(MSDC_PIN_PULL_UP == mode){		// clk/dsl:pd-50k, cmd/dat:pu-10k, (rstb:pu-50k)
				sdr_set_field(MSDC0_GPIO_PUPD0_G5_ADDR,MSDC0_PUPD_CMD_DSL_CLK_DAT04_MASK,0x11111661);
				sdr_set_field(MSDC0_GPIO_PUPD1_G5_ADDR,MSDC0_PUPD_DAT567_MASK,0x111);
			}
			break;
		case 1:
			if(MSDC_PIN_PULL_NONE == mode){			// high-Z
				sdr_set_field(MSDC1_GPIO_PUPD0_G4_ADDR,MSDC1_PUPD_CMD_CLK_DAT_MASK,0x444444);
			} else if(MSDC_PIN_PULL_DOWN == mode){	// cmd/clk/dat:pd-50k
				sdr_set_field(MSDC1_GPIO_PUPD0_G4_ADDR,MSDC1_PUPD_CMD_CLK_DAT_MASK,0x666666);
		...
		case 2:
			if(MSDC_PIN_PULL_NONE == mode){			// high-Z
				sdr_set_field(MSDC2_GPIO_PUPD0_G0_ADDR,MSDC2_PUPD_CMD_CLK_DAT_MASK,0x444444);
			} else if(MSDC_PIN_PULL_DOWN == mode){	// cmd/clk/dat:pd-50k
				sdr_set_field(MSDC2_GPIO_PUPD0_G0_ADDR,MSDC2_PUPD_CMD_CLK_DAT_MASK,0x666666);
			} else if(MSDC_PIN_PULL_UP == mode){		// cmd/dat:pu-50k, clk:pd-50k, 
				sdr_set_field(MSDC2_GPIO_PUPD0_G0_ADDR,MSDC2_PUPD_CMD_CLK_DAT_MASK,0x222262);
			}
			break;
    ...
    switch(host->id){
        case 1:
            ...
            if (host->hw->flags & MSDC_SD_NEED_POWER)
                msdc_ldo_power(1, MT6328_POWER_LDO_VMCH, VOL_3000, &g_msdc1_flash);
            else
                msdc_ldo_power(on, MT6328_POWER_LDO_VMCH, VOL_3000, &g_msdc1_flash);
	    msdc_ldo_power(on, MT6328_POWER_LDO_VMC, VOL_3000, &g_msdc1_io);
	    if (on)
        ...
        case 2:
            msdc_set_driving(host,host->hw,0);
			msdc_set_rdsel(host,0);
            msdc_ldo_power(on, MT6328_POWER_LDO_VMC, VOL_3000, &g_msdc2_io);
            msdc_ldo_power(on, MT6328_POWER_LDO_VMCH, VOL_3000, &g_msdc2_flash);
            break;
        default:
            break;
    }
    ...
    switch(host->id){
        ...
        case 2:
            if(MSDC_VIO18_MC2 == host->power_domain) {
                if(on) {
#if 0 //CHECK ME
                    msdc_ldo_power(on, MT_POWER_LDO_VGP6, VOL_1800, &g_msdc2_io); // Bus & device keeps 1.8v
#endif
                } else {
#if 0 //CHECK ME
                    msdc_ldo_power(on, MT_POWER_LDO_VGP6, VOL_3000, &g_msdc2_io); // Bus & device keeps 3.3v
#endif
                }

            } else if(MSDC_VIO28_MC2 == host->power_domain) {
                //msdc_ldo_power(on, MT_POWER_LDO_VIO28, VOL_2800, &g_msdc2_io); // Bus & device keeps 2.8v
            }
...
#define msdc_set_vol_change_wait_count(count) \
    do { \
        sdr_set_field(SDC_VOL_CHG,SDC_VOL_CHG_CNT, (count)); \
    } while(0)
...
static noinline void sdio_set_vcore_performance(struct msdc_host *host, u32 enable) 
{
	
	if(atomic_read(&host->ot_work.ot_disable)){ //TODO: also return here when clock rate is not 200MHz
		//pr_info("sdio_set_vcore_performance auto-K haven't done\n");
		return;
	}

	//pr_info("** sdio_set_vcore_performance() enable:%d id:%d irqs_disabled():%d in_atomic():%d autok_done: %d ot_disable: %d\n",enable, host->id,irqs_disabled(),in_atomic(),atomic_read(&host->ot_work.autok_done),atomic_read(&host->ot_work.ot_disable));
	//mmc_claim_host(host->mmc);
	...
	if(enable){
		...
		if( cancel_delayed_work_sync(&(host->set_vcore_workq)) == 0){ //true if dwork was pending, false otherwise
	...
	if (mmc_card_sd(card) && (host->hw->host_function == MSDC_SD)) {
		if ((host->power_cycle < MSDC_MAX_POWER_CYCLE) && (host->power_cycle_enable)) {
			...
			host->continuous_fail_request_count++;
                	ERR_MSG("Host continuous fail request count <%d>\n", host->continuous_fail_request_count);
		} else {
			ERR_MSG(
...
static u32 msdc_status_verify_case1(struct msdc_host *host, struct mmc_command *cmd)
{
	struct mmc_host *mmc = host->mmc;
	u32 status = 0;
	u32 state = 0;
...
static u32 msdc_status_verify_case2(struct msdc_host *host, struct mmc_command *cmd)
{
	struct mmc_host *mmc = host->mmc;
	u32 status = 0;
	u32 state = 0;
	...
	if(cmd->arg == card->rca << 16){
		return (3 == state || 8 == state) ? MSDC_VERIFY_NEED_TUNE : MSDC_VERIFY_NEED_NOT_TUNE;
	}else{
		return (4 == state || 5 == state || 6 == state || 7 == state) ? MSDC_VERIFY_NEED_TUNE : MSDC_VERIFY_NEED_NOT_TUNE; 
	}
}

static u32 msdc_status_verify_case3(struct msdc_host *host, struct mmc_command *cmd)
{
	struct mmc_host *mmc = host->mmc;
	u32 status = 0;
	u32 state = 0;
	...
	state = R1_CURRENT_STATE(status);
	return (5 == state || 6 == state) ? MSDC_VERIFY_NEED_TUNE : MSDC_VERIFY_NEED_NOT_TUNE; 
}

static u32 msdc_status_verify_case4(struct msdc_host *host, struct mmc_command *cmd)
{
	struct mmc_host *mmc = host->mmc;
	u32 status = 0;
	u32 state = 0;
...
#if 0
static u32 msdc_status_verify_case5(struct msdc_host *host, struct mmc_command *cmd)
{
	struct mmc_host *mmc = host->mmc;
	u32 status = 0;
	u32 state = 0;
...
static u32 msdc_status_verify(struct msdc_host *host, struct mmc_command *cmd){
	if(!host->mmc || !host->mmc->card || !host->mmc->card->rca){ //card is not identify
		return MSDC_VERIFY_NEED_TUNE;
	}
	
	if(((host->hw->host_function == MSDC_EMMC) && IS_IN_CMD_SET(cmd->opcode, CMD_SET_FOR_MMC_TUNE_CASE1))
		|| ((host->hw->host_function == MSDC_SD) && IS_IN_CMD_SET(cmd->opcode, CMD_SET_FOR_SD_TUNE_CASE1))
		|| (host->app_cmd && IS_IN_CMD_SET(cmd->opcode, CMD_SET_FOR_APP_TUNE_CASE1))){
	...
	}else if((host->hw->host_function == MSDC_EMMC) && IS_IN_CMD_SET(cmd->opcode, CMD_SET_FOR_MMC_TUNE_CASE4)){
		return msdc_status_verify_case4(host, cmd);
#if 0
	}else if((host->hw->host_function == MSDC_EMMC) && IS_IN_CMD_SET(cmd->opcode, CMD_SET_FOR_MMC_TUNE_CASE5)){
...
stop:
	...
	if (mrq->cmd->error == (unsigned int)-EIO) {
		if(((cmd->opcode == MMC_SELECT_CARD) || (cmd->opcode == MMC_SLEEP_AWAKE)) &&
			 ...
			 /* should be deleted in new platform, as the state verify function has applied*/
			mrq->cmd->error = 0x0;
		} else {
...
int hs400_restore_cmd_tune(int restore)
{
	...
	if (mtk_msdc_host[0]) {
		base = mtk_msdc_host[0]->base;
		if (!restore) {
			sdr_set_field(EMMC50_PAD_CMD_TUNE, MSDC_EMMC50_PAD_CMD_TUNE_TXDLY, 0x4);
		}
	}
	return 0;
}
...
static void emmc_clear_timing(void)
{
    ...
    for(i = 0; i < HS400_BACKUP_REG_NUM; i++)
    {
        sdr_set_field((hs400_backup_reg_list[i].addr+mtk_msdc_host[0]->base), hs400_backup_reg_list[i].mask,  hs400_backup_reg_list[i].default_value);
    }
...
int msdc_tune_write(struct msdc_host *host)
{
	...
	if (orig_dsmpl == 0) {
		...
		if (cur_wrrdly < 32) {
			...
			cur_wrrdly = 0;
            sdr_set_field(MSDC_PAD_TUNE0, MSDC_PAD_TUNE0_DATWRDLY, cur_wrrdly);  // need third
								  ...
								  struct mmc_command *sbc)
{
        ...
        ((cmd->error == -EIO) || (data->error == -EIO)))
    {
        ...
        //ccyeh@FIXME int cur_temperature = mtk_thermal_get_temp(MTK_THERMAL_SENSOR_CPU);
	...
	if (hw->flags & MSDC_EXT_SDIO_IRQ) {	/* yes for sdio */
		...
		if (enable) {
			...
			while(1){
				...
				printk("@#0x%08x @e >%d<\n",(sdr_read32(MSDC_INTEN)),host->mmc->sdio_irq_pending);
				if( (sdr_read32(MSDC_INTEN) & MSDC_INT_SDIOIRQ) == 0){
					printk("Should never ever get into this >%d<\n",host->mmc->sdio_irq_pending);;
				}
				else{
					break;
				}
 ...
 //   struct device_node *node;
    ...
    if (enable) {
        ...
        if (hw->cd_level) {
            ...
            if (request_irq(cd_irq, (irq_handler_t)msdc1_eint_handler, IRQF_TRIGGER_HIGH, "MSDC1_INS-eint", NULL))
				pr_err("MSDC1 IRQ LINE NOT AVAILABLE!!\n");
        } else {
            host->sd_cd_polarity = 0;
            /* request irq for eint (either way) */
            if (request_irq(cd_irq, (irq_handler_t)msdc1_eint_handler, IRQF_TRIGGER_LOW, "MSDC1_INS-eint", NULL))
				pr_err("MSDC1 IRQ LINE NOT AVAILABLE!!\n");
        }
    } else {
        disable_irq(cd_irq);
...
#endif
	host->core_clkon = 1;
//	msdc_select_clksrc(host, hw->clk_src); // no need select clock cause 400M can div to 260K
	...
	host->saved_para.pad_tune0 = sdr_read32(MSDC_PAD_TUNE0);
	host->saved_para.pad_tune0 |= (((hw->cmdrrddly & 0x1F) << 22) | ((hw->cmdrddly & 0x1F) << 16) | ((hw->datwrddly & 0x1F) << 0));
	...
	sdr_get_field(MSDC_PATCH_BIT2, MSDC_PB2_RESPWAITCNT, host->saved_para.resp_wait_cnt);
    /* disable support 64G not necessary, if disable need backup/restore @suspend/resume*/
...
void msdc_dump_gpd_bd(int id)
{
	...
	if(gpd == NULL){
		...
		pr_err("hwo:0x%x, bdp:0x%x, rsv0:0x%x, chksum:0x%x,intr:0x%x,rsv1:0x%x,nexth4:0x%x,ptrh4:0x%x\n", 
			gpd->hwo, gpd->bdp, gpd->rsv0, gpd->chksum, gpd->intr, gpd->rsv1, (unsigned int)gpd->nexth4,(unsigned int)gpd->ptrh4);		   
		pr_err("next:0x%x, ptr:0x%x, buflen:0x%x, extlen:0x%x, arg:0x%x,blknum:0x%x,cmd:0x%x\n", 
			(unsigned int)gpd->next,(unsigned int)gpd->ptr, gpd->buflen, gpd->extlen, gpd->arg, gpd->blknum, gpd->cmd);   
	}
	pr_err("==========================MSDC BD INFO ===========================\n"); 
	if(bd == NULL){
		pr_err("BD is NULL\n"); 
		...
		for(i = 0; i < host->dma.sglen; i++){
			...
			pr_err("	eol:0x%x, rsv0:0x%x, chksum:0x%x, rsv1:0x%x,blkpad:0x%x,dwpad:0x%x,rsv2:0x%x\n", 
				bd->eol, bd->rsv0, bd->chksum, bd->rsv1, bd->blkpad, bd->dwpad,bd->rsv2);		   
			pr_err("	nexth4:0x%x, ptrh4:0x%x, next:0x%x, ptr:0x%x, buflen:0x%x, rsv3:0x%x\n", 
				 (unsigned int)bd->nexth4, (unsigned int)bd->ptrh4,(unsigned int)bd->next, (unsigned int)bd->ptr, bd->buflen, bd->rsv3);
		}
	}
}
...
static int msdc_drv_probe(struct platform_device *pdev)
{
    ...
    if (strcmp(pdev->dev.of_node->name, "MSDC0") == 0) {
        hw = &msdc0_hw;
        pdev->id = 0;
		pr_err("platform_data hw:0x%p, is msdc0_hw \n", hw);
    }
#endif
#if defined(CFG_DEV_MSDC1)
	if (strcmp(pdev->dev.of_node->name, "MSDC1") == 0) {
		hw = &msdc1_hw;
		pdev->id = 1;
		pr_err("platform_data hw:0x%p, is msdc1_hw \n", hw);
	}
#endif
#if defined(CFG_DEV_MSDC2)
    ...
    if ((pdev->id == 1) && (hw->host_function == MSDC_SD) && (eint_node == NULL)) {
