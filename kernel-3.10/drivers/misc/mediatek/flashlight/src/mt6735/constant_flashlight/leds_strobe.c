...
//Alvin add ==20160304==p0==
//Define flashlight gpio
#ifdef CB04_6735_35U
#define FLASH_GPIO_ENF GPIO43
#define FLASH_GPIO_ENT GPIO42
#endif
//End of p0==Alvin==
...
int FL_Init(void)
{
  ...
  buf[0]=0xa;
    ...
    //Alvin add ==20160304==p1==
    //Init flashlight
    #ifdef CB04_6735_35U

    PK_DBG(" FL_Init  set gpio FLASH_GPIO_ENT and FLASH_GPIO_ENF zero\n");
