 ...
 * Please make sure firmware support debug mode data log firstly, then you can enable this compile option.
 * Else, disbale this compile option by default.
 * By default, this compile option is disabled.
 */
...
//#define CONFIG_ENABLE_GESTURE_WAKEUP // gesture key @2016-1-15 by bruce
 ...
 * By default, this compile option is disabled.
 */
#define CONFIG_ENABLE_UPDATE_FIRMWARE_WITH_8_BYTE_EACH_TIME // For Z630 project, must enable this compile option because of I2C DMA mode issue.
