...
//                    Ana_Set_Reg(AUDENC_ANA_CON9, 0x0710, 0xfff0); //MICBIAS1 DCC  on //DCC
                    Ana_Set_Reg(AUDENC_ANA_CON9, 0x0710, 0xfff0); //MICBIAS1 DCC  on //DCC, bit 5 to 1 to match ACCDET
...
static void mt6331_codec_init_reg(struct snd_soc_codec *codec)
{
    ...
    Ana_Set_Reg(AFE_PMIC_NEWIF_CFG2, 0x8000, 0x8000);/* Reverse the PMIC clock*/    
}
