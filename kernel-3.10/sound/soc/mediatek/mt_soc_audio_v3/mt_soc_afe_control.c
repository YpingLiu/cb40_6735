...
extern bool get_voice_md2_bt_status(void);
extern bool get_voice_md2_status(void);
...
{
    bool ret = (get_voice_bt_status() || get_voice_status() || get_voice_md2_status() || get_voice_md2_bt_status());
...
void EnableApll1(bool bEnable)
{
    ...
    if (bEnable)
    {
        if (Aud_APLL_DIV_APLL1_cntr == 0)
        {
            ...
            SetClkCfg(AUDIO_CLK_AUDDIV_0, 0x03000000, 0x07000000); // apll1_ck_div0, 90.3168/4 = 22.5792M
