...
#
#MTK dex2oat watchdog extend timeout
#
MTK_WATCHDOG_EXTEND_TIMEOUT_ENABLE := true
ifeq ($(MTK_WATCHDOG_EXTEND_TIMEOUT_ENABLE),true)
MTK_CFLAGS += -DMTK_WATCHDOG_EXTEND_TIMEOUT
endif

#
#decide to have google patch with CL#137780
#Wait for threads to finish unregistering
#https://android-review.googlesource.com/#/c/137780/
#
GOOGLE_PATCH_CL137780_ENABLE := true
ifeq ($(GOOGLE_PATCH_CL137780_ENABLE),true)
MTK_CFLAGS += -DGOOGLE_PATCH_CL137780
endif

ifeq ($(TARGET_BUILD_VARIANT),eng)
  ifeq ($(MTK_ENG_FULL_AOT), true)
    #MTK_CFLAGS += -DMTK_ENG_FULL_AOT
  endif
endif
...
#
# decide to have google patch with CL141470 or not
# https://android-review.googlesource.com/#/c/141470/
#
GOOGLE_PATCH_CL141470_ENABLE := true
ifeq ($(GOOGLE_PATCH_CL141470_ENABLE),true)
MTK_CFLAGS += -DGOOGLE_PATCH_CL141470
endif

ifeq ($(MTK_ENABLE_INCOMPLETE_BOOT_CHECK), true)
  MTK_CFLAGS += -DMTK_DISABLE_INCOMPLETE_BOOT_CHECK
endif
...
ifeq ($(MTK_ART_OPT_ENABLE),true)
ifeq ($(MTK_ARTSLIM_ENABLE),true)
ART_HOST_CFLAGS += -DHOST_AOT
MTK_CFLAGS += -DMTK_ARTSLIM_ENABLE
endif
endif
