    ...
    void setTimeFromNITZString (String nitz, long nitzReceiveTime)
    {
        ...
        try {
            ...
            if ((zone == null) || (mZoneOffset != tzOffset) || (mZoneDst != (dst != 0))){
                ...
                // fix LTEIRLAB_DCMP_11001 fail {
                if (("OP09".equals(SystemProperties.get("ro.operator.optr", "")) ||
                        "1".equals(SystemProperties.get("ro.ct6m_support", "0"))) &&
                        tzOffset == 0) {
                    mNeedFixZone = false;
                } else {
                    mNeedFixZone = true;
                ...
                /// @}
                    ...
                    if (("OP09".equals(SystemProperties.get("ro.operator.optr", "")) ||
                        ...
                        if (zone == null) {
                            ...
                            if (getAutoTimeZone()) {
                                setAndBroadcastNetworkSetTimeZone(gmtZone.getID());
                            }
                            saveNitzTimeZone(gmtZone.getID());
                        }
                    }
                    // fix LTEIRLAB_DCMP_11001 fail }
