...
public class MMTelSSUtils {
    ...
    public static String getXcapRootUri(int phoneId) {
        ...
        if (isOp01IccCard(phoneId)) {
            ...
            simSrv.setOperator(simSrv.OPERATOR_OP06);
        } else if (isOp15IccCard(phoneId)) {
            simSrv.setOperator(simSrv.OPERATOR_OP15);
        } else if (isOp18IccCard(phoneId)) {
            simSrv.setOperator(simSrv.OPERATOR_OP18);
        } else {
    ...
    public static boolean isGsmUtSupport(int phoneId) {
        ...
        if (SystemProperties.get("ro.mtk_ims_support").equals("1") &&
            ...
            if ((isOp01IccCard(phoneId) || isOp15IccCard(phoneId)) 
                && isUsimCard(phoneId)) {
                return true;
            }
        }
    ...
    public static boolean isOp01IccCard(int phoneId) {
        ...
        Rlog.d(LOG_TAG, "isOp01IccCard: false");
        return false;
    }
    ...
    public static boolean isOp06IccCard(int phoneId) {
        ...
        Rlog.d(LOG_TAG, "isOp06IccCard: false");
        return false;
    }

    /**
     * Check whether is IMS PDN operator.
     *
     * @param phoneId phone index
     * @return true if the Icc Card is IMS PDN operator
     */
    public static boolean isImsPdnOperator(int phoneId) {
        return isOp06IccCard(phoneId);
    }
    ...
    public static boolean isNotSupportXcap(int phoneId) {
        ...
        Rlog.d(LOG_TAG, "isNotSupportXcap: false");
        return false;
    }
