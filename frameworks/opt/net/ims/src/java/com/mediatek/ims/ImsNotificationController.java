...
public class ImsNotificationController {
    ...
    BroadcastReceiver mBr = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (DBG) Log.d(TAG, "mPhoneType:" + mPhoneType);
    ...
    private static final String KEY_OPERATOR_PRESENT = "ro.operator.optr";
    
    // TODO: added for customer lab test
    private static final String KEY_LAB_TEST = "persist.sys.wfc_lab_test";
    ...
    * Wfc registration notification ID. This is 
    ...
    private boolean isIsimAppPresent() {
        // Checking ISIM is TMO specific requirement, so by-passing it for other operators
        if (!(SystemProperties.get(KEY_OPERATOR_PRESENT).equals("OP08")) ||
            SystemProperties.get(KEY_LAB_TEST).equals("1")) return true;
        else if (SystemProperties.get(KEY_ISIM_PRESENT).equals("1")) {
