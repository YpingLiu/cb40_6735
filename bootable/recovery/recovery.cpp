...
//#endif
  ...
  { "restore_data", required_argument, NULL, 'd' },
#endif //SUPPORT_DATA_BACKUP_RESTORE
...
#if 1 //tonykuo 2014-06-24
static void update_modem_property(void)
{
                ...
                case Device::APPLY_SDCARD2:
                  {
                      ...
                      // as scratch space).
                      ensure_path_mounted(CACHE_ROOT);
                      ensure_path_mounted(SDCARD2_ROOT);
                      char* path = browse_directory(SDCARD2_ROOT, device);
                      if (path == NULL) {
                          ui->Print("\n-- No package file selected.\n", path);
                          break;
                      }
                ...
                case Device::FORCE_APPLY_SDCARD2_SIDELOAD:
                    {
                        ...
                        status = install_package(path, &wipe_cache,
                                             TEMPORARY_INSTALL_FILE, true);
#endif
                        ensure_path_unmounted(SDCARD2_ROOT);
