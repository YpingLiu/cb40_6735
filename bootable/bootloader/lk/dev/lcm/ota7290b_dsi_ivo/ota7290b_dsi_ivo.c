...
// Video mode setting
    ...
    params->dsi.vertical_sync_active   = 20;  //0x20; //0x04;// 3    2
    params->dsi.vertical_backporch     = 30;  //0x30;  //0x14;// 20   1
    params->dsi.vertical_frontporch    = 30;  //0x30; //0x16; // 1  12
...
//params->dsi.horizontal_frontporch    = 0x5f;
    params->dsi.horizontal_sync_active  = 30;  //0x30;  //8;// 50  2
    params->dsi.horizontal_backporch    = 40;  //0x30;     //0x44;
    params->dsi.horizontal_frontporch   = 40;  //0x30;    //46;
...
//params->dsi.LPX=8;
  ...
  // Bit rate calculation
    params->dsi.PLL_CLOCK = 150;   //220;  // 240->220 evade 2G RFI
  //1 Every lane speed
