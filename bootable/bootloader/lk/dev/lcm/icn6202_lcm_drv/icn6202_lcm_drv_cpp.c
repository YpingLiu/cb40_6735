...
//---------------------------------------------------------------------------
#define GPIO_LCM_BOOST_EN_PIN    GPIO147	// 1
...
static void icn6202_register_init()
{
	...
	data_array[0] = 0x58202300;dsi_set_cmdq(data_array, 1, 1);
	data_array[0] = 0x00212300;dsi_set_cmdq(data_array, 1, 1);
	data_array[0] = 0x42222300;dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x88342300;dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x4D7B2300;dsi_set_cmdq(data_array, 1, 1);
	data_array[0] = 0x08082300;dsi_set_cmdq(data_array, 1, 1);
...
//	data_array[0] = 0x412A2300;dsi_set_cmdq(data_array, 1, 1);
	...
	// LVDS setting	
	/*
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x7A, 0xC1);
	...
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x23, 0xA0);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x24, 0x13);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x25, 0x8C);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x26, 0x00);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x27, 0x0C);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x28, 0x02);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x29, 0x14);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x34, 0x80);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x36, 0xA0);
	...
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x56, 0x92);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x6B, 0x31);
	icn6202_i2c_write(ICN6202_CHIP_ADDR, 0x69, 0x26);
...
static void lcm_suspend(void)
{
    ...
    LCD_DEBUG("[DISPD] ICN6202 lcm_suspend\n");
}
...
static void lcm_resume(void)
{
    ...
    LCD_DEBUG("[DISPD] ICN6202 lcm_resume\n");
}
