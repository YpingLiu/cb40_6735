                    ...
                    void * handle)  // ourput setting
{
    ...
    dprintf(CRITICAL,"RDMAConfig input_is_yuv %d,idx %d, mode %d, address 0x%x, inputformat %d, input_swap %u, pitch %u, width %u, height %u\n",input_is_yuv, idx, mode, address, inputFormat,input_swap, pitch,width, height);
