...
COM_DEFS_FOR_MT6280  = MT6280                MT6280_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6752  = MT6752                MT6752_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6290  = MT6290                MT6290_$(strip $(CHIP_VER))
...
COM_DEFS_FOR_MT6735_LTE_MT6169_TB_CUSTOM = MT6169_RF MT6169_LTE_RF MT6735_LTE_MT6169_TB_CUSTOM
COM_DEFS_FOR_MT6735_MT6169_UMTS_TDD_TB_CUSTOM = MT6169_RF MT6169_UMTS_TDD MT6735_MT6169_UMTS_TDD_TB_CUSTOM
COM_DEFS_FOR_MT6735_2G_MT6169_TB_CUSTOM  = MT6169_2G_RF MT6735_2G_MT6169_TB_CUSTOM
...
ifdef PMIC
  ...
  PMIC_MT6325_SUPPORT_PLATFORM = MT6752 MT6735
  ...
  PMIC_MT6328_SUPPORT_PLATFORM = MT6735 MT6735M MT6753
  ifeq ($(strip $(PMIC)),MT6328)
    ifeq ($(filter $(strip $(PLATFORM)) ,$(PMIC_MT6328_SUPPORT_PLATFORM)),)
      $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support PMIC=$(strip $(PMIC)))
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif  
...
NEED_ADD_PMIC_COMPILE_LIST = MT6223PMU MT6238PMU MT6235PMU MT6236PMU MT6573PMU MT6575PMU MT6577PMU MT6305 MT6318 MT6326 MT6253PMU MT6253ELPMU MT6252PMU MT6326_CCCI MT6251PMU MT6276PMU MT6256PMU MT6921PMU MT6329 MT6255PMU MT6922PMU MT6250PMU MT6327 MT6320 MT6339 MT6331 MT6332 MT6331_PLUS_MT6332 MT6325 MT6328
...
ifeq ($(strip $(USB_SUPPORT)),TRUE)
  USB_SUPPORT_PLATFORM = MT6280 MT6575 MT6577 MT6752 MT6735
...
ifdef EDGE_SUPPORT
  ifeq ($(strip $(EDGE_SUPPORT)),TRUE)
    EDGE_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6752 MT6290 MT6595 MT6735 MT6795
...
ifeq ($(strip $(RF_DRDI_GPIO_6PIN_SUPPORT)),TRUE)
  COM_DEFS    += __RF_DRDI_GPIO_6PIN_SUPPORT__
endif
...
ifdef USB_HS_SUPPORT
  ifeq ($(strip $(USB_HS_SUPPORT)),TRUE)
     ifneq ($(strip $(USB_SUPPORT)),TRUE)
       ...
       USB_HS_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6752 MT6735
...
ifeq ($(strip $(AMRWB_LINK_SUPPORT)),TRUE)
  AMRWB_LINK_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6752 MT6290 MT6595 MT6735 MT6795
...
ifneq ($(filter $(strip $(PLATFORM)),$(SV5X_PLATFORM)),)
  ifneq ($(strip $(SMART_PHONE_CORE)),NONE)
    ifeq ($(strip $(X_BOOTING)),NONE)
	  ifneq ($(strip $(USB_FW_DL_SUPPORT)),TRUE)
        COM_DEFS += __AP_BOOTUP_BY_MDBL__
      endif
    endif
  endif
...
CENTRALIZED_SLEEP_MANAGER_PLATFORM = MT6752 MT6595 MT6290 MT6735 MT6795
...
ifdef DMA_UART_VIRTUAL_FIFO
  ...
  ifneq ($(filter $(strip $(PLATFORM)),$(VFIFO_NOT_SUPPORT_PLATFORM)),)
    ...
    ifneq ($(filter MT6752,$(strip $(PLATFORM))),)
      ...
      ifneq ($(strip $(DMA_UART_VIRTUAL_FIFO)),TRUE)
        ifeq ($(filter MT6256 MT6276 MT6573 MT6575 MT6577 MT6735,$(strip $(PLATFORM))),)
...
MULTI_LNA_MODE_CALIBRATION_SUPPORT_PLATFORM = MT6575 MT6280 MT6577 MT6752 MT6290 MT6595 MT6735 MT6795
...
CR4_WITH_COPRO_PLATFORM = MT6290 MT6595 MT6735 MT6795
ifdef PLATFORM
...
2G_TX_POWER_CONTROL_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6752 MT6572 MT6582 MT6290 MT6595 MT6735 MT6795
...
UMTS_MIPI_SUPPORT_PLATFORM = MT6290 MT6595 MT6752 MT6735 MT6795
...
ifeq ($(strip $(UMTS_RELEASE_SUPPORT)),UMTS_R8_SUPPORT)
  ...
  ifeq ($(strip $(UMTS_MODE_SUPPORT)),UMTS_FDD_MODE_SUPPORT)
    COM_DEFS    += __FDD_REDIRECTION__ __PPACR_SUPPORT__ __3G_CSG_SUPPORT__
  endif  
...
ifeq ($(strip $(UMTS_RELEASE_SUPPORT)),UMTS_R9_SUPPORT)
  ...
  ifeq ($(strip $(UMTS_MODE_SUPPORT)),UMTS_FDD_MODE_SUPPORT)
    COM_DEFS     += __FDD_REDIRECTION__ __PPACR_SUPPORT__ __HSDPA_2MS_DATA_IND__ __HSDPA_2MS_DATA_IND_LATENCY_IMPROVE__ __3G_CSG_SUPPORT__
  endif   
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6280 MT6290 MT6735
QUERY_32K_CRYSTAL_FROM_MD_PLATFORM = MT6280 MT6290
QUERY_32K_CRYSTAL_FROM_AP_PLATFORM = MT6735
...
DUAL_TALK_SUPPORT_PLATFORM = MT6752 MT6290 MT6595 MT6735 MT6795
ifdef MDSYS
  ifeq ($(strip $(MDSYS)),MD1)
    COM_DEFS += __MD1__
    else
...
DHL_SUPPORT_PLATFORM = MT6290 MT6595  MT6752 MT6735 MT6795
ifdef DHL_SUPPORT
 ifeq ($(strip $(DHL_SUPPORT)),TRUE)
...
GGE_MIPI_SUPPORT_PLATFORM = MT6290 MT6595 MT6752 MT6735 MT6795
...
MULTI_RAT_AFC_TADC_SHARE_PLATFORM = MT6290 MT6595 MT6752 MT6735 MT6795
...
ifdef DSP_IMG_ON_EMI
  ifeq ($(strip $(DSP_IMG_ON_EMI)),TRUE)
    ifneq ($(filter MT6752 MT6735,$(PLATFORM)),)
      ifeq ($(strip $(MDSYS)),MD1)
...
UMTS_MIPI_NVRAM_NOT_SUPPORT_PLATFORM = MT6280 MT6589 MT6572 MT6582 MT6290 MT6595 MT6752 MT6795
...
ifdef SLIM_DSP_LOGGING
  ifeq ($(strip $(SLIM_DSP_LOGGING)),TRUE)
    COM_DEFS    += __SLIM_DSP_LOGGING__
  endif
endif

ifneq ($(call Upper,$(strip $(EUTRAN_MODE_SUPPORT))),NONE)
  COM_DEFS += __LTE_CONN_ALWAYS_RCV_UE_PCH__
endif
...
#6 GPIO Pin support feature
RF_DRDI_V2_SUPPORT_PLATFORM = MT6735
ifneq ($(filter $(RF_DRDI_V2_SUPPORT_PLATFORM), $(strip $(PLATFORM))),)
  COM_DEFS    += __RF_DRDI_V2_SUPPORT__
endif

ifdef C2K_MODE_SUPPORT
  ifneq ($(strip $(C2K_MODE_SUPPORT)),NONE)
    ifdef TAS_FOR_C2K_ONOFF_SUPPORT
      ifeq ($(strip $(TAS_FOR_C2K_ONOFF_SUPPORT)),TRUE)
        COM_DEFS += __TAS_FOR_C2K_ONOFF_SUPPORT__
      endif
    endif
  endif
endif

ifneq ($(filter __TAS_FOR_C2K_ONOFF_SUPPORT__,$(strip $(COM_DEFS))),)
  ifneq ($(filter __TAS_SUPPORT__,$(strip $(COM_DEFS))),)
    $(warning ERROR: __TAS_SUPPORT__ and  __TAS_FOR_C2K_ONOFF_SUPPORT__ cannot both be true)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
