...
#define NVRAM_EF_L1_TAS_LIB_PARAMES_LID_VERNO                "000"
#endif
...
#define NVRAM_EF_EL1_RXON_BPIOFFSET_LID_VERNO         "001"
#define NVRAM_EF_EL1_TXON_BPIOFFSET_LID_VERNO         "001"
#define NVRAM_EF_EL1_RXOFF_BPIOFFSET_LID_VERNO        "001"
#define NVRAM_EF_EL1_TXOFF_BPIOFFSET_LID_VERNO        "001"
...
#define NVRAM_EF_EL1_CUSTOM_DYNAMIC_INIT_DEBUG_LID_VERNO  "004"
#else
...
/*for Co-Tms cal data*/
#define NVRAM_EF_EL1_GPS_CO_TMS_DATA_LID_VERNO                "000"
...
#define NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_LID_VERNO       "000"
#endif
...
#define NVRAM_EF_ERRC_LEARNED_MCC_LID_VERNO       "001"
...
#if (IS_MML1_CUSTOM_GPIO_6_PINS_SUPPORT)
#define NVRAM_EF_AST_CUSTOM_DYNAMIC_INIT_DEBUG_LID_VERNO     "001"
#else
...
#define NVRAM_EF_AST_TL1_RFFE_PARAM_LID_VERNO                "001"
#endif
...
#define NVRAM_EF_MML1_CUSTOM_DYNAMIC_INIT_LID_VERNO          "001"
#endif
...
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_LID_VERNO        "019"
...
#define NVRAM_EF_SBP_MODEM_CONFIG_LID_VERNO "034"
#define NVRAM_EF_SBP_MODEM_DATA_CONFIG_LID_VERNO "001"

#ifdef __VOLTE_SUPPORT__
#define NVRAM_EF_VDM_ADS_PROFILE_LID_VERNO                    "002"
#endif 

#define NVRAM_EF_2G_BA_INFO_LID_VERNO                         "001"
...
typedef struct{
  ...
  kal_uint16     sip_dscp;                  // 0
  kal_uint16     sip_priority;              // 0
  kal_uint16     audio_dscp;                // 0
  kal_uint16     audio_priority;            // 0
  kal_uint16     video_dscp;                // 0
  kal_uint16     video_priority;            // 0
  ...
  kal_uint16     UA_call_rej_by_user_code; // 486
...
typedef struct{
  ...
  kal_uint32    auto_re_reg_timer;                    // 5    000ms
  kal_uint32    auto_re_reg_base_timer;               // 30   000ms
  kal_uint32    auto_re_reg_max_timer;                // 1800 000ms  
  ...
  kal_uint8     ims_roaming_mode;                     // 0 (0: disable, 1: enable, 2: auto)
  kal_bool      mncmcc_pass_flag;                     //enable mnc,mcc check for registration
  kal_bool      ims_reg_allowed_at_23g;               // 0 (0: disable, 1: enable)
  kal_uint8     pad;
  ...
  kal_uint8     mncmcc_whitelist[128];              //mnc,mcc whitelist for operator <num><mnc_len><MNC><mcc_len><MCC>

  kal_bool      wfc_support;                          // 1
  kal_uint8     wfc_pad[3];
...
typedef struct
{
    ...
    nvram_gsm_cell_struct gsm_cell[NVRAM_2G_STORED_CELL_NUM_MAX];
...
/*GPS Co-Tms cal data*/
LID_BIT MULTIPLE_LID VER_LID(NVRAM_EF_EL1_GPS_CO_TMS_DATA_LID)
     nvram_el1_gps_co_tms_data_struct *NVRAM_EF_EL1_GPS_CO_TMS_DATA_TOTAL
     {
...
#if defined(__CDMA2000_RAT__)
LID_BIT MULTIPLE_LID VER_LID(NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_LID)
     nvram_el1_band_ind_struct *NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_TOTAL
             {
...
LID_BIT VER_LID(NVRAM_EF_SBP_MODEM_CONFIG_LID)
    nvram_ef_sbp_modem_config_struct *NVRAM_EF_SBP_MODEM_CONFIG_TOTAL
    {
       ...
       modem_sbp_config[18]
       {
        ...
        modem_sbp_config[21]
        {
            IGNORE_INT_CHECK_FOR_DEDICATED_BEARER: 1 "IGNORE_INT_CHECK_FOR_DEDICATED_BEARER"
            {
                0x0: "NOT skip integrity check for Activate Dedicated EPS Bearer Context Request";
                0x1: "Skip integrity check for Activate Dedicated EPS Bearer Context Request";
            };
...
LID_BIT VER_LID(NVRAM_EF_2G_BA_INFO_LID) nvram_ef_gsm_ba_info_struct * NVRAM_EF_2G_BA_INFO_TOTAL{};
