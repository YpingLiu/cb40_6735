...
MODULE_MSG_BEGIN( MSG_ID_RRM_COMMON_CODE_BEGIN )
    ...
    MSG_ID_RRM_COMMON_CODE_END = MSG_ID_RRM_VERIFY_GV_FOR_UT,
...
/* Yu-Po20141229, add MSG_ID_ANTENNA_SWITCH_REQ for C2K antenna switch*/
#ifdef __TAS_FOR_C2K_ONOFF_SUPPORT__
    MSG_ID_RR_MPAL_ANTENNA_SWITCH_REQ,
