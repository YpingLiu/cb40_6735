...
MODULE_MSG_BEGIN( MSG_ID_L4C_CODE_BEGIN )
...
MODULE_MSG_END( MSG_ID_L4C_CODE_TAIL )	
	/*--------------- L4C_MSG_CODE_END--------------------------*/
...
MODULE_MSG_BEGIN( MSG_ID_RAT_TCM_CODE_BEGIN )
       ...
       #ifdef __SGLTE__
       MSG_ID_TCM_PS_CHANGE_COMPLETE_IND,
       MSG_ID_RAT_TCM_CONTEXT_TRANSFER_REQ,
       MSG_ID_RAT_TCM_CONTEXT_TRANSFER_CNF,
       #endif /* __SGLTE__ */
       ...
       MSG_ID_RAT_TCM_CODE_END  = MSG_ID_RAT_TCM_PRINT_EMBEDDED_MODIFY_IND_MSG,
	/*-----------------RAT_TCM_CODE_TAIL-------------------------*/
...
MODULE_MSG_BEGIN( MSG_ID_TCM_CODE_BEGIN )
    ...
    /* For TCM context transfer */
	#ifdef __SGLTE__
    MSG_ID_TCM_CONTEXT_TRANSFER_MSG_BEGIN,
        MSG_ID_TCM_CONTEXT_TRANSFER_REQ,
        MSG_ID_TCM_CONTEXT_TRANSFER_CNF,
    MSG_ID_TCM_CONTEXT_TRANSFER_MSG_END,
    #endif /* __SGLTE__ */
...
#ifdef __SGLTE__
        MSG_ID_TCM_EVAL_PS_SWITCH_COMPLETE_IND,
#endif /* __SGLTE__ */  
...
//SSAGPS
 ...
 //   MSG_ID_L4CSMSAL_UPDATE_SMS_OVER_SGS_CFG_REQ,
    ...
    MSG_ID_L4CSMSAL_UPDATE_SMS_OVER_SGS_CFG_REQ,
	MSG_ID_SMSAL_CODE_END = MSG_ID_L4CSMSAL_UPDATE_SMS_OVER_SGS_CFG_REQ,
	/*------------------ SMSAL_MSG_CODE_END --------------------*/
...
/* under construction !*/
	...
	MSG_ID_SMU_CODE_END = MSG_ID_L4CSMU_SAT_SET_GPRS_PROF_RES, //MAUI_02395134
	/*------------------------SMU_MSG_CODE_END -----------------*/
...
MODULE_MSG_BEGIN( MSG_ID_RAC_CODE_BEGIN )
   ...
   MSG_ID_L4CAS_SET_SAVE_RAC_PREFERENCE_REQ,
   MSG_ID_L4CAS_SET_SAVE_RAC_PREFERENCE_CNF,

#ifdef __SGLTE__
   MSG_ID_L4CRAC_MMDC_MODE_UPDATE_REQ,
   MSG_ID_L4CRAC_PEER_REJECT_REQ,
   MSG_ID_L4CRAC_MMDC_PS_DOMAIN_ON_REQ,
   MSG_ID_L4CRAC_PS_SWITCH_REQ,
   MSG_ID_L4CRAC_PS_SWITCH_SUSPEND_REQ,
   MSG_ID_L4CRAC_PS_SWITCH_RESUME_REQ,   
   MSG_ID_L4CRAC_PLMN_SEARCH_ABORT_REQ,  
   MSG_ID_GMMREG_PS_SWITCH_CNF,
   MSG_ID_GMMREG_PS_SWITCH_SUSPEND_CNF,
   MSG_ID_GMMREG_NW_IMPLICIT_DETACH_IND,
#endif /* __SGLTE__ */
   MSG_ID_L4CRAC_MMDC_RECOVERY_SEARCH_REQ,

   MSG_ID_L4CRAC_ACTIVE_SIM_IND,
...
#ifdef __SGLTE__    
    MSG_ID_EMMREG_PS_SWITCH_CNF,
    MSG_ID_EMMREG_PS_SWITCH_SUSPEND_CNF,
#endif /* __SGLTE__ */    
#endif /* __LTE_RAT__ */
...
#ifdef __SGLTE__
   MSG_ID_RAC_GMSS_MMDC_CAMP_ON_STATUS_IND,
   MSG_ID_RAC_GAS_RAT_MODE_OR_FLIGHT_MODE_IND,
   MSG_ID_RAC_GMSS_PLMN_SEARCH_ABORT_CNF,
   MSG_ID_RAC_GMSS_MMDC_PLMN_LOSS_IND,
#endif /* __SGLTE__ */
   ...
   MSG_ID_RAC_CODE_END = MSG_ID_RAC_GMSS_REG_STATUS_IND,
...
MODULE_MSG_BEGIN( MSG_ID_ATCI_CODE_BEGIN )
    ...
    MSG_ID_ATCI_CODE_END = MSG_ID_ATCI_MD3_PWROFF_DONE_IND,
...
MODULE_MSG_BEGIN(MSG_ID_MBCI_CODE_BEGIN)
    ...
    MSG_ID_MBCI_CODE_END = MSG_ID_UPS_MBCI_LOOPBACK_STOP_IND,
    /*------------------------MBCI_MSG_CODE_END ---------------*/
...
#ifdef __TAS_FOR_C2K_ONOFF_SUPPORT__
   MSG_ID_L4CAS_CALL_STATUS_NOTIFY_REQ, //C2K dynamic antenna switch
#endif /* __TAS_FOR_C2K_ONOFF_SUPPORT__ */

#ifdef __SGLTE__
   MSG_ID_L4CAS_PS_SWITCH_GAS_NOTIFICATION_IND,
#endif
...
#endif
   MSG_ID_PS_CODE_END = MSG_ID_L4C_RRCE_PCH_TXRX_IND,
   /*----------AS_MSG_CODE_END -----------------*/
...
MODULE_MSG_BEGIN( MSG_ID_VMMI_CODE_BEGIN )	    
   ...
   MSG_ID_VMMI_CODE_END = MSG_ID_L4VMMI_AT_RESPONSE_IND,
   /*----------VMMI_MSG_CODE_END -----------------*/
MODULE_MSG_END( MSG_ID_VMMI_CODE_TAIL )	    
   
MODULE_MSG_BEGIN( MSG_ID_PROXY_CODE_BEGIN )
   MSG_ID_PROXY_ATCI_CMD_IND = MSG_ID_PROXY_CODE_BEGIN,
