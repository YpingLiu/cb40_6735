 ...
 * removed!
 * removed!
 * 	MP7: MSG_ID_ERRC_EL1_SPECIFIC_CELL_DELETE_NTF.
 *
 * removed!
 * removed!
 * IDC sw msg for low power.
 *
 * removed!
 * removed!
 * define new msg id for ERRC_EL1_MEASURE_EVENT_NTF (TMO patch N).
 *
 * removed!
 * removed!
 * add IRT sw msg timer.
 *
 * removed!
 * removed!
 * .
...
MSG_ID_ETMR_EL1_IRT_LTE_STATUS_TMR_EXPIRY,
MSG_ID_ETMR_EL1_CH_UPDT_FREQ_TMR_EXPIRY,
