 ...
 * removed!
 * removed!
 * [LR9.MP7][EPDCP] VoLTE Data Prediction: MSG_IDs and prototype.
 *
 * removed!
 * removed!
 * Merge ERLC UL-DL Supervision from MP7.CMCCVOLTE.FPB to MP7 in OA domain
 *
 * removed!
 * removed!
 * [EPDCP] Inactivity Detection Timer ERRC Interface.
 * 	
 * 	Merge to LR9.MP7.
 *
 * removed!
 * removed!
 * [EL2][EMAC] RA Probing Request Interface
 *
 * removed!
 * removed!
 * Leave DRX for DCCH UL data (OA domain).
 *
 * removed!
 * removed!
