 ...
 * removed!
 * removed!
 * 	declarations with no bCSFB compile option for MP7.
 *
 * removed!
 * removed!
 * 	.
 ...
 * removed!
 * removed!
 * 1. Add PLMN_FOUND_IND from ERRC to EVAL.
 * 2. Add no_action_cause_enum and no_action_cause in NO_ACTION_IND.
 *
 * removed!
 * removed!
 * MP7 fast roaming .h
 ...
 * removed!
 * removed!
 * .add MSG_ID_EVAL_ERRC_OOS_SEARCH_IND
 *
 * removed!
 * removed!
 * c2l sniff interface (oa)
 *
 * removed!
 * removed!
 * add MSG_ID_L4C_EVAL_LTE_NEIGHBOR_CELL_INFO_REQ,
 * 	MSG_ID_EMMREG_DUPLEX_MODE_CHANGE_REQ
 *
 * removed!
 * removed!
 * add DUPLEX_MODE_CHANGE_REQ and DUPLEX_MODE_CHANGE_CNF ids
 *
 * removed!
 * removed!
 * code merge to MP7 for "set LTE to active RAT when receiving C2L_TRANSFER_REQ"
 *
 * removed!
 * removed!
 * 	interface/sap/md/...
...
#endif /* __SGLTE__ */
MSG_ID_EVAL_ERRC_OOS_SEARCH_IND,// C2K MD-IRAT
