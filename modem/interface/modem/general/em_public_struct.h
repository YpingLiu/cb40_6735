...
//#endif
   ...
   EL2_EM_INFO_END_R2 = EM_UPCM_PS_TPUT_INFO, // current end
   EL2_EM_INFO_END_RESERVED = EL2_EM_INFO_BEGIN_R2 + 29, // reserved end: 490
...
typedef struct
{
    ...
    /*for auto test tool*/
    kal_int16  dl_rsrq[2]; // -255: disable

    /*operator requirement*/
    kal_uint8  srs_bw_ave;
    kal_int16  pucch_tx_power_ave_fmt[7]; //0:FMT1, 1:FMT1A, 2:FMT1B, 3:FMT2
                                          //4:FMT2_extCP, 5:FMT2A, 6:FMT2B
...
/**************************************************************************
  * Here is the UPCM related EM definition
  *
  * Notes: UPCM structures is defined here
  * Steve: 2015/01/08:  Add UPCM EM related structures
  **************************************************************************/
/********************* begin of UPCM definition ****************************/
