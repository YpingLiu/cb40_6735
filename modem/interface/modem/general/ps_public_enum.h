...
#define MAX_NUM_CONFIG_OPTION_PACKETS 16 /* See tcm_pco_api.h for PCO number counting. */
#else  /* __IMS_SUPPORT__ */
#define MAX_NUM_CONFIG_OPTION_PACKETS 9  /* See tcm_pco_api.h for PCO number counting. */
...
#define CONFIG_MTK_C2K_SUPPORT      0x01   // bit0
#define CONFIG_MTK_SVLTE_SUPPORT    0x02   // bit1
#define CONFIG_MTK_SRLTE_SUPPORT    0x04   // bit2
#define CONFIG_MTK_C2K_OM_SOLUTION1 0x08   // bit3
#define CONFIG_MTK_CT6M_SUPPORT     0x10   // bit4
#endif
...
/* ============================== TCM cause ============================== */
    ...
    #ifdef __SGLTE__
    TCM_L4C_DEACT_IND_BY_NO_USER_RESPONSE_TILL_PS_CHANGE_COMPLETE_IND,
    TCM_L4C_PDP_INFO_WRITE_BY_NO_NVRAM_CONF_TILL_PS_CHANGE_COMPLETE_IND,
    TCM_L4C_SEC_PDP_INFO_WRITE_BY_NO_NVRAM_CONF_TILL_PS_CHANGE_COMPLETE_IND,
    #endif /* __SGLTE__ */
...
/* ============================== L4C cause ============================== */
    ...
    L4C_LOCAL_DISCONNECT_CSD, //MAUI_01801045
    ...
    L4C_CMD_CONFLICT_C2K_IRAT_ONGOING = L4C_TYPE_5_C2K_CAUSE_START, /* +CMD ERROR : 4224 */
    L4C_CMD_CONFLICT_C2K_AP_DEACT_RETRY_NEEDED, /* +CMD ERROR : 4225 */
...
{
    /* 1st byte */
    SBP_PERMANENT_AUTO_SEL_MODE, /* default off */
    SBP_UMTS_CB_OFF,
    ...
    /* 22nd byte */
    SBP_IGNORE_INT_CHECK_FOR_DEDICATED_BEARER,
