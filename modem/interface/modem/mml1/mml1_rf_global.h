...
#include "mml1_mipi_public.h"    //MIPI Nvram usage
/*===============================================================================*/
...
#if defined(__RF_DRDI_GPIO_6PIN_SUPPORT__)
#define IS_MML1_CUSTOM_GPIO_6_PINS_SUPPORT       1   /* Enable DRDI GPIO 6 Pins Support */
#else
#define IS_MML1_CUSTOM_GPIO_6_PINS_SUPPORT       0   /* Disable DRDI GPIO 6 Pins Support, default 3 Pins Support */
#endif

#if defined(__RF_DRDI_SPECIAL_MEMORY_SUPPORT__)
...
#define MML1_RF_DRDI_GPIO_MAX_DETECT_PIN_NUM       (6)
#define MML1_CUSTOM_GPIO_MAX_SET_NUMS             (64)    /* Maximum 64 set for GPIO 6 Pins */  
#else
#define MML1_RF_DRDI_GPIO_MAX_DETECT_PIN_NUM       (3)
#define MML1_CUSTOM_GPIO_MAX_SET_NUMS              (8)    /* Maximum 8 set for GPIO 3 Pins  */  
#endif
...
#define MML1_CUSTOM_MEMORY_DATA_DETECTION_ID  (4)
#endif
...
typedef struct
{
   ...
   kal_uint16  memory_data_read_value;
...
typedef struct
{
   ...
   //reqMask[0]
   kal_uint8  gpioPinName[MML1_RF_DRDI_GPIO_MAX_DETECT_PIN_NUM][MML1_RF_DRDI_GPIO_PIN_NAME_STRING_LENGTH]; //[3][34] or [6][34]

   //reqMask[1]
   kal_uint32 gpioPinNum[MML1_RF_DRDI_GPIO_MAX_DETECT_PIN_NUM];  //[3] or [6]
...
typedef struct
{
   ...
   //reqMask[1]
   kal_uint32 gpioPinValue[MML1_RF_DRDI_GPIO_MAX_DETECT_PIN_NUM]; //[3] or [6]
...
//DCXO
#define MML1_RF_SetCrystalCap()
#define MML1_RF_SetDCXOFreqLPM()
#define MML1_RF_UpdateDCXOCapID()
...
#define MML1_RF_VRF18_LPM_ModeSet()
#define MML1_RF_VRF18_LPM_SrcSel()
#define MML1_RF_VRF18_LPM_Enable()
