...
#include "L1Trc.h"
	...
	#define EMAC_LOG_DRX_CHK_WAKE(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x420E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SCH_RESV_ADP_RETX(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x450E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SCH_RESV_NON_ADP_RETX(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x460E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_REQ_IN_GEMINI_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x470E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_GAP_STATE(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x490E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_JUDGE_RETX_MODE(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x4E0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_TX_SKIP_FOR_GAP(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x4F0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_UPDATE_G_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x500E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SKIP_FOR_G_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x510E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DISABLE_PHICH(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x540E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DISABLE_PHICH_BUNDLING(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x550E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_GEMINI_ALIGNED_GAP_TIME(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x560E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_GEMINI_SIM_RESULT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x570E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_CALLON(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x590E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_NOT_WAKEUP(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x5E0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_VSR_COVER(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x600E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_USING_VSR(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x610E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_UPDATE_WAKEUP(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x630E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSE_INVALID_SSID(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x660E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_SAVE_MSG3_HWB(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x670E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_MSG3_HARQ_RELOAD_UPD(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x680E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
