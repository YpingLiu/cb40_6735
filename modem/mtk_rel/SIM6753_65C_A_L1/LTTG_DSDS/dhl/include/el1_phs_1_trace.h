...
#define PHS_Param_Log_Type_String(v1)  (unsigned char)(v1+172)
#define PHS_Track_Mode_String(v1)  (unsigned char)(v1+177)
...
#define PHS_LOG_FIND_LP_EXE_EVT_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C01, (unsigned char)(v1), (unsigned char)(v2)))
	...
	#define PHS_LOG_EXT_WIN_TIME(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x0D01, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v9));\
	} while(0)
#else
	#define PHS_LOG_EXT_WIN_TIME(v1, v2, v3, v4, v5, v6, v7, v8, v9)
#endif
#define PHS_LOG_EXT_WIN_TIME_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x0D01, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v9))
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PARAM_ABS_TIME2(v1, v2, v3, v4, v5, v6) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x2F01, (unsigned char)(v1), (unsigned char)(v6)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	#define PHS_LOG_PARAM_ABS_TIME2(v1, v2, v3, v4, v5, v6)
#endif
#define PHS_LOG_PARAM_ABS_TIME2_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x2F01, (unsigned char)(v1), (unsigned char)(v6)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PHS_RNTI_STUS(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3001, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_PHS_RNTI_STUS(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_PHS_RNTI_STUS_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3001, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))
...
#endif
#define PHS_LOG_UPDT_SRV_CID_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3101, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define PHS_LOG_UPDT_SRV_CID_ISR_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3201, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define PHS_LOG_CHNG_OLD_END_WIN_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3301, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_CHNG_NEW_STRT_WIN(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3401, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_CHNG_NEW_STRT_WIN(v1, v2)
#endif
#define PHS_LOG_CHNG_NEW_STRT_WIN_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3401, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_EXE_CMD_END_TIME(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x3501, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_EXE_CMD_END_TIME(v1, v2, v3, v4)
#endif
#define PHS_LOG_EXE_CMD_END_TIME_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x3501, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_FINAL_EXE_TIME(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x3601, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	#define PHS_LOG_FINAL_EXE_TIME(v1, v2, v3, v4, v5, v6, v7)
#endif
#define PHS_LOG_FINAL_EXE_TIME_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x3601, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_FINAL_EXE_TIME_1(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3701, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_FINAL_EXE_TIME_1(v1, v2, v3)
#endif
#define PHS_LOG_FINAL_EXE_TIME_1_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3701, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_RNTI_CTRL_EN_TIME(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x3801, (unsigned char)(v5), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_RNTI_CTRL_EN_TIME(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_RNTI_CTRL_EN_TIME_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x3801, (unsigned char)(v5), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_MAC_DRX_OP_GAP(v1, v2, v3, v4, v5, v6) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x3901, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	#define PHS_LOG_MAC_DRX_OP_GAP(v1, v2, v3, v4, v5, v6)
#endif
#define PHS_LOG_MAC_DRX_OP_GAP_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x3901, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6))
...
#endif
#define PHS_LOG_RNTI_CTRL_REL_TIME_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x3A01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PRESCH_CMD_TIME(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x3B01, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_PRESCH_CMD_TIME(v1, v2, v3, v4)
#endif
#define PHS_LOG_PRESCH_CMD_TIME_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3B01, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#endif
#define PHS_LOG_PRESCH_CMD_DONE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3C01, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_LIFE_TIME_EXPIRE(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3D01, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_LIFE_TIME_EXPIRE(v1)
#endif
#define PHS_LOG_LIFE_TIME_EXPIRE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3D01, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define PHS_LOG_PRESCH_CMD_INDX_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3E01, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_MEAS_CMD_TYPE(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3F01, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define PHS_LOG_MEAS_CMD_TYPE(v1, v2)
#endif
#define PHS_LOG_MEAS_CMD_TYPE_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3F01, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define PHS_LOG_INTRA_CS_NUM_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4001, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define PHS_LOG_INTER_CS_NUM_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4101, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_FUNC_RTN(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4201, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_FUNC_RTN(v1)
#endif
#define PHS_LOG_FUNC_RTN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4201, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SCHDL_EVT_INFO(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4301, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3));\
	} while(0)
#else
	#define PHS_LOG_SCHDL_EVT_INFO(v1, v2, v3, v4)
#endif
#define PHS_LOG_SCHDL_EVT_INFO_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4301, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_UPDT_MIN_EVT_TIME(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4401, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_UPDT_MIN_EVT_TIME(v1, v2)
#endif
#define PHS_LOG_UPDT_MIN_EVT_TIME_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4401, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NXT_GAP_TIME(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x4501, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_NXT_GAP_TIME(v1, v2, v3, v4)
#endif
#define PHS_LOG_NXT_GAP_TIME_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x4501, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NXT_STBY_GAP_TIME(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x4601, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	#define PHS_LOG_NXT_STBY_GAP_TIME(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_NXT_STBY_GAP_TIME_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x4601, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_EXE_EVT_REMAP(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4701, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_EXE_EVT_REMAP(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_EXE_EVT_REMAP_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4701, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PARAM_3(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x4801, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define PHS_LOG_PARAM_3(v1, v2, v3)
#endif
#define PHS_LOG_PARAM_3_NOFLTR(v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x4801, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PARAM_6(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x4901, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	#define PHS_LOG_PARAM_6(v1, v2, v3, v4, v5, v6, v7)
#endif
#define PHS_LOG_PARAM_6_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x4901, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PHS_RNTI_VALUE(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x4A01, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)));\
	} while(0)
#else
	#define PHS_LOG_PHS_RNTI_VALUE(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_PHS_RNTI_VALUE_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x4A01, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_CH_RNTI_ACT(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x4B01, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_CH_RNTI_ACT(v1, v2, v3)
#endif
#define PHS_LOG_CH_RNTI_ACT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4B01, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_REDUCE_END_TIME(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4C01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define PHS_LOG_REDUCE_END_TIME(v1, v2, v3)
#endif
#define PHS_LOG_REDUCE_END_TIME_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4C01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_ENBL_RX_CTRL(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4D01, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_ENBL_RX_CTRL(v1, v2)
#endif
#define PHS_LOG_ENBL_RX_CTRL_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4D01, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_MEAS_TRIG(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x04)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x4E01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	#define PHS_LOG_MEAS_TRIG(v1, v2, v3, v4, v5, v6, v7)
#endif
#define PHS_LOG_MEAS_TRIG_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x4E01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_GAP_ACTV(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x04)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x4F01, (unsigned char)(v1), (unsigned char)(v4)), TRC_MERGE_4C((unsigned char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define PHS_LOG_GAP_ACTV(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_GAP_ACTV_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x4F01, (unsigned char)(v1), (unsigned char)(v4)), TRC_MERGE_4C((unsigned char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_HNDLR_ENTRY(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[3]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5001, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_HNDLR_ENTRY(v1)
#endif
#define PHS_LOG_HNDLR_ENTRY_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5001, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_GET_NXT_TIME_DBG(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5101, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_GET_NXT_TIME_DBG(v1, v2, v3)
#endif
#define PHS_LOG_GET_NXT_TIME_DBG_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5101, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_EXE_EVT_STUS_DBG(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5201, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_EXE_EVT_STUS_DBG(v1, v2, v3, v4)
#endif
#define PHS_LOG_EXE_EVT_STUS_DBG_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5201, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SCH_EVT_ACTIVE_DBG(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5301, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_SCH_EVT_ACTIVE_DBG(v1, v2, v3)
#endif
#define PHS_LOG_SCH_EVT_ACTIVE_DBG_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5301, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_RTB_CONFLICT(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5401, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define PHS_LOG_RTB_CONFLICT(v1, v2)
#endif
#define PHS_LOG_RTB_CONFLICT_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5401, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SCH_DROP_RATE(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x5501, (unsigned short)(v1)));\
	} while(0)
#else
	#define PHS_LOG_SCH_DROP_RATE(v1)
#endif
#define PHS_LOG_SCH_DROP_RATE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x5501, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NEW_TRACK_INFO(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x5601, (short)(v1)), TRC_MERGE_2S((short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_NEW_TRACK_INFO(v1, v2, v3, v4)
#endif
#define PHS_LOG_NEW_TRACK_INFO_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x5601, (short)(v1)), TRC_MERGE_2S((short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_EVT_TRACK_MODE(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5701, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define PHS_LOG_EVT_TRACK_MODE(v1, v2)
#endif
#define PHS_LOG_EVT_TRACK_MODE_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5701, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_TRACK_MODE_NOT_MEET(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5801, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_TRACK_MODE_NOT_MEET(v1)
#endif
#define PHS_LOG_TRACK_MODE_NOT_MEET_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5801, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_HOST_CNF_CHNG(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x5901, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_HOST_CNF_CHNG(v1, v2, v3, v4)
#endif
#define PHS_LOG_HOST_CNF_CHNG_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x5901, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_INTRA_CONTI_INTER() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5A01, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_INTRA_CONTI_INTER()
#endif
#define PHS_LOG_INTRA_CONTI_INTER_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5A01, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_DRX_INACT(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x5B01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	#define PHS_LOG_DRX_INACT(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_DRX_INACT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x5B01, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PAG_DUMP_INFO(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x5C01, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_PAG_DUMP_INFO(v1, v2, v3, v4)
#endif
#define PHS_LOG_PAG_DUMP_INFO_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x5C01, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_UNSLP_CNT(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5D01, (unsigned char)(v2), TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define PHS_LOG_UNSLP_CNT(v1, v2)
#endif
#define PHS_LOG_UNSLP_CNT_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5D01, (unsigned char)(v2), TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PAG_DUMP_INFO2(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5E01, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_PAG_DUMP_INFO2(v1, v2, v3)
#endif
#define PHS_LOG_PAG_DUMP_INFO2_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5E01, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PAG_POLL_DELAY(v1, v2, v3) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5F01, (unsigned char)(v2), (unsigned char)(v3)), (unsigned long)(v1));\
	} while(0)
#else
	#define PHS_LOG_PAG_POLL_DELAY(v1, v2, v3)
#endif
#define PHS_LOG_PAG_POLL_DELAY_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5F01, (unsigned char)(v2), (unsigned char)(v3)), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_AHEAD_TX_INFO(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6001, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_AHEAD_TX_INFO(v1, v2, v3, v4)
#endif
#define PHS_LOG_AHEAD_TX_INFO_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6001, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SDRX_EARLY_TRIG(v1, v2, v3, v4) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x6101, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_SDRX_EARLY_TRIG(v1, v2, v3, v4)
#endif
#define PHS_LOG_SDRX_EARLY_TRIG_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x6101, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_CLASSIFY() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6201, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_CLASSIFY()
#endif
#define PHS_LOG_CLASSIFY_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6201, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
void L1TRC_Send_PHS_LOG_EXT_WIN_TIME(unsigned char v1, unsigned char v2, unsigned long v3, unsigned long v4, unsigned long v5, unsigned long v6, unsigned char v7, unsigned char v8, unsigned long v9);
...
void L1TRC_Send_PHS_LOG_PARAM_ABS_TIME2(unsigned char v1, unsigned long v2, unsigned long v3, unsigned long v4, unsigned long v5, unsigned char v6);
...
void L1TRC_Send_PHS_LOG_FINAL_EXE_TIME(unsigned char v1, unsigned long v2, unsigned long v3, unsigned long v4, unsigned long v5, unsigned long v6, unsigned long v7);
void L1TRC_Send_PHS_LOG_FINAL_EXE_TIME_1(unsigned char v1, unsigned char v2, unsigned char v3);
...
void L1TRC_Send_PHS_LOG_SCHDL_EVT_INFO(unsigned char v1, unsigned char v2, unsigned long v3, unsigned char v4);
...
void L1TRC_Send_PHS_LOG_NEW_TRACK_INFO(short v1, short v2, unsigned short v3, unsigned short v4);
void L1TRC_Send_PHS_LOG_EVT_TRACK_MODE(unsigned char v1, unsigned char v2);
void L1TRC_Send_PHS_LOG_TRACK_MODE_NOT_MEET(unsigned char v1);
void L1TRC_Send_PHS_LOG_HOST_CNF_CHNG(unsigned long v1, unsigned long v2, unsigned long v3, unsigned long v4);
...
void L1TRC_Send_PHS_LOG_PAG_POLL_DELAY(unsigned long v1, unsigned char v2, unsigned char v3);
void L1TRC_Send_PHS_LOG_AHEAD_TX_INFO(unsigned short v1, unsigned short v2, unsigned short v3, unsigned char v4);
void L1TRC_Send_PHS_LOG_SDRX_EARLY_TRIG(unsigned long v1, unsigned long v2, unsigned long v3, unsigned long v4);
void L1TRC_Send_PHS_LOG_CLASSIFY(void);
...
#define ChkL1MsgFltr_PHS_LOG_SRCH_EXE_EVT()	ChkL1ClsFltr_EL1_PHS_1_phs_func_trace_2()
#define ChkL1MsgFltr_PHS_LOG_SRCH_HP_EXE_EVT()	ChkL1ClsFltr_EL1_PHS_1_phs_func_trace_2()
#define ChkL1MsgFltr_PHS_LOG_SRCH_LP_EXE_EVT()	ChkL1ClsFltr_EL1_PHS_1_phs_func_trace_2()
...
#define ChkL1MsgFltr_PHS_LOG_PARAM_ABS_TIME2()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
...
#define ChkL1MsgFltr_PHS_LOG_FUNC_RTN()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace_2()
...
#define ChkL1MsgFltr_PHS_LOG_NEW_TRACK_INFO()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_EVT_TRACK_MODE()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_TRACK_MODE_NOT_MEET()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_HOST_CNF_CHNG()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
...
#define ChkL1MsgFltr_PHS_LOG_PAG_POLL_DELAY()	ChkL1ClsFltr_EL1_PHS_1_phs_flow_trace()
#define ChkL1MsgFltr_PHS_LOG_AHEAD_TX_INFO()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_SDRX_EARLY_TRIG()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_CLASSIFY()	ChkL1ClsFltr_EL1_PHS_1_phs_flow_trace()
