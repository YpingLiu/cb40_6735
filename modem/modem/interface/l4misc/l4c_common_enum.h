...
#define L4C_POWER_LEVEL_IND_INVALID_RSSNR  0x7fff
...
typedef enum
{
   ...
   RMMI_SRC_END = RMMI_SRC + RMMI_SRC_END_CHANNEL -1,
   ...
   IMSP_SRC,
   IMSP_SRC_END = IMSP_SRC + 10, //IMSP_MAX_TRANSACTION = 10, it must be the same with IMSP_MAX_TRANSACTION
#endif
   TST_SRC,
   TST_SRC_END = TST_SRC + RMMI_MAX_SIM_NUM - 1,
