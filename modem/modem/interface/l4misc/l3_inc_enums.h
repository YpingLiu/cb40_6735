...
#define MAX_RECOVERY_TIMER_NUM  19 /* Should in range 1 ~ 256 */

#ifdef __R7_EHPLMN__
#define MAX_NUM_HPLMN 8
#else
#define MAX_NUM_HPLMN 1
#endif

#define MAX_NUM_EMC_FPLMN 6

#ifdef __SEARCH_ALL_EHPLMN_TOGETHER__
/* __SEARCH_ALL_EHPLMN_TOGETHER__ is dependent on __R7_EHPLMN__, so MAX_NUM_HPLMN == 4 here. */
#define MAX_NUM_SEARCH_PLMN (MAX_NUM_EQ_PLMN + MAX_NUM_HPLMN - 1)
#else
...
typedef enum
{
	RX_BAND_NOT_IN_1850_1880 = 0,
	RX_BAND_IN_1850_1880 = 1
}gsm_rx_band_1800_hign_enum;
#endif
...
typedef enum {
    ...
    AUTH_FAIL,
    SIM_INVALID_FOR_LTE_BECAUSE_NON_USIM_INSERTED = 0x8f
}mm_cause_enum;
...
typedef enum
{
    ...
    NWSEL_CUSTOMER_FPLMN_NOT_ALLOW = 5
...
/* Lanslo 20060621: modify type size for VC simulator environment */
       ...
       #ifdef __FLC2__
          #define RLC_UL_CTRL_HEADER_LENGTH 13 
       #else
       #define RLC_UL_CTRL_HEADER_LENGTH 12  //sizeof rlc_peer_data_info_struct
       #endif
   #else
       #ifdef __FLC2__
...
#ifdef __SGLTE__
    /*Local release RRC Connection(with RAB) for PS Swtich from 3G*/
    AS_REL_SCOPE_MMDC_PS_SWITCH 
#endif /* __SGLTE__ */
}as_rel_scope_enum;
...
typedef enum
{
    ...
    ,
    /* [20141021] Add reject cause to notify MM cell evaluation is ongoing in connected mode. */
    RR_CELL_EVAL = 13
...
#ifdef __LTE_RAT__
typedef enum {
    EAS_USER_NO_SERVICE_PLMN_LIST,
    EAS_USER_PLMN_SEARCH,
    EAS_USER_IN_SERVICE_PLMN_LIST,
    EAS_MM_PLMN_SEARCH,
    EAS_AS_AFR,
    EAS_AS_CELL_SELECTION,
    EAS_AS_CSG_CELL_EVALUATION,
    EAS_AS_BACKGROUND_SEARCH,
    EAS_MM_PLMN_LIST,
    EAS_AS_CSG_AUTONOMOUS_SEARCH,
    EAS_AS_FINGERPRINT,
    EAS_AS_MCC_LEARNING,
    EAS_SIM_PROTECTION,
    EAS_MM_PLMN_SEARCH_POWER_ON,
    EAS_FREQ_SCAN_NULL
...
typedef enum
{
    ...
    MM_EVENT_PS_ATTACH_SUSPEND_IND = 10,
    MM_EVENT_SEARCH_OTHER_RAT_IND = 11 //CSFB REDIR REJ, SEARCH OTHER RAT TO FINISH CALL
} mm_event_type_enum;
...
#ifdef __SGLTE__
    ,
    EVENT_TYPE_PEER_LR_RESULT = 0x40
#endif /* __SGLTE__ */
} event_type_enum;
...
typedef enum{
    ...
    ERAT_UMTSTDD      = 4,
    ERAT_UMTSTDD_GSM  = 5,
    ERAT_UMTSTDD_UMTSFDD      = 6,
    ERAT_UMTSTDD_UMTSFDD_GSM  = 7,
    ERAT_LTE          = 8,
    ERAT_LTE_GSM      = 9,
    ERAT_LTE_UMTSFDD  = 10,
    ERAT_LTE_UMTSFDD_GSM      = 11,
    ERAT_LTE_UMTSTDD  = 12,
    ERAT_LTE_UMTSTDD_GSM      = 13,
    ERAT_LTE_UMTSTDD_UMTSFDD  = 14,
    ERAT_LTE_UMTSTDD_UMTSFDD_GSM  = 15,
    ERAT_C2K          = 16,
    ERAT_C2K_LTE      = 24,
    ERAT_C2K_LTE_UMTSFDD_GSM = 27
...
typedef enum
{
    EMM_ATTACH_RESULT_EPS_ONLY_ATTACHED    = 1,
...
typedef enum
{
    ESM_CAUSE_NO_CAUSE                          = 0,    /* Cause not assigned                                   */
...
typedef enum
{
    MMDC_PS_SWITCH_NOT_START = 0,
    MMDC_PS_SWITCH_START,
    MMDC_PS_SWITCH_END,
    MMDC_PS_SWITCH_CURRENT_PS
} mmdc_ps_switch_notify_gas_enum;

typedef enum
{
    MMDC_RR_STATE_IDLE = 0,
    MMDC_RR_STATE_NOT_IDLE,
} mmdc_rr_state_enum;

#define MAX_SYS_CRITERIA_NUM 32
...
{
    ATTACH_CAUSE_NONE = 0,
    ATTACH_CAUSE_MANUAL_RESELECTION,
    ATTACH_CAUSE_AUTO_RESELECTION
} attach_cause_enum;
#endif
...
#ifdef __SGLTE__
#define MAX_NR_OF_UAS_PRIO_THRESH  9
#define MAX_NR_OF_EAS_PRIO_THRESH  8
#endif

#ifdef __SGLTE_DSDS__
// when ps on sim2, sim1 state as below
typedef enum
{
    PS_NOT_ON_SIM1_NONE =0,
    PS_NOT_ON_SIM1_ATTACH,       /*have ever recv attach*/
    PS_NOT_ON_SIM1_PLMN_SEARCH,  /*recv plmn search*/
    PS_NOT_ON_SIM1_WAIT_SYSINFO, /*recv sysinfo*/
    PS_FROM_SIM2_TO_SIM1         /*PS return to SIM1*/
} ps_not_on_sim1_state_enum;
#endif
...
typedef enum
{
    GMSS_RAT_CDMA2000_ALL   = 0,    /* All 3GPP2 access technology */
    GMSS_RAT_3GPP_ALL       = 1,    /* All 3GPP access technology */
    GMSS_RAT_CDMA2000_1xRTT = 2,    /* CDMA2000 1xRTT */
    GMSS_RAT_CDMA2000_HRPD  = 3,    /* CDMA2000 HRPD (1xEV-DO) */
    GMSS_RAT_GERAN          = 4,    /* GSM */
    GMSS_RAT_UTRAN          = 5,    /* UMTS */    
    GMSS_RAT_EUTRAN         = 6,    /* LTE */
...
typedef enum
{
    ...
    EMDSTATUS_SIM_CONFIG_REMOTE_ACCESS_SIM1,    /* MD1 access MD1's SIM task1 */
    EMDSTATUS_SIM_CONFIG_REMOTE_ACCESS_SIM2     /* MD1 access MD1's SIM task2 */
