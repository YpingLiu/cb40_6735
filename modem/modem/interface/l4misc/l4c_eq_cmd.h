...
extern kal_bool l4c_eq_vm_delete_req(kal_uint8 src_id, kal_wchar *file_name, kal_bool delete_all);
extern kal_bool l4c_eq_vm_append_req(kal_uint8 src_id, kal_wchar *file_name);
extern kal_bool l4c_eq_vm_rename_req(kal_uint8 src_id, kal_wchar *old_name, kal_wchar *new_name);
#else /* __FS_ON__ */ 
extern kal_bool l4c_eq_vm_play_req(kal_uint8 src_id, kal_uint8 fileid);
extern kal_bool l4c_eq_vm_delete_req(kal_uint8 src_id, kal_uint8 fileid, kal_bool delete_all);
...
#if defined(__NONE_USED_L4MMI_MESSAGE__)
extern kal_bool l4c_eq_set_dspl_text_req(kal_uint8 src_id, kal_uint8 *text_string);

extern kal_bool l4c_eq_set_indicator_req(kal_uint8 src_id, kal_uint8 icon_id, kal_uint8 value);

extern kal_bool l4c_eq_get_indicator_req(kal_uint8 src_id, kal_uint8 icon_id, kal_uint8 *value);
#endif
...
#if defined(__NONE_USED_L4MMI_MESSAGE__)
extern kal_bool l4c_eq_set_country_code_req(kal_uint8 src_id, kal_uint8 country_code);

extern kal_bool l4c_eq_get_country_code_req(kal_uint8 src_id, kal_uint8 *country_code);

extern kal_bool l4c_eq_get_battery_status_req(kal_uint8 src_id, kal_uint8 *battery_status, kal_uint8 *battery_vol);
#endif
...
#if defined(__NONE_USED_L4MMI_MESSAGE__)
extern kal_bool l4c_update_mmi_default_prof_value_req(
                    kal_uint8 category,
                    kal_uint8 param1,
                    kal_uint8 param2,
                    kal_uint8 param3);
...
#if defined(__NONE_USED_L4MMI_MESSAGE__)
extern kal_bool l4c_eq_read_ms_imei_req(kal_uint8 src_id, nvram_lid_enum file_idx, kal_uint8 para);
#endif
...
#ifdef __LTE_RAT__
extern kal_bool l4c_eq_rx_rssi_verify_req(kal_uint8 band, kal_uint16 dl_earfcn);
