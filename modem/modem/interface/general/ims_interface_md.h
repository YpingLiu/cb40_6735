...
*/
#define IMCB_IMC_HEADER_FILE_VERNO  0x00000047
...
#define IMC_MAX_CCCI_BUFFER_LEN     3456
typedef enum {
...
typedef struct {
    ...
    imcf_uint32 tlv_dst;
    imcf_uint8  data[IMC_MAX_CCCI_BUFFER_LEN-16]; //imcb_imc_tlv_struct
