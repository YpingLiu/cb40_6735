 ...
 *------------------------------------------------------------------------------
 * $Revision:   1.34  $
 * $Modtime:   Jul 29 2005 13:41:38  $
 * $Log:   //mtkvs01/vmdata/Maui_sw/archives/mcu/l1/l1d/l1d_cid.h-arc  $
 *
 * 05 18 2015 dou.ju
 * removed!
 * 	.
 ...
 * removed!
 * removed!
 * 	[MOLY00073031]Rollback [MT6592][Hero2][CMCC case][op01_sglte_dsds][RRM][6200][TG][4.3.9.5]FAIL
 * 	.
 *
 * removed!
 * removed!
 ...
 * removed!
 * removed!
 * Merge back to MOLY for possible future usage and default OFF.
 *
 * removed!
 * removed!
 * 	.
 ...
 * removed!
 * removed!
 * SW workaround solution for MT6276E2 DSP fatal error issue.
 *
 * removed!
 * removed!
 * .
 ...
 * removed!
 * removed!
 * .add UL1D/ L1D code modifition code for AGPS
 *
 * removed!
 * removed!
 * .
 ...
 * removed!
 * removed!
 * Add a IS_CENTRALIZED_SMM_CHIP if defined(__CENTRALIZED_SLEEP_MANAGER__)
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Move IS_L1_R2BC_SUPPORT to l1d_def.h
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * [UL1D][Modify] Check in MT6160 RF Chip ID Detect Functions
 *
 * removed!
 * removed!
 * Roll back since some issue happened
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Disable MT6268A TDMA no sleep configuration temporarily
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * [L1D][Modify] Open IS_LC_Support for FHC support 33-sections calibration
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * [L1D][Modify] Move Partial memory definition to the end of this file to fix IS_GEMINI_SUPPORT warning
 *
 * removed!
 * removed!
 * [L1D][Modify] 1. Check in IS_MPLL_FLT compile option for MT6253T MPLL FH. 2. Modify IS_65NM_CHIP, IS_65NM_CHIP_BSI_BPI_PWN and IS_SOC_CHIP. 3. Repalce coding to let this file be more clear.
 *
 * removed!
 * removed!
 * [L1D][Modify] Add code IS_PARTIAL_INTERNCODE for MT6253T
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * [L1D][Modify] Check in code for MT6253T MPLL FH
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * [L1D][Modify] Check in AD6546 Driver
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * [L1D][Modify] IS_CHIP_EQ34311 (DSP central weighting window) is defined for L1C to adjust the upper bound to recalibrate 32k Xtal : 1=> upper bound 24; 0=> upper bound 32
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Enable L1D_PM_1R7PM and L1D_PCH_1BURST_DECODE feature for MT6268T
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Disable PCH_1BURST_DECODE feature for MONZA29, VENUS, MT6268T
 *
 * removed!
 * removed!
 * Remove L1D_PM_1R7PM, L1D_PCH_EMPTY_PATTERN compile warning for those chips which do not support
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Add SW workaround to lock DCM when in RFTOOL mode for MT6227, MT6228 chips
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Turn on EMPTY pattern support for 6238 and latter chips
 *
 * removed!
 * removed!
 * Add compile option IS_PM_DONE_CHECK_SUPPORT
 *
 * removed!
 * removed!
 * #defined IS_### defined(####) can't work correctly in VC compiler. Change it to #defined  IS_### (defined #### )
 *
 *
 * removed!
 * removed!
 ...
 * removed!
 * removed!
 * Modify for the MT6223P
 *
 * removed!
 * removed!
 * Modify for the MT6223P compile option
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * Add the MT6223P compile option and modify the FACCH reduce compile option
 *
 * removed!
 * removed!
 *
 ...
 * removed!
 * removed!
 * exclude MT6229 S00 and S01 from supported chip list
 *
 * removed!
 * removed!
 *
 ...
 *
 *
 *    Rev 1.34   Jul 29 2005 14:00:16   mtk00773
 * [L1D][Enhence] Support RF SKY74117
 * Resolution for 12111: [L1D][Enhence] Support RF SKY74117
 *
 *    Rev 1.33   Jul 08 2005 16:53:02   mtk00939
 * [L1D][Modify]L1D add code for MT6139C and META related code
 *
 *    Rev 1.32   Jun 21 2005 09:52:56   mtk00939
 *  [L1][Modify]Add compile option for MT6227
 *
 *    Rev 1.31   May 17 2005 00:34:18   BM_Trunk
 * Karlos:
 * add copyright and disclaimer statement
 *
 *    Rev 1.30   Jan 18 2005 00:37:54   BM
 * append new line in W05.04
 *
 *    Rev 1.29   Oct 01 2004 21:14:46   mtk00703
 * Modify the compile options to avoid the bugs of VC++
 * Resolution for 7985: [L1D][Modify]Add MT6217 support on GPRS June Branch
 *
 *    Rev 1.28   Sep 22 2004 10:27:30   mtk00240
 ...
 *
 *    Rev 1.27   Sep 08 2004 18:00:08   mtk00703
 * Add MT6229 EDGE Group and EDGE Mode Compile Options.
 * Modify Compile Options for L1Sim.
 * Resolution for 7576: [L1D][Modify]Add MT6229 and EDGE Mode Compile Options
 *
 *    Rev 1.26   Sep 03 2004 17:16:50   mtk00773
 * Support MT6219_EV chip
 * Resolution for 7477: [L1D][Modify]  Support MT6219_EV chip
 *
 *    Rev 1.25   Sep 03 2004 10:22:10   mtk00240
 * For the mt6217 DVT & mt6228 Co-sim requirement, add these 2 chip's compile option in l1d_cid.h
 * Resolution for 7470: [L1D] Add mt6217 & mt6228 compile option support
 *
 *    Rev 1.24   Jul 30 2004 17:37:06   mtk00240
 * L1D add code to support AERO1Plus RF chip
 * Resolution for 6925: [L1D][Enhance] L1D add code to support AERO1Plus RF chip
 *
 *    Rev 1.23   Jul 14 2004 10:13:02   mtk00773
 * Add definition for l1 simulation use
 *
 *    Rev 1.22   Jul 09 2004 17:58:52   mtk00773
 * Put back the RF MT6129D define, and modify one RF POLARIS1 define
 *
 *    Rev 1.21   Jul 05 2004 15:46:40   mtk00773
 * Add RF POLARIS1 setting
 * Resolution for 6489: [L1D][Enhence] Support RF POLARIS1 (RFMD)
 *
 *    Rev 1.20   Jun 05 2004 15:09:02   mtk00240
 * Add mt6218_FN & mt6218B_FN option
 * Resolution for 5878: [L1D][Fix DSP Bug] Fix DSP bug about 4QB shift of timing offset report of NB in GPRS mode
 *
 *    Rev 1.19   May 21 2004 19:01:56   mtk00240
 * Add code to support MT6129D
 * Resolution for 5565: [L1D][Add Feature] Add code to support MT6129D
 *
 *    Rev 1.18   May 21 2004 14:53:30   mtk00240
 ...
 *
 *    Rev 1.17   Jan 27 2004 15:33:12   mtk00585
 * [L1D][Add] L1D Add code for MT6129C RF Driver.
 *
 *    Rev 1.16   Oct 23 2003 14:20:52   mtk00585
 * [L1D][Add] L1D Add code for MT6129B RF Driver.
 * Resolution for 3177: [L1D][Add] L1D Add code for MT6129B RF Driver.
 *
 *    Rev 1.15   Oct 01 2003 15:16:32   mtk00585
 * [L1D][Modify]L1D modify code for MT6219
 * Resolution for 3037: [L1D][Modify]L1D modify code for MT6219
 *
 *    Rev 1.14   Jul 11 2003 17:42:48   mtk00489
 * [L1D][Enhanced]L1D supports MT6218B
 * Resolution for 2245: [L1D][Enhanced]L1D supports MT6218B
 *
 *    Rev 1.13   Jul 11 2003 17:41:30   mtk00489
 * [L1D][Enhanced]L1D supports MT6129A
 * Resolution for 2241: [L1D][Enhanced]L1D supports MT6129A
 *
 *    Rev 1.12   Jun 23 2003 18:01:16   mtk00489
 * [L1D][Enhanced]L1D ONLY use software control RFVCO for FOUNTAIN2 and FOUNTAIN3, otherwise use hardware control RFVCO. Besides, check in KLM2003_FOUNTAIN2 for baseline code.
 * Resolution for 2100: [L1D][Enhanced]L1D ONLY use software control RFVCO for FOUNTAIN2 and FOUNTAIN3, otherwise use hardware control RFVCO. Besides, check in KLM2003_FOUNTAIN2 for baseline code.
 *
 *    Rev 1.11   Jun 06 2003 18:42:40   mtk00489
 ...
 *
 *    Rev 1.10   May 16 2003 13:09:22   mtk00489
 * [L1D][New Feature]L1D supports MT6119C
 * Resolution for 1794: [L1D][New Feature]L1D supports MT6119C
 *
 *    Rev 1.9   05 Dec 2002 10:50:24   mtk00240
 * L1D add code to support MT6218
 * Resolution for 581: L1D add code to support MT6218
 *
 *    Rev 1.8   01 Nov 2002 11:17:50   mtk00240
 * L1D add new compile option for MT6205B
 * Resolution for 544: L1D add new compile option for MT6205B
 *
 *    Rev 1.7   12 Sep 2002 14:14:42   mtk00240
 * Fix the bug that __PS_SERVICE__ and __CS_SERVICE__ bith exist
 * Resolution for 460: L1D modifed GPRS related code to support MAUI
 *
 *    Rev 1.6   12 Sep 2002 10:57:34   mtk00240
 * Add __PS_SERVICE__ and __CS_SERVICE__ compile option
 * Resolution for 460: L1D modifed GPRS related code to support MAUI
 *
 *    Rev 1.5   24 Aug 2002 14:10:46   mtk00240
 *  L1D add code to support AERO RF Module
 * Resolution for 464:  L1D add code to support AERO RF Module
 *
 *    Rev 1.4   18 Jul 2002 11:47:46   mtk00240
 * L1D change the compile option for BB and RF chip
 *
 *    Rev 1.3   02 May 2002 14:26:12   mtk00240
 * Reduce warnnings n compiling time for MT6205
 * Resolution for 384: Extract GSM code from L1D
 *
 *    Rev 1.2   02 May 2002 10:05:42   mtk00240
 * Support MTK_GPRS_ENABLE AND GPRS==1
 * Resolution for 384: Extract GSM code from L1D
 *
 *    Rev 1.1   02 May 2001 08:56:16   mtk00240
 * Add compile ID for GSM/GPRS
 * Resolution for 384: Extract GSM code from L1D
 *
 *    Rev 1.0   May 02 2002 08:46:16   admin
 * Initial revision.
 *******************************************************************************/
...
#define  CHIP_ID_MT6735          0x00010091
...
#define  IS_CHIP_MT6735                       ( CHIP_ID==CHIP_ID_MT6735 )

/* For L1C usage */
/* CS3 requirement, CS3 would request us to update them */
#define  IS_CHIP_MT623538                     IS_CHIP_MT6238
#define  IS_CHIP_MT6235_SER                   ( defined(MT6235) || defined(MT6235B) )
#define  IS_CHIP_MT6238_SER                   ( IS_CHIP_MT623538 && !IS_CHIP_MT6235_SER )
#define  IS_HYPER_SLEEP_MODE_CHIP             ((IS_CHIP_MT6238_SER || IS_CHIP_MT6516 || IS_CHIP_MT6268B || IS_CHIP_MT6253 || IS_CHIP_MT6236 || IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2) && !defined(MT6516_S00) )
...
#define  IS_LTE_CHIP_MT6290_AND_LATTER_VERSION        ( IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6290) && !IS_CHIP_MT6752_MD2 )
#define  IS_LTE_CHIP_MT6595_AND_LATTER_VERSION        ( IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6595) && !IS_CHIP_MT6752_MD2 )
...
#define  IS_BPI_DATA_32_BIT_CHIP              ( IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6583_MD1) )
/* For chip with 32-bit of BSI_CON */
#define  IS_BSI_CON_32_BIT_CHIP               ( IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2 )
...
/* For SOC chip Group */
#define  IS_SOC_CHIP                          ( IS_CHIP_SER(CHIP_ID_MT6253) || (IS_CHIP_SER(CHIP_ID_MT6256)&&(!IS_CHIP_MT6583_MD1)&&(!IS_CHIP_MT6583_MD2)&&(!IS_CHIP_MT6572)&&(!IS_CHIP_MT6290)&&(!IS_CHIP_MT6595)&&(!IS_CHIP_MT6752_MD1)&&(!IS_CHIP_MT6752_MD2)&&(!IS_CHIP_MT6735)) )
/* For 3G group */
...
/*MT6223*/  #define  CHIP_ID     CHIP_ID_MT6223
   #endif
   #ifdef  MT6235    /* For L1 MT6235==MT6238 */
/*MT6235*/  #define  CHIP_ID     CHIP_ID_MT6238
   #endif
   #ifdef  MT6238
...
/*MT6253T*/ #define  CHIP_ID     CHIP_ID_MT6253T
   #endif
   #ifdef  MT6253
/*MT6253*/  #define  CHIP_ID     CHIP_ID_MT6253
   #endif
   #ifdef  MT6252H
/*MT6252*/  #define  CHIP_ID     CHIP_ID_MT6252H
   #endif
   #ifdef  MT6252
/*MT6252*/  #define  CHIP_ID     CHIP_ID_MT6252L
   #endif
   #ifdef  MT6253E
/*MT6253*/  #define  CHIP_ID     CHIP_ID_MT6252H
   #endif
   #ifdef  MT6253L
/*MT6253*/  #define  CHIP_ID     CHIP_ID_MT6252L
   #endif
   #ifdef  MT6236
/*MT6236*/  #define  CHIP_ID     CHIP_ID_MT6236
   #endif
   #ifdef  MT6236B   /* For L1 MT6236B==MT6236 */
/*MT6236B*/ #define  CHIP_ID     CHIP_ID_MT6236
   #endif
   #ifdef  MT6270A
/*MT6270A*/ #define  CHIP_ID     CHIP_ID_MT6270A
   #endif
   #ifdef  MT6276
/*MT6276*/  #define  CHIP_ID     CHIP_ID_MT6276
   #endif
   #ifdef  MT6256
/*MT6256*/  #define  CHIP_ID     CHIP_ID_MT6256
   #endif
   #ifdef  MT6255
/*MT6255*/  #define  CHIP_ID     CHIP_ID_MT6255
   #endif
   #ifdef  MT6251
/*MT6251*/  #define  CHIP_ID     CHIP_ID_MT6251
   #endif
   #ifdef  MT6573
/*MT6573*/  #define  CHIP_ID     CHIP_ID_MT6573
   #endif
   #ifdef  MT6575
/*MT6575*/  #define  CHIP_ID     CHIP_ID_MT6575
   #endif
   #ifdef  MT6577
/*MT6577*/  #define  CHIP_ID     CHIP_ID_MT6577
   #endif
   #ifdef  MT6250
/*MT6250*/  #define  CHIP_ID     CHIP_ID_MT6250
   #endif
   #ifdef  MT6280
...
#error
   ...
   #endif
   #ifdef  MT6572
/*MT6572*/  #define  CHIP_ID     CHIP_ID_MT6572
   #endif
   #ifdef  MT6582
/*MT6582*/  #define  CHIP_ID     CHIP_ID_MT6582
   #endif
   #ifdef  MT6290
/*MT6290*/  #define  CHIP_ID     CHIP_ID_MT6290
   #endif
   #ifdef  MT6595
/*MT6595*/  #define  CHIP_ID     CHIP_ID_MT6595
   #endif
   #ifdef  MT6735
/*MT6595*/  #define  CHIP_ID     CHIP_ID_MT6735
   #endif
...
#define SIM_MT6229 MT6268T
   #elif defined(MT6276)
#define SIM_MT6229 MT6276
   #elif defined(MT6280)
#define SIM_MT6229 MT6280
   #elif defined(MT6575)
#define SIM_MT6229 MT6575
   #elif defined(MT6583)
#define SIM_MT6229 MT6583
   #elif defined(MT6752)
#define SIM_MT6229 MT6752
   #elif defined(MT6572)
#define SIM_MT6229 MT6572
   #elif defined(MT6582)
#define SIM_MT6229 MT6582
   #elif defined(MT6290)
#define SIM_MT6229 MT6290
   #elif defined(MT6595)
#define SIM_MT6229 MT6595
   #elif defined(MT6735)
#define SIM_MT6229 MT6735
   #else
#error
   #endif
#endif
...
#if defined(__GEMINI_GSM__) && defined(__UMTS_FDD_MODE__)
#define IS_GEMINI_WGG_SUPPORT                      1  /*WG+G*/
#else
#define IS_GEMINI_WGG_SUPPORT                      0
#endif

#if defined(__GEMINI_GSM__) && defined(__UMTS_TDD128_MODE__)
...
#if defined(L1D_TEST)  // loopback not ready for NEW L1D ARCH
...
#elif ( IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_CHIP_MT6582 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2 ) && defined(MTK_SLEEP_ENABLE)
#define IS_TDMAIRQ_TIMING_CHECK_BYPASS_SUPPORT     1
#else
...
#define IS_DEFAULT_TURNOFF_3GMTCMOS                0
   ...
   #if IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if (IS_SOC_CHIP && !defined(__L1D_SOC_NO_MPLLFH__)) || IS_CHIP_MT6236 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_CHIP_MT6251 || IS_CHIP_MT6252 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_NSFT_SUPPORT && IS_EPSK_TX_SUPPORT  && (defined __MTK_TARGET__)
...
#if IS_TDD_DUAL_MODE_SUPPORT && (IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2)
...
#define IS_AST3002_SUPPORT                         0
   ...
   #if IS_CHIP_MT6575 && defined(__AST3001__)
...
#define IS_TDD_DM_RF_INIT_HANDSHAKE_SUPPORT        1  /* Handle init flow of single RF controlled by separate TD/2G BB chips */
#define IS_TDD_DM_RF_POWER_CHECK_SUPPORT           1  /* Handle power-on/off sync of single RF controlled by separate TD/2G BB chips */
   #elif IS_AST3002_SUPPORT && (IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2)
#define IS_BSI_TRIG_OFFCHIP_BPI_SUPPORT            0  /* Trigger off-chip BPI pins by sending BSI data */
...
#if IS_TDD_DUAL_MODE_SUPPORT
   #if IS_CHIP_MT6290 || IS_CHIP_MT6595 || IS_CHIP_MT6752_MD1 || IS_CHIP_MT6735
...
#define IS_RRM_TD_GAP_SHORT_FB_WORKAROUND          0
   ...
   #if IS_CHIP_MT6236 || IS_CHIP_MT6252
#define IS_DSP_SHORT_FBSB_V1                       1
#define IS_DSP_SHORT_FBSB_V2                       0
#define IS_DSP_SHORT_SB_ENABLED                    0
   #elif defined(__AST2001__)
#define IS_DSP_SHORT_FBSB_V1                       0
#define IS_DSP_SHORT_FBSB_V2                       1
#define IS_DSP_SHORT_SB_ENABLED                    0
   #elif defined(__AST3001__) && (IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250)
#define IS_DSP_SHORT_FBSB_V1                       0
#define IS_DSP_SHORT_FBSB_V2                       1
#define IS_DSP_SHORT_SB_ENABLED                    0
   #else
...
#if defined(L1_SIM)
#define IS_MD_GPIO_API_SUPPORT                     0
#elif IS_CHIP_MT6575 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6280
#define IS_MD_GPIO_API_SUPPORT                     1
#else
#define IS_MD_GPIO_API_SUPPORT                     0
#endif
...
#define IS_HEADROOM_DETECTION_SUPPORT              1
   #if IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_SET_TX_BSI_CW_NEEDED                    0
   #else
...
#if IS_RF_MT6256RF || IS_RF_MT6251RF || IS_RF_MT6252RF || IS_RF_MT6255RF || IS_RF_MT6162 || IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6169 || IS_RF_MT6166 || IS_RF_MT6165
...
#define IS_W_CANCELLATION_SUPPORT                  1
   #endif
#elif IS_CHIP_MT6255 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_MT6251_DCR_MODE                         0
#define IS_MT6256_DCR_MODE                         0
#define IS_W_CANCELLATION_SUPPORT                  1
#define IS_MT6251_E1_FT                            0
...
#elif IS_CHIP_MT6582 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_SPEECH_RESYNC_SUPPORT                   0
...
#define IS_WC_IMM_MODE_ENABLE                      0
   ...
   #if IS_RF_MT6256RF || IS_RF_MT6162 || IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6169 || IS_RF_MT6166 || IS_RF_MT6165
...
#if IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6577 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_ABB_HW_CALIBRATION_SUPPORT              1
#else
#define IS_ABB_HW_CALIBRATION_SUPPORT              0
#endif

#if IS_EDGE_SAIC_CHIP_MT6256_AND_LATTER_VERSION || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6252 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define IS_BSI_V1_SUPPORT                          (!IS_BSI_V2_SUPPORT)
   ...
   #if IS_CHIP_MT6256 || IS_CHIP_MT6252 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define IS_TXPC_OL_BSI_SUPPORT                     0
   #elif IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_TXPC_CL_AUXADC_SUPPORT                  0
#define IS_TXPC_CL_BSI_SUPPORT                     1
...
#if IS_RF_MT6162 || IS_RF_MT6256RF || IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6169 || IS_RF_MT6166 || IS_RF_MT6165
...
#if IS_RF_MT6169
#define IS_DYNAMIC_GAINTABLE_SWITCH_SUPPORT        1
#else
#define IS_DYNAMIC_GAINTABLE_SWITCH_SUPPORT        0
#endif
#if IS_GPRS
...
#define IS_ADJUSTABLE_LNA_MODE_CALIBRATION_SUPPORT_V2 0  /* pathloss cal with one LNA or multi-lna mode are adjustable by tool config, and LNA Mode can be choose by L1  */
   #elif defined(__DUAL_TALK_SUPPORT__)
#define IS_MULTI_LNA_MODE_CALIBRATION_SUPPORT         1
#define IS_ADJUSTABLE_LNA_MODE_CALIBRATION_SUPPORT    0  /* pathloss cal with one LNA or multi-lna mode are adjustable by tool config  */
#define IS_ADJUSTABLE_LNA_MODE_CALIBRATION_SUPPORT_V2 1  /* pathloss cal with one LNA or multi-lna mode are adjustable by tool config, and LNA Mode can be choose by L1  */
   #else
#define IS_MULTI_LNA_MODE_CALIBRATION_SUPPORT         1
...
#if defined (__DUAL_TALK_RX_GAIN_TABLE_CO_BAND_SUPPORT__) || defined(__DUAL_TALK_SUPPORT__)
   #if IS_RF_MT6166
#define IS_DUAL_TALK_RX_GAIN_TABLE_CO_BAND_SUPPORT 1
   #else
...
#if IS_EPSK_TX_SUPPORT
   #if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6583_MD2
...
#define IS_DYNAMIC_G_E_TXWIN_POSITION_SUPPORT_V2   0  /* Change the GMSK and EPSK TX window positions dynamically by frames */
   ...
   #elif IS_CHIP_MT6256 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2 || defined(__L1_GPS_CO_CLOCK_SUPPORT__)
...
#if IS_RF_MT6166 || IS_RF_MT6165 || IS_RF_MT6169
...
#if defined(__L1_LOCK_AFCDAC_AT_STARTUP_SUPPORT__) && IS_DUAL_LOOP_AFC_CONTROL_SUPPORT
...
#if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
#define IS_RESEND_AFC_DATA_REQUIRED                1
#else
#define IS_RESEND_AFC_DATA_REQUIRED                0
#endif

/* IS_AFC_EVENT_SUPPORT_CHIP: decide if the chip supports the AFC event register                    */
#if IS_AST_B2S_SUPPORT || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_SOC_CHIP || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_RF_MT6252RF || IS_RF_MT6251RF || IS_RF_MT6256RF || IS_RF_MT6255RF || IS_RF_MT6162 || IS_RF_MT6163 || IS_RF_MT6250RF || IS_RF_MT6280RF || IS_RF_MT6169 || IS_RF_MT6166 || IS_RF_MT6165
...
#if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
/* workaround for low 2G RX performance due to large wifi TX power. */
#if IS_CHIP_MT6255 || IS_CHIP_MT6250
#define IS_WIFI_ADAPTIVE_POWER_CONTROL_SUPPORT     1
#else
#define IS_WIFI_ADAPTIVE_POWER_CONTROL_SUPPORT     0
#endif
...
#define IS_VAMOS_CAPABILITY                        1
   #if defined(__VAMOS_1__) || defined(__VAMOS_2__)
...
#if defined(L1D_TEST) && (IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2)
...
#define IS_L1D_INJECT_STRING_DEBUG_ON              0
...
#define IS_LOW_POWER_HQA_PDN_SUPPORT               1
#elif IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_DCM_ISSUE_WORKAROUND_ON                 0
...
#if IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_LTE_CHIP_MT6290_AND_LATTER_VERSION
...
#if IS_MIPI_SUPPORT && IS_LTE_CHIP_MT6290_AND_LATTER_VERSION
#define IS_MIPI_CENTRAL_CONTROL_SUPPORT            1
#else
#define IS_MIPI_CENTRAL_CONTROL_SUPPORT            0
#endif

#if IS_MIPI_CENTRAL_CONTROL_SUPPORT && (IS_RF_MT6169 || IS_RF_MT6165)
...
#define IS_DSDA_DCS_TX_NOTCH_SWITCH_ENABLE         1
   #else
...
#if defined (__CSFB_WITH_SGLTE_HW__) && IS_TDD_DUAL_MODE_SUPPORT
#define IS_CSFB_WITH_SGLTE_HW_ENABLE               1
#else
...
#if IS_LTE_CHIP_MT6290_AND_LATTER_VERSION /* Chipset support MML1 and DRDI */
...
#if defined(__TAS_FOR_C2K_ONOFF_SUPPORT__)
#define IS_2G_TAS_FOR_C2K_ONOFF_SUPPORT              1
#else
#define IS_2G_TAS_FOR_C2K_ONOFF_SUPPORT              0
#endif
...
// default value
/* ------------------------------------------------------------- */
#if IS_CHIP_MT6205 || IS_CHIP_MT6225 || IS_CHIP_MT6223 || IS_CHIP_MT6238_SER || IS_CHIP_MT6276 || IS_CHIP_MT6251 || IS_CHIP_MT6573 || IS_CHIP_MT6252 || IS_CHIP_MT6256 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define INTERNCODE_DEFAULT                         INTERN_NULL
#else
#define INTERNCODE_DEFAULT                         INTERN_FULL
#endif
/* ------------------------------------------------------------- */
#if IS_CHIP_MT6205 || IS_CHIP_MT6225 || IS_CHIP_MT6223 || IS_CHIP_MT6238_SER || IS_CHIP_MT6276 || IS_CHIP_MT6253 || IS_CHIP_MT6251  || IS_CHIP_MT6573 || IS_CHIP_MT6256 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
