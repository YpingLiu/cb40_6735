...
#if defined(__SIM_MMDS_CLIENT__) || defined(__SGLTE__) || defined(__APVSIM__)
...
extern void sat_utk_enabled_update_req_handler(ilm_struct *sim_ilm_ptr, sim_context_struct *this_sim);
...
extern void sim_cdma_detection(sim_context_struct *this_sim);
...
extern kal_bool op09_sim_need_locked(kal_uint8 *imsi);
