...
#if defined(__SIM_MMDS_SERVER__)
void l4c_sim_mmdc_file_change_rind(sat_file_change_ind_struct *msg_ptr);
#endif
...
extern void l4c_sat_evdl_call_rind(kal_uint8 ti, kal_uint8 status, kal_bool is_mt_call, kal_bool is_far_end, kal_uint8 *cause, kal_uint8 cause_len);
...
extern void l4c_cc_update_call_state_rind(kal_uint8 msg_type,kal_uint8 call_id);
...
extern void l4c_cc_call_present_rind(kal_uint8 call_id, l4c_number_struct *addr, kal_uint8 seq_no, l4c_number_struct *redirect_addr);

extern void l4c_ps_connect_rind(void);

extern void l4c_ps_activate_rind(void);
...
extern void l4c_nw_signal_quality_rind(kal_uint8 sig1, kal_uint8 sig2, kal_uint8 ber, kal_int32 rssi_in_qdbm, kal_int32 RSCP_in_qdbm, kal_int32 EcN0_in_qdbm, kal_int32 RSRQ_in_qdbm, kal_int32 RSRP_in_qdbm, l4c_rat_enum rat, kal_int16 rs_snr_in_qdb);
...
extern void l4c_sim_access_extmd_rind(sim_access_extmd_ind_struct *sim_extmd_ind_ptr);
#endif
...
extern void l4c_sim_usim_type_rind(kal_uint8 is_usim, kal_uint8 cdma_info);
...
extern void l4c_sim_isCTcard_rind(void);
...
extern void l4c_sat_estknum_ind(kal_uint8 *addr, kal_uint8 no_addr); // stkcallnumber
#endif
...
extern void l4c_nw_ecell_report(void);

extern void l4c_nw_ecell_rind(void);
...
extern void l4c_nw_feature_rind(kal_uint8 active_rat, void *nw_featute);
...
extern void l4c_nw_ims_cell_info_update_rind(reg_state_enum gprs_state, cell_info_and_rat_struct *cell_info);
...
extern void l4c_nw_ims_service_rind(kal_uint8 service_type);

extern void l4c_gas_afr_rind(kal_bool is_afr_triggered);
...
#ifdef __SGLTE__
extern void l4c_psdm_psd_rind(psdm_psd_enum ps_decision, mmdc_psd_switch_cause_enum cause);
extern void l4c_eval_cap_change_rind(kal_bool is_b39_supported);
extern void l4c_rac_ps_event_rind();
#endif
