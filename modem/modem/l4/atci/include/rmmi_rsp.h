...
extern void l4c_smu_sml_status_rrsp(kal_bool result,kal_uint8*  state,kal_uint8*  retry_count,
...
extern void l4c_sim_manage_channel_rrsp(l4c_result_struct result, kal_uint8 channel_id, l4c_action_enum action);
...
extern void l4c_eq_read_ms_imei_rrsp(l4c_result_struct result, kal_uint16 length, kal_uint8 *data);
#endif
...
extern void l4c_nw_fake_cfg_rrsp(kal_uint8 src_id, kal_bool result);
