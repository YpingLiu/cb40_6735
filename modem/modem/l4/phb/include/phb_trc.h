...
BEGIN_TRACE_MAP(MOD_PHB)
   ...
   TRC_MSG(FUNC_PHB_SIM_SEARCH_RECORD, "[PHB] phb_sim_search_record")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_RECORD_CNF, "[PHB] phb_sim_search_record_cnf")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_ADN_RECORD_CNF, "[PHB] phb_search_adn_record_cnf, phb_seek_adn_bitmap[%d] = %x")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_RECORD_READ_ADN, "[PHB] phb_search_record_read_adn, phb_seek_done: %d, record_index: %d")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_IAP_RECORD_CNF, "[PHB] phb_search_iap_record_cnf, phb_seek_iap_bitmap[%d] = %x")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_RECORD_READ_IAP, "[PHB] phb_search_record_read_iap, phb_seek_done: %d, record_index: %d")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_PBC_RECORD_CNF, "[PHB] phb_search_pbc_record_cnf, phb_seek_pbc_bitmap[%d] = %x")
   TRC_MSG(FUNC_PHB_SIM_SEARCH_RECORD_READ_PBC, "[PHB] phb_search_record_read_pbc, phb_seek_done: %d, record_index: %d")
