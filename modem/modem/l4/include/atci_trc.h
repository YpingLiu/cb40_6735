...
BEGIN_TRACE_MAP(MOD_ATCI)
   ...
   TRC_MSG(FUNC_L4C_SMU_GET_SIM_LOCK_STATUS_RRSP_ENTRY, "l4c_smu_get_sim_lock_status_rrsp()")
   ...
   TRC_MSG(FUNC_L4C_SAT_PROFILE_WRITE_RRSP_ENTRY, "l4c_sat_profile_write_rrsp()")
   ...
   TRC_MSG(FUNC_RMMI_EDE_HDLR_ENTRY, "rmmi_ede_hdlr()")
   ...
   TRC_MSG(WARNING_EPOF_WAIT_MD3_PWROFF, "Warning: wait MD3 power off, pending EPOF")
