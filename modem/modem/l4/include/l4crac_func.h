...
/*****************************************************************************
* FUNCTION
*  l4crac_set_project_type
* DESCRIPTION
*  To Set the AP project in rac_global_context
*
* PARAMETERS
*  type: 0: not specified (default value)
*          1: Basic Project
*          2:BSP Project
*          3:Turnkey Project
*
...
*  none
*****************************************************************************/
extern kal_bool l4crac_set_project_type(rac_project_type_enum project_type);

/*****************************************************************************
* FUNCTION
*  l4crac_get_project_type
* DESCRIPTION
*  Returns the AP project type
*
* PARAMETERS
*  none
*
* RETURNS
*  rac_project_type_enum
* GLOBALS AFFECTED
*  none
*****************************************************************************/
extern rac_project_type_enum l4crac_get_project_type(void);
