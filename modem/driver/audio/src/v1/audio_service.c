...
#elif defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(MT6752) || defined(MT6735)
...
//    toneLoopbackRecInit(); // remove legency file and function
   ...
   L1Audio_FreeAudioID( initaud_id );
		...
		L1SP_Speech_On(0);
#endif
#if defined(MT6735) && (MDAFE_DVT_CASE1 || MDAFE_DVT_CASE2 || MDAFE_DVT_CASE3 || APAUDSYS_DVT_8K || APAUDSYS_DVT_16K || APAUDSYS_DVT_32K)
		kal_prompt_trace(MOD_L1SP, "DVT speechOn");
		kal_sleep_task(3);
		L1SP_Speech_On(0);
#endif
...
void l1audio_console_handler(kal_char *string)
{
   ...
   if(strcmp(string, "VIO18")==0) {
      ...
      kal_prompt_trace(MOD_L1SP, "l1audio_console_handler VIO18 ON");
      set_vio18_setting(1);
   }
   else if(strcmp(string, "VIO18OFF")==0) {
      void set_vio18_setting(int val);
      kal_prompt_trace(MOD_L1SP, "l1audio_console_handler VIO18 OFF");
      set_vio18_setting(0);
   }
