...
#ifdef __TAS_SUPPORT__
#define ANT0_BPI_NUM   11  // TAS Antenna 0 BPI Number
#define ANT1_BPI_NUM   11  // TAS Antenna 1 BPI Number

#define TDS_TAS_ENA    1  // TAS Enable Flag, [0 - TAS Disable, 1 - TAS Enable]
#else
#define TDS_TAS_ENA    0  // TAS Enable Flag, [0 - TAS Disable, 1 - TAS Enable]
#endif
...
//T_IQ_SWAP_CFG_STRUCT
 ...
 #ifdef __TAS_SUPPORT__
 {
	 TDS_TAS_ENA,			 // TDS TAS Enable
	 ANTENNA_0,			 	 // TAS Default Main Physical Antenna
	 2,// TAS Default Type: 0 - Disable   1 - With Rx Diversity   2 - Without Rx Diversity, Fixed
	 (TDS_BAND34_SUPPORT_TAS<<0) + (TDS_BAND39_SUPPORT_TAS<<1) + (TDS_BAND40_SUPPORT_TAS<<2),	// TAS Type by Band
	 TDS_FORCE_TX_ANT_SWITCH,// TAS Force Tx Antenna Enable
	 ANTENNA_0,			 	 // TAS Force Tx Antenna Index
	 TAS_TEST_SIM_ENABLE     // TDS TAS Test Sim Enable
 }
#endif
}};
 #endif
 ...
 // [7:4]     [3:0] 	
  ...
  /////////////////////DBB_BPI_AREA1 begin (fix for TX Control )/////////////////////////////
...
#ifdef __TAS_SUPPORT__
         (1<<ANT0_BPI_NUM) + (1<<6) + (1<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (1<<26)+ (1<<27) + (1<<28),	   //TX_CTRL_BITMASK   data[1]	    
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G34 PA_HGAIN  data[2]	    
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G34 PA_MGAIN  data[3]	    
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G34 PA_LGAIN  data[4]	    
		 (0<<ANT0_BPI_NUM) + (1<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G01 PA_HGAIN  data[5]	    
		 (0<<ANT0_BPI_NUM) + (1<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (0<<21)+ (1<<26)+ (0<<27) + (1<<28),     //TX_2G01 PA_MGAIN  data[6]	    
		 (0<<ANT0_BPI_NUM) + (1<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (0<<21)+ (1<<26)+ (1<<27) + (1<<28),	   //TX_2G01 PA_LGAIN  data[7]	    
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_1G90 PA_HGAIN  data[8]	    
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (1<<26)+ (0<<27) + (1<<28),	   //TX_1G90 PA_MGAIN  data[9]	    
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (1<<26)+ (1<<27) + (1<<28),	   //TX_1G90 PA_LGAIN  data[10]     
		 (0<<ANT0_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (0<<28),		   //TX_DISABLE	       data[11] 
#else										
	...
	/////////////////////DBB_BPI_AREA2 begin (fix for RX Control)///////////////////////////
#ifdef __TAS_SUPPORT__
         (1<<ANT0_BPI_NUM) + (1<<19) + (1<<20) + (1<<21) + (1<<28),	 //RX_CTRL_BITMASK	 data[12]	    
		 (0<<ANT0_BPI_NUM) + (0<<19) + (0<<20) + (0<<21) + (0<<28),	 //RX_2G34			     data[13]	
		 (0<<ANT0_BPI_NUM) + (0<<19) + (1<<20) + (0<<21) + (1<<28),	 //RX_2G01			     data[14]	
		 (0<<ANT0_BPI_NUM) + (0<<19) + (0<<20) + (0<<21) + (1<<28),	 //RX_1G90			     data[15]	
	     (0<<ANT0_BPI_NUM) + (0<<19) + (0<<20) + (0<<21) + (0<<28),	   //RX_DISABLE		     data[16]	
#else								
		//V1	  V2	   V3		  RFconflict										
  ...
  /////////////////////DBB_BPI_AREA1 begin (fix for TX Control )/////////////////////////////
		//MODE	  BS1	   BS2		  VC1		VC2 	 RFconflict 								
		 (1<<ANT1_BPI_NUM) + (1<<6) + (1<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (1<<26)+ (1<<27) + (1<<28),	   //TX_CTRL_BITMASK   data[1]	    
		 (1<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G34 PA_HGAIN  data[2]	    
		 (1<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G34 PA_MGAIN  data[3]	    
		 (1<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G34 PA_LGAIN  data[4]	    
		 (1<<ANT1_BPI_NUM) + (1<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_2G01 PA_HGAIN  data[5]	    
		 (1<<ANT1_BPI_NUM) + (1<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (0<<21)+ (1<<26)+ (0<<27) + (1<<28),     //TX_2G01 PA_MGAIN  data[6]	    
		 (1<<ANT1_BPI_NUM) + (1<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (0<<21)+ (1<<26)+ (1<<27) + (1<<28),	   //TX_2G01 PA_LGAIN  data[7]	    
		 (1<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (0<<26)+ (0<<27) + (1<<28),	   //TX_1G90 PA_HGAIN  data[8]	    
		 (1<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (1<<26)+ (0<<27) + (1<<28),	   //TX_1G90 PA_MGAIN  data[9]	    
		 (1<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (1<<10) + (1<<19) + (1<<20)+ (1<<21)+ (1<<26)+ (1<<27) + (1<<28),	   //TX_1G90 PA_LGAIN  data[10]     
		 (0<<ANT1_BPI_NUM) + (0<<6) + (0<<9) + (0<<10) + (0<<19) + (0<<20)+ (0<<21)+ (0<<26)+ (0<<27) + (0<<28),		   //TX_DISABLE	       data[11] 
	/////////////////////DBB_BPI_AREA1 end///////////////////////////////////////////////////
	  },
	...
	/////////////////////DBB_BPI_AREA2 begin (fix for RX Control)///////////////////////////
		//MODE	  BS1	   BS2		  VC1	  VC2		  RFconflict										
		 (1<<ANT1_BPI_NUM) + (1<<19) + (1<<20) + (1<<21) + (1<<28),	 //RX_CTRL_BITMASK	 data[12]	    
		 (1<<ANT1_BPI_NUM) + (0<<19) + (0<<20) + (0<<21) + (0<<28),	 //RX_2G34			     data[13]	
		 (1<<ANT1_BPI_NUM) + (0<<19) + (1<<20) + (0<<21) + (1<<28),	 //RX_2G01			     data[14]	
		 (1<<ANT1_BPI_NUM) + (0<<19) + (0<<20) + (0<<21) + (1<<28),	 //RX_1G90			     data[15]	
	     (0<<ANT1_BPI_NUM) + (0<<19) + (0<<20) + (0<<21) + (0<<28),	   //RX_DISABLE		     data[16]	
	 /////////////////////DBB_BPI_AREA2 end///////////////////////////////////////////////////
    },
#endif    
