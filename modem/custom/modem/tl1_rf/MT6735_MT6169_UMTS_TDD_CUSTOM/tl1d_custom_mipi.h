...
/*MT6169*/   #define  MIPI_ASM      0xf         //ASM slave id
...
T_MIPI_CUSTOMIZATION_STRUCT AST_TL1_RFFE_PARAMETER_DEFAULT[] ={
{
	...
	//MIPI Data table
	{
			//Rx On Data
			{
				...
				{  /*  0 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x3800,                0x0F5C,                0x3800,                0x0F5C},
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x0400,                0x0F40,                0x0D00,                0x0F40},
			...
			{
				/*            module      |     port          ,     band34 low 16bit    ,   band34 high 16bit   ,   band39 low 16bit   ,    band39 high 16bit  */
				{  /*  0 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x0000,                0x0F40,                0x0000,                0x0F40},
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x3800,                0x0F5C,                0x3800,                0x0F5C},
				{  /*  2 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  3 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  4 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  5 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
			...
			{
				/*            module      |     port          ,     band34 low 16bit    ,   band34 high 16bit   ,   band39 low 16bit   ,    band39 high 16bit  */
				{  /*  0 */  MIPI_ASM       | (MIPI_PORT1<<15),        PA_REG_NUM_B34,           PA_SEL_FLAG,        PA_REG_NUM_B39,           PA_SEL_FLAG},
				{  /*  1 */  DATA_NULL     |         (0<<15),                     0,                     0,                     0,                     0},
				{  /*  2 */  DATA_NULL     |         (0<<15),                     0,                     0,                     0,                     0},
				{  /*  3 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  4 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
	...
	{		  
			{
				/*            module      |     port          ,     band34 low 16bit    ,   band34 high 16bit   ,   band39 low 16bit   ,    band39 high 16bit  */
				{  /*  0 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x3800,                0x0F5C,                0x3800,                0x0F5C},//FOR PA HIGH MODE 
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x0F00,                0x0F40,                0x0F00,                0x0F40},//FOR PA HIGH MODE
				{  /*  2 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x6F00,                0x0F41,                0x6F00,                0x0F41},//FOR PA HIGH MODE
				{  /*  3 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},//FOR PA High MODE
				{  /*  4 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},//FOR PA High MODE
				
		  },
			{
				/*            module      |     port          ,     band34 low 16bit    ,   band34 high 16bit   ,   band39 low 16bit   ,    band39 high 16bit  */
				{  /*  0 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x3800,                0x0F5C,                0x3800,                0x0F5C},//FOR PA MID MODE
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x0F00,                0x0F40,                0x0F00,                0x0F40},//FOR PA MID MODE
				{  /*  2 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x6F00,                0x0F41,                0x6F00,                0x0F41},//FOR PA MID MODE
				{  /*  3 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},//FOR PA MID MODE
				{  /*  4 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},//FOR PA MID MODE
				
			},
			{
				/*            module      |     port          ,     band34 low 16bit    ,   band34 high 16bit   ,   band39 low 16bit   ,    band39 high 16bit  */
				{  /*  0 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x3800,                0x0F5C,                0x3800,                0x0F5C},//FOR PA LOW MODE
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x0F00,                0x0F40,                0x0F00,                0x0F40},//FOR PA LOW MODE
				{  /*  2 */  MIPI_ASM     | (MIPI_PORT1<<15),	               0x2A00,                0x0F41,                0x2A00,                0x0F41},//FOR PA LOW MODE
				{  /*  3 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},//FOR PA LOW MODE
