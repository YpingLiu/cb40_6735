...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_RX_DATA[] = 
{
   ...
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 18050 /*100 kHz*/    ,0x00 , 0x05}, { 18238 /*100 kHz*/    ,0x00 , 0x05}, { 18425 /*100 kHz*/    ,0x00 , 0x05}, { 18612 /*100 kHz*/    ,0x00 , 0x05}, { 18800 /*100 kHz*/    ,0x00 , 0x05},} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_RX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 25700  /*100 kHz*/    ,0x00 , 0x01}, { 25825 /*100 kHz*/    ,0x00 , 0x01}, {  25950  /*100 kHz*/    ,0x00 , 0x01}, {  26075 /*100 kHz*/    ,0x00 , 0x01}, {  26200  /*100 kHz*/    ,0x00 , 0x01},} }, 
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band39_MIPI_RX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 18800 /*100 kHz*/    ,0x00 , 0x0D}, { 18900 /*100 kHz*/    ,0x00 , 0x0D}, { 19000 /*100 kHz*/    ,0x00 , 0x0D}, { 19100 /*100 kHz*/    ,0x00 , 0x0D}, { 19200 /*100 kHz*/    ,0x00 , 0x0D},} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_RX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 23000 /*100 kHz*/    ,0x00 , 0x03}, { 23250 /*100 kHz*/    ,0x00 , 0x03}, { 23500 /*100 kHz*/    ,0x00 , 0x03}, { 23750 /*100 kHz*/    ,0x00 , 0x03}, { 24000 /*100 kHz*/    ,0x00 , 0x03},} }, 
   ...
   { /* 3  */ LTE_MIPI_PA , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA1   ,{ { 23000 /*100 kHz*/    ,0x02 , 0x03}, { 23250 /*100 kHz*/    ,0x02 , 0x03}, { 23500 /*100 kHz*/    ,0x02 , 0x03}, { 23750  /*100 kHz*/    ,0x02 , 0x03}, { 24000 /*100 kHz*/    ,0x02 , 0x03},} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_RX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 24960 /*100 kHz*/    ,0x00 , 0x01}, { 25601 /*100 kHz*/    ,0x00 , 0x01}, { 26300 /*100 kHz*/    ,0x00 , 0x01}, { 26301 /*100 kHz*/    ,0x00 , 0x01}, { 26900 /*100 kHz*/    ,0x00 , 0x01},} }, 
   ...
   { /* 3  */ LTE_MIPI_PA , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA1   ,{ { 24960 /*100 kHz*/    ,0x02 , 0x01}, { 25601 /*100 kHz*/    ,0x02 , 0x01}, { 26300 /*100 kHz*/    ,0x02 , 0x01}, { 26301 /*100 kHz*/    ,0x02 , 0x01}, { 26900 /*100 kHz*/    ,0x02 , 0x01},} }, 
...
LTE_MIPI_EVENT_TABLE_T LTE_Band1_MIPI_TX_EVENT[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_PA_TX_ON0 },//PA On
   { /* 1  */ LTE_MIPI_PA  , { 4    , 4    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_PA_TX_OFF0},//PA Off
   { /* 2  */ LTE_MIPI_ASM , { 5    , 6    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ASM_TX_ON0},
...
LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_TX_EVENT[] =
{
  /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_ASM  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ASM_TX_ON0 },//PA On
   { /* 1  */ LTE_MIPI_ASM  , { 3    , 3    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_ASM_TX_OFF0},//PA Off
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0              },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band1_MIPI_TX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 19200 /*100 kHz*/    ,0x00 , 0x44}, { 19350 /*100 kHz*/    ,0x00 , 0x44}, { 19500 /*100 kHz*/    ,0x00 , 0x44}, { 19650 /*100 kHz*/    ,0x00 , 0x44}, { 19800 /*100 kHz*/    ,0x00 , 0x44},} }, // PA path sel
   ...
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 19200 /*100 kHz*/    ,0x03 , 0x00}, { 19350 /*100 kHz*/    ,0x03 , 0x00}, { 19500 /*100 kHz*/    ,0x03 , 0x00}, { 19650 /*100 kHz*/    ,0x03 , 0x00}, { 19800 /*100 kHz*/    ,0x03 , 0x00},} }, // Iref
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 19200 /*100 kHz*/    ,0x00 , 0x00}, { 19350 /*100 kHz*/    ,0x00 , 0x00}, { 19500 /*100 kHz*/    ,0x00 , 0x00}, { 19650 /*100 kHz*/    ,0x00 , 0x00}, { 19800 /*100 kHz*/    ,0x00 , 0x00},} }, // PA disable  
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 19200 /*100 kHz*/    ,0x1C , 0x38}, { 19350 /*100 kHz*/    ,0x1C , 0x38}, { 19500 /*100 kHz*/    ,0x1C , 0x38}, { 19650 /*100 kHz*/    ,0x1C , 0x38}, { 19800 /*100 kHz*/    ,0x1C , 0x38},} }, // ASM PM_Trig: normal mode
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 19200 /*100 kHz*/    ,0x00 , 0x08}, { 19350 /*100 kHz*/    ,0x00 , 0x08}, { 19500 /*100 kHz*/    ,0x00 , 0x08}, { 19650 /*100 kHz*/    ,0x00 , 0x08}, { 19800 /*100 kHz*/    ,0x00 , 0x08},} }, // ASM PM_Trig: normal mode
   { /* 7  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_TX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/    ,0x00 , 0x34}, { 17287 /*100 kHz*/    ,0x00 , 0x34}, { 17475 /*100 kHz*/    ,0x00 , 0x34}, { 17662 /*100 kHz*/    ,0x00 , 0x34}, { 17850 /*100 kHz*/    ,0x00 , 0x34},} }, // PA path sel
   ...
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/    ,0x03 , 0x00}, { 17287 /*100 kHz*/    ,0x03 , 0x00}, { 17475 /*100 kHz*/    ,0x03 , 0x00}, { 17662 /*100 kHz*/    ,0x03 , 0x00}, { 17850 /*100 kHz*/    ,0x03 , 0x00},} }, // Iref
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/    ,0x00 , 0x00}, { 17287 /*100 kHz*/    ,0x00 , 0x00}, { 17475 /*100 kHz*/    ,0x00 , 0x00}, { 17662 /*100 kHz*/    ,0x00 , 0x00}, { 17850 /*100 kHz*/    ,0x00 , 0x00},} }, // PA disable
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 17100 /*100 kHz*/    ,0x1C , 0x38}, { 17287 /*100 kHz*/    ,0x1C , 0x38}, { 17475 /*100 kHz*/    ,0x1C , 0x38}, { 17662 /*100 kHz*/    ,0x1C , 0x38}, { 17850 /*100 kHz*/    ,0x1C , 0x38},} }, // ASM PM_Trig: normal mode
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 17100 /*100 kHz*/    ,0x00 , 0x05}, { 17287 /*100 kHz*/    ,0x00 , 0x05}, { 17475 /*100 kHz*/    ,0x00 , 0x05}, { 17662 /*100 kHz*/    ,0x00 , 0x05}, { 17850 /*100 kHz*/    ,0x00 , 0x05},} },
   { /* 7  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_TX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 25700 /*100 kHz*/    ,0x00 , 0x5C}, { 25825 /*100 kHz*/    ,0x00 , 0x5C}, { 25950 /*100 kHz*/    ,0x00 , 0x5C}, { 26075 /*100 kHz*/    ,0x00 , 0x5C}, { 26200 /*100 kHz*/    ,0x00 , 0x5C},} }, // PA path sel               
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 25700  /*100 kHz*/    ,0x01 , 0x00}, { 25825 /*100 kHz*/    ,0x01 , 0x00}, { 25950 /*100 kHz*/    ,0x01 , 0x00}, { 26075 /*100 kHz*/    ,0x01 , 0x00}, { 26200 /*100 kHz*/    ,0x01 , 0x00},} }, // PA On PM_Trig: normal mode
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 25700 /*100 kHz*/    ,0x02 , 0x00}, { 25825 /*100 kHz*/    ,0x02 , 0x00}, { 25950 /*100 kHz*/    ,0x02 , 0x00}, { 26075 /*100 kHz*/    ,0x02 , 0x00}, { 26200 /*100 kHz*/    ,0x02 , 0x00},} }, // Rx: bypass mode
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 25700 /*100 kHz*/    ,0x03 , 0x00}, { 25825 /*100 kHz*/    ,0x03 , 0x00}, { 25950 /*100 kHz*/    ,0x03 , 0x00}, { 26075 /*100 kHz*/    ,0x03 , 0x00}, { 26200 /*100 kHz*/    ,0x03 , 0x00},} }, // PA On PM_Trig: normal mode
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 25700 /*100 kHz*/    ,0x00 , 0x00}, { 25825 /*100 kHz*/    ,0x00 , 0x00}, { 25950 /*100 kHz*/    ,0x00 , 0x00}, { 26075 /*100 kHz*/    ,0x00 , 0x00}, { 26200 /*100 kHz*/    ,0x00 , 0x00},} }, // PA path sel               
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 25700 /*100 kHz*/    ,0x00 , 0x01}, { 25825 /*100 kHz*/    ,0x00 , 0x01}, { 25950 /*100 kHz*/    ,0x00 , 0x01}, { 26075 /*100 kHz*/    ,0x00 , 0x01}, { 26200 /*100 kHz*/    ,0x00 , 0x01},} }, // Iref                      
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },                              
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 18800 /*100 kHz*/    ,0x1C , 0x38}, { 18900 /*100 kHz*/    ,0x1C , 0x38}, { 19000 /*100 kHz*/    ,0x1C , 0x38}, { 19100 /*100 kHz*/    ,0x1C , 0x38}, { 19200 /*100 kHz*/    ,0x1C , 0x38},} }, // PA On PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 18800 /*100 kHz*/    ,0x00 , 0x0F}, { 18900 /*100 kHz*/    ,0x00 , 0x0F}, { 19000 /*100 kHz*/    ,0x00 , 0x0F}, { 19100 /*100 kHz*/    ,0x00 , 0x0F}, { 19200 /*100 kHz*/    ,0x00 , 0x0F},} },
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 18800 /*100 kHz*/    ,0x01 , 0x00}, { 18900 /*100 kHz*/    ,0x01 , 0x00}, { 19000 /*100 kHz*/    ,0x01 , 0x00}, { 19100 /*100 kHz*/    ,0x01 , 0x00}, { 19200 /*100 kHz*/    ,0x01 , 0x00},} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 18800 /*100 kHz*/    ,0x00 , 0x00}, { 18900 /*100 kHz*/    ,0x00 , 0x00}, { 19000 /*100 kHz*/    ,0x00 , 0x00}, { 19100 /*100 kHz*/    ,0x00 , 0x00}, { 19200 /*100 kHz*/    ,0x00 , 0x00},} },
   { /* 4  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_TX_DATA[] =
{
   ...
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 23000 /*100 kHz*/    ,0x00 , 0x6C}, { 23250 /*100 kHz*/    ,0x00 , 0x6C}, { 23500 /*100 kHz*/    ,0x00 , 0x6C}, { 23750 /*100 kHz*/    ,0x00 , 0x6C}, { 24000 /*100 kHz*/    ,0x00 , 0x6C},} }, // PA path sel               
   ...
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 23000 /*100 kHz*/    ,0x02 , 0x00}, { 23250 /*100 kHz*/    ,0x02 , 0x00}, { 23500 /*100 kHz*/    ,0x02 , 0x00}, { 23750 /*100 kHz*/    ,0x02 , 0x00}, { 24000 /*100 kHz*/    ,0x02 , 0x00},} }, // Rx: bypass mode
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 23000 /*100 kHz*/    ,0x03 , 0x00}, { 23250 /*100 kHz*/    ,0x03 , 0x00}, { 23500 /*100 kHz*/    ,0x03 , 0x00}, { 23750 /*100 kHz*/    ,0x03 , 0x00}, { 24000 /*100 kHz*/    ,0x03 , 0x00},} }, // PA enable                 
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 23000 /*100 kHz*/    ,0x00 , 0x00}, { 23250 /*100 kHz*/    ,0x00 , 0x00}, { 23500 /*100 kHz*/    ,0x00 , 0x00}, { 23750 /*100 kHz*/    ,0x00 , 0x00}, { 24000 /*100 kHz*/    ,0x00 , 0x00},} }, // Iref                      
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 24960 /*100 kHz*/    ,0x1C , 0x38}, { 25601 /*100 kHz*/    ,0x1C , 0x38}, { 26300 /*100 kHz*/    ,0x1C , 0x38}, { 26301 /*100 kHz*/    ,0x1C , 0x38}, { 26900 /*100 kHz*/    ,0x1C , 0x38},} }, // PA On PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 24960 /*100 kHz*/    ,0x00 , 0x5C}, { 25445 /*100 kHz*/    ,0x00 , 0x5C}, { 25600 /*100 kHz*/    ,0x00 , 0x5C}, { 25601 /*100 kHz*/    ,0x00 , 0x5C}, { 26900 /*100 kHz*/    ,0x00 , 0x5C},} }, // PA path sel               
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 24960 /*100 kHz*/    ,0x01 , 0x00}, { 25445 /*100 kHz*/    ,0x01 , 0x00}, { 25600 /*100 kHz*/    ,0x01 , 0x00}, { 25601 /*100 kHz*/    ,0x01 , 0x00}, { 26900 /*100 kHz*/    ,0x01 , 0x00},} }, // PA On PM_Trig: normal mode
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 24960 /*100 kHz*/    ,0x02 , 0x00}, { 25601 /*100 kHz*/    ,0x02 , 0x00}, { 26300 /*100 kHz*/    ,0x02 , 0x00}, { 26301 /*100 kHz*/    ,0x02 , 0x00}, { 26900 /*100 kHz*/    ,0x02 , 0x00},} }, // Rx: bypass mode
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 24960 /*100 kHz*/    ,0x03 , 0x00}, { 25601 /*100 kHz*/    ,0x03 , 0x00}, { 26300 /*100 kHz*/    ,0x03 , 0x00}, { 26301 /*100 kHz*/    ,0x03 , 0x00}, { 26900 /*100 kHz*/    ,0x03 , 0x00},} }, // PA On PM_Trig: normal mode
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 24960 /*100 kHz*/    ,0x00 , 0x00}, { 25601 /*100 kHz*/    ,0x00 , 0x00}, { 26300 /*100 kHz*/    ,0x00 , 0x00}, { 26301 /*100 kHz*/    ,0x00 , 0x00}, { 26900 /*100 kHz*/    ,0x00 , 0x00},} }, // PA path sel               
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 24960 /*100 kHz*/    ,0x00 , 0x01}, { 25445 /*100 kHz*/    ,0x00 , 0x01}, { 25600 /*100 kHz*/    ,0x00 , 0x01}, { 25601 /*100 kHz*/    ,0x00 , 0x01}, { 26900 /*100 kHz*/    ,0x00 , 0x01},} }, // Iref                      
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },                              
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_TPC_EVENT[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 1    }, LTE_MIPI_TPC_SET   , US2OFFCNT(8)   },
   { /* 1  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0              },
};
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band1_MIPI_PA_SECTION_DATA[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x44}  , { 0x1 , 0x15} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x26} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x28} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x38} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x38} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x4B} , { 0x3 , 0xCB} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x4D} , { 0x3 , 0xCB} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x44}  , { 0x1 , 0x4E} , { 0x3 , 0xCB} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band2_MIPI_PA_SECTION_DATA_Set2[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         ...
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x00}  , { 0x2 , 0x00} , { 0x3 , 0x00} , { 0x0 , 0x0} , { 0x0 , 0x0}}},//SRS
      }
   },
      ...
      /*8916 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         ...
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1F}  , { 0x2 , 0xB7} , { 0x3 , 0x21} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1F}  , { 0x2 , 0x9C} , { 0x3 , 0x24} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1F}  , { 0x2 , 0xFC} , { 0x3 , 0x20} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1F}  , { 0x2 , 0xBB} , { 0x3 , 0x25} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x1F}  , { 0x2 , 0x8B} , { 0x3 , 0x29} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x00}  , { 0x2 , 0x00} , { 0x3 , 0x00} , { 0x0 , 0x0} , { 0x0 , 0x0}}},//SRS
      }
   },
};
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band3_MIPI_PA_SECTION_DATA[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x34}  , { 0x1 , 0x15} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x26} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x28} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x39} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x39} , { 0x3 , 0xC0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x4C} , { 0x3 , 0xCB} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x5D} , { 0x3 , 0xCB} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x34}  , { 0x1 , 0x5F} , { 0x3 , 0xCB} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x00}  , { 0x1 , 0x00} , { 0x3 , 0x00} , { 0x0 , 0x0} , { 0x0 , 0x0}}},//SRS
      }
   },
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band4_MIPI_PA_SECTION_DATA[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x0c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x0c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x0c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x0c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x0c}  , { 0x2 , 0x2d} , { 0x3 , 0x23} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band38_MIPI_PA_SECTION_DATA[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x23} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x54} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x74} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x85} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0xB5} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0xC8} , { 0x3 , 0x87} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0xD9} , { 0x3 , 0x87} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0xDA} , { 0x3 , 0x87} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x00}  , { 0x1 , 0x00} , { 0x3 , 0x0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},//SRS
      }
   },
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band40_MIPI_PA_SECTION_DATA[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x6C}  , { 0x1 , 0x43} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0x64} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0x85} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0xA5} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0xC5} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0xD6} , { 0x3 , 0x88} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0xD8} , { 0x3 , 0x88} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x6C}  , { 0x1 , 0xD8} , { 0x3 , 0x88} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x00}  , { 0x1 , 0x00} , { 0x3 , 0x0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},//SRS
      }
   },
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band41_MIPI_PA_SECTION_DATA[LTE_MIPI_SUBBAND_NUM_PER_DATA] =
{
   /*8714 KHz*/
   {
      ...
      MIPI_USID_PA0,/*USID*/
      {
         // PAEn=1
         //PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2,...
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x33} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x44} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x55} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x66} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x67} , { 0x3 , 0x80} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x79} , { 0x3 , 0x87} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0x9A} , { 0x3 , 0x87} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x5c}  , { 0x1 , 0xAB} , { 0x3 , 0x87} , { 0x0 , 0x0} , { 0x0 , 0x0}}},
         {{ { 0x0 , 0x00}  , { 0x1 , 0x00} , { 0x3 , 0x0} , { 0x0 , 0x0} , { 0x0 , 0x0}}},//SRS
      }
   },
...
LTE_MIPI_IMM_DATA_TABLE_T LTE_MIPI_ASM_ISOLATION_DATA[] =
{
   ...
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT1 , LTE_REG_W    , MIPI_USID_ASM0   , {0x0  , 0x0C} , WAITUSCNT(0) }, // Broadcast ID, Standard MIPI, PM_TRIG = normal mode
   {LTE_MIPI_END_PATTERN,0,0,0,{0,0},0},
};
