...
static kal_uint8 const NVRAM_EF_BAND_INFO_DEFAULT[] = {
        ...
        0x00, /* recorded_mcc_count for gas_learned_mcc_workingband_table*/
#else /* __FAST_ROAMING_SEARCH__ */
        0x00, /* learned band */      
...
#ifdef __UMTS_R9__
    ,
                      /* r9_cap1: USIME_R9_Cap1
                       * bit 3: eutraSupportOfMFBI
                       */
    0x00 /* eutraSupportOfMFBI: 0x04 supported, 0x00 not supported */
#endif    
};
    ...
    // nvram_ef_vdm_ads_profile_struct
    {
        // nvram_vdm_ads_profile_normal_struct (profile_normal)
        {
            // nvram_vdm_ads_general_profile_struct (general_setting_normal)
            {
                ...
                0x0F,   // ads_delay_enw_resume_ads_timer_length = 15
                0x0,    // reserved1
                0x0     // reserved2
            },
...
{
    {
        /* nvram_ua_struct */
        {
            ...
            0x00004268, // UA_reg_t4_timer = 17000
            ...
            /* VoLTE_Setting_SIP_Force_Use_UDP = 0 */
            /* VoLTE_Setting_SIP_TCP_On_Demand = 1 */
            /* VoLTE_Setting_SIP_TCP_MTU_Size = 1300  */
            0x00, 0x01, 0x0514,
            /* VoLTE_Setting_SIP_TCP_MSS;       // 1200(default)*/
            1200,
...
/* under construction !*/
        ...
        /* nvram_imc_struct */
        {
            ...
            0x00001388, // auto_re_reg_timer = 5000ms (5 sec)
              30*1000,  // auto_re_reg_base_timer = 30 000ms (30 sec)
            1800*1000,  // auto_re_reg_max_timer = 1800 000ms (180 sec)
        ...
        /* pcscf_manual_list? */
            ...
            0x00,                    // ims_roaming_mode = 0 (0:disable, 1:enable, 2:auto)
            0x00,                    // mnc,mcc check for registration (0:disable, 1:enable)                    
            0x00,                    // ims_reg_allowed_at_23g = 0 (0:disable, 1:enable)
            0x00,
            {
...
static nvram_ef_ltecsr_profile_record_struct const NVRAM_EF_LTECSR_PROFILE_DEFAULT[] = 
{
	...
	4, //jbm_jitter_full_offset
        15000, //silence to rrc report threshold
	0, //ltecsr_common_para0
	0, //ltecsr_common_para1
	0, //ltecsr_common_para2
	0, //ltecsr_common_para3
	0 //ltecsr_common_para4
};
#endif /*__MOD_IMC__ */
...
{
    {
#if defined(__SET_VOICE_CENTRIC__)
        0x00,       /* vioce centric */
#elif defined(__SGLTE__) || defined(__DISABLE_CSCALL__) || defined(__DISABLE_SMS__)
...
#if defined(__VOLTE_SUPPORT__) && !defined(__VDP_SET_CS_VOICE_ONLY__)
        ...
        0x01,       /* CS voice only */
#endif
#else /* __VOLTE_SUPPORT__ && !defined(__VDP_SET_CS_VOICE_ONLY__)*/
        0x01,       /* CS voice only */
#endif /* __VOLTE_SUPPORT__ && !defined(__VDP_SET_CS_VOICE_ONLY__)*/
...
//#if defined(__VOLTE_SUPPORT__) && defined(__OP01__)
//        0x08+  // enable 2g afr in test mode for CMCC VoLTE NS-IOT test spec require 2G AFR procedure
//#endif
        ...
        0xFE26,  //lte_to_c2k_rsrp_threshold, -474(qdBm)
        0x0010,  //c2k_to_lte_rsrp_delta. 16(qdB)
	},
};
...
//#endif
	...
	0X20 |
#endif
#if defined(__OP08__) && defined(__IMS_SUPPORT__)
    0X40 |
#endif
    ...
    0x08 |
#endif
#if defined(__MM_IMSI_DETACH_WHEN_MM_CONN_ACTIVE__)
    0x10 |  
#endif

#if defined(__3G_CSG__)
    0x20 |
#endif
...
#if defined(__IS_CONN_PAGING_LOCAL_RE__)
    0x10 | //Default off
#endif

#if defined(__LTE_FAST_POWER_ON_SEARCH__)
    0x20 |
#endif
...
#if (defined(__IC_SLT__) || defined(IC_MODULE_TEST))
        0x02 |
#endif
    
#if defined(__OP09_SIM_LOCK__)
        0x04 |
#endif
    0x08 |  //ERRC_DETECTION_TIMER
    0x00 |  //UMAC_TVM_DECREASE_TRANSMITTED
    0x00 |   //UMAC_TVM_FAVOR_POW_PERF
	...
	/* 14th byte */ 
#if defined(__MM_T3212_PERIOD_SETTING__)
	0x00 |	
#endif

#ifdef __DISABLE_EUTRAN_MEAS_AND_REP_CAP__
    0x02 | //Default turn off disable EUTRAN measurement and reporting capability
#endif
#if defined(__CLEAR_LOCI_WHEN_UICC_RESET__)
    0x04 |
#endif
#if defined(__SAT_LOCATION_INFO_CHANGE_LIMITED_TO_NORMAL_FIRST_TIME__)
    0x08 |
#endif  
    ...
    /* 15th byte */
//#ifdef __NWSEL_BACKUP_RPLMN_IN_AUTO_MODE__
    0x01 |
//#endif
    ...
    0x04 |
#endif
#if defined(__DISABLE_2MIN_MINIMUM_HPPLMN_TIMER__)
    0x08 |
#endif
    0x10 |  //SPEED_CS_FEATURE
#if defined(__OP01__)
    0x20 |
#endif
    ...
    0x02 |
#endif
#if defined(__C2K_OM_SOLUTION1__)
    0x04 |
#endif
#if defined(__RAC_UEMODE_WITHOUT_CONSIDER_VDP__)
    0x08 |
#endif
    //0x10 | //SBP_DATA_SR_RETRY_THROTTLING
#if defined(__EMM_CONN_FAIL_ABNORMAL_B__)
    0x20 |
#endif    
//  0x40 |  //SBP_USER_REQ_NOT_INIT_MM_PROC_WHEN_ABNORMAL_T3212_RUNNING
//  0x80 |  //SBP_USER_REQ_NOT_INIT_GMM_PROC_WHEN_ABNORMAL_T3302_RUNNING
    0x00,
    /*17th Byte*/
    ...
    0x04 |
#endif
    0x08 | //SBP_SEARCH_4G_WHEN_FIRST_PS_ATTACH
#if defined(__DISABLE_BEARER_RSC_ALLOC__)
    0x10 |
#endif
#if defined(__DISABLE_BEARER_RSC_MOD__)
    0x20 |
#endif
#if defined(__EMM_IGNORE_TAC_ALL_ZEROS_CHECK__)
    0x40 |
#endif
#if defined(__4G_BACKGROUND_SEARCH_OPTIMIZATION__)
    0x80 | /* 4G Background Search Optimization in 3G */
#endif
    0x00,
    
    /* 18th byte */
#if defined(__4G_BACKGROUND_SEARCH_OPTIMIZATION__)
    0x01 | /* 4G Background Search Optimization in 2G */
#endif
#if defined(__MM_SKIP_LU_AFTER_CSFB_FOR_EAFR__)	
	0x02 |
#endif
#ifdef UNIT_TEST
    0x00 |
#elif __FAST_ROAMING_SEARCH__
    0x04 |
#endif    
#if defined(__SEARCH_NOT_PREFERRED_AVAILABLE_PLMN__)
    0x08 |
#endif    
#if defined(__MCC_ASSIST_FULLBAND_RAT_SELECTION__)
    0x10 |
#endif
#if defined(__FULLBAND_RAT_ORDER_ON_CUSTOM_SETTING__)
    0x20 |
#endif
#if defined(__REG_HISTORY_FOR_PLMN_SELECTION__)
    0x40 |
#endif
   ...
   0x00,
    ...
    /* 19th byte */
#if defined(__FAST_HPPLMN_SEARCH__)
    0x01 |
#endif
#if defined(__LTE_DISABLE_ENH_CELLSEL__)
    0x02 |
#endif
#if defined(__CLEAR_LOCI_WHEN_REFRESH_FCN__)
    0x04 |
#endif
#if defined(__DRX_TEST_TRACE__)
	0x08 |
#endif
#if defined(__DISABLE_PAGING_RESPONSE_IN_LIMITED_SIM_ME_LOCK__)
	0x10 |
#endif
#if defined(__LTE_FORCE_RX_NESIB_B4_CONN__)
    0x20 |
#endif
  //0x40 | //SBP_DISABLE_LTE_B41
   ...
   /* 20th byte */
#if defined(__SEL_AUTO_MODE_FROM_MANUAL_IF_REFRESH_TYPE_RESET__)
    0x01 |
#endif
#if defined(__SM_DISABLE_PS_SIG_CONN_RETRY_TIMER__)
    0x02 |
#endif
#if defined(__R11_CELL_FACH_LTE_APBCR__)
    0x04 |  //SBP_CELL_FACH_LTE_APBCR
#endif
#if defined(__NWSEL_DO_NOT_SEARCH_NEXT_FOR_REJ_12__)
    0x08 |
#endif
#if defined(__NO_3G_FULL_BAND_SEARCH_DURING_CSFB__)
    0x10 | //SBP_NO_3G_FULL_BAND_SEARCH_DURING_CSFB_REDIR
#endif
	...
	0x40 |
#endif
#if defined(__PREFER_3G_IN_23G_MODE__)
  0x80 | //SBP_PREFER_3G_IN_23G_MODE
#endif
	0x00,
	...
	0x02 |
#endif
 // 0x04 | //LTE_PARTIAL_BAND 
 // 0x08 | //LTE_DISABLE_BW
//#if defined(__GAS_SMART_SCAN__)
    0x10 | /* GAS Smart Scan (Default ON) */
//#endif
#if defined (__SDM_RETRY_IMS_WHEN_IMS_SEND_FAIL__)
    0x20 |
#endif
#if defined(__SIM_RESET_BY_SIM__)
	0x40 |
#endif
    ...
    /* 22nd byte */
#if defined(__IGNORE_INT_CHECK_FOR_DEDICATED_BEARER__)
    0x01 |
#endif
    ...
    0x04 |
#endif
#if defined(__BEFORE_RINGING_CSFB__)
    0x08 |
#endif
  //0x10 | //SBP_SET_FOLLOW_ON_REQUEST_FOR_IMS_PDP
  //0x20 | //SBP_NOT_REPORT_IMS_UL_DATA_STATUS
...
/* 23rd byte */
#if defined (__SBP_VDM_DELAY_ENW_RESUME_ADS__)
    0x01 |
#endif
#if defined(__NWSEL_INCREMENTAL_LTE_DISABLE_FOR_NW_REJ__)
    0x02 |
#endif
#if defined(__MM_DO_NOT_START_FOP_GUARD_TIMER__)
    0x04 |
#endif
#if defined(__EXTRA_FILE_SELECTION_AFTER_SAT_COMMAND__)
    0x08 |
#endif
#if defined(__ALLOW_REGISTRATION_FOR_PPAC_RESTRICTION__)
	0x10 |
#endif
  //0x20 |  //SBP_CUSTOM_FPLMN_USED
#if defined(__DISABLE_MM_SKIP_LU_WHEN_BACK_TO_REGISTERED_LAI__)
	0x40 |
#endif
    ...
    /* 24th byte */
#ifdef __DO_NOT_CLEAR_CS_FPLMN_FOR_RAT_MODE_CHANGE__
    0x01 |
#endif
#if defined(__TELSTRA_BAND_PRIORITY_SEARCH__)
    0x02 |
#endif
#if defined(__CB_CHANNELS_IN_SIM_FIRST__)
	0x04 |
#endif
#if defined (__REL_12_EPLMN_LIST_HANDLING__)
    0x08 |
#endif
    0x00
        }
...
static nvram_ef_sbp_modem_data_config_struct NVRAM_EF_SBP_MODEM_DATA_CONFIG_DEFAULT[] = {
{
   ...
   /*9th Byte  PLMN_SEARCH_ABORT_4G_TIMER_PERIOD*/
    ...
    0x0c,
#endif
   /*10th Byte EUTRAN_DISABLE_TIMER_VALUE */
    0xFF, // 0xFF means no preference, use default 12min.
   /*11th Byte  SS_DISABLE_AFR_TIMER_PERIOD*/
#ifdef __LTE_RAT__
    0x04
#endif
    }
...
*/
...
#if (defined(__UMTS_TDD128_MODE__) && defined(__UMTS_R7__)) || (defined(__SEARCH_ALL_EHPLMN_TOGETHER__))
   {
    ...
    
    {
        ...
        NVRAM_EF_UE_CSG_LIST_TOTAL,
        NVRAM_EF_UE_CSG_LIST_SIZE,
        NVRAM_NORMAL(NVRAM_EF_FF_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_AVERAGE,
        "MR01",
        VER(NVRAM_EF_UE_CSG_LIST_LID)
    },    
#endif
...
#endif /* __TAS_SUPPORT__ || __TAS_FOR_C2K_ONOFF_SUPPORT__ */

#if defined(__CDMA2000_RAT__)
    {
        NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_LID,
        NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_TOTAL,
        NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_SIZE,
        NVRAM_DEFAULT_FUNC(nvram_get_eL1_default_value_to_write),
        NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
        NVRAM_ATTR_MULTIPLE,
        "EL6M",
        VER(NVRAM_EF_EL1_SVLTE_BAND_INDICATOR_LID)
    },
#endif /* __CDMA2000_RAT__ */

    {
	   NVRAM_EF_EL1_GPS_CO_TMS_DATA_LID,
	   NVRAM_EF_EL1_GPS_CO_TMS_DATA_TOTAL,
	   NVRAM_EF_EL1_GPS_CO_TMS_DATA_SIZE,
	   NVRAM_DEFAULT_FUNC(nvram_get_eL1_default_value_to_write),
	   NVRAM_CATEGORY_CALIBRAT | NVRAM_CATEGORY_FUNC_DEFAULT,
	   NVRAM_ATTR_MULTIPLE,
	   "EL6N",
	   VER(NVRAM_EF_EL1_GPS_CO_TMS_DATA_LID)
    },
#endif
...
// RF TIME SEQUENCE INFO. FOR NVRAM
...

    {
        ...
        NVRAM_EF_2G_BA_INFO_TOTAL,
        NVRAM_EF_2G_BA_INFO_SIZE,
        NVRAM_NORMAL(NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER,
        NVRAM_ATTR_MULTIPLE,
        "MT84",
        VER(NVRAM_EF_2G_BA_INFO_LID),
    },
};
