...
public:
...
#if ENABLE(WML)
    bool isWMLDocument() const { return m_documentClasses & WMLDocumentClass; }
#endif
    ...
    */
    ...
    /// M: WML Support
    virtual String conformTextToInputMask(const String& inputText) { return inputText; }
