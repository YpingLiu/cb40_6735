...
#undef MEMORY_LOG
#define MEMORY_LOG(...) __android_log_print(ANDROID_LOG_INFO, "MemoryUsage", __VA_ARGS__)
...
void MemoryCache::dumpStats(Timer<MemoryCache>*)
{
    ...
    MEMORY_LOG("%-13s %-13s %-13s %-13s %-13s %-13s %-13s\n", "", "Count", "Size", "LiveSize", "DecodedSize", "PurgeableSize", "PurgedSize");
    MEMORY_LOG("%-13s %-13s %-13s %-13s %-13s %-13s %-13s\n", "-------------", "-------------", "-------------", "-------------", "-------------", "-------------", "-------------");
#if 0
...
#else
    MEMORY_LOG("%-13s %13d %13d %13d %13d %13d %13d\n", "Images", MEMORY_CACHE_ARGS(s.images));
    ...
    MEMORY_LOG("%-13s %13d %13d %13d %13d %13d %13d\n", "Other", MEMORY_CACHE_ARGS(s.other));

#endif
    MEMORY_LOG("%-13s %-13s %-13s %-13s %-13s %-13s %-13s\n\n", "-------------", "-------------", "-------------", "-------------", "-------------", "-------------", "-------------");

    MEMORY_LOG("Duplication of encoded data from data URLs\n");
    MEMORY_LOG("%-13s %13d of %13d\n", "Images",     s.images.encodedSizeDuplicatedInDataURLs,         s.images.encodedSize);
