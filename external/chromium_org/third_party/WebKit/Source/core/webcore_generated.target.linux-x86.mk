...
$(gyp_intermediate_dir)/UserAgentStyleSheetsData.cpp: $(gyp_shared_intermediate_dir)/blink/core/UserAgentStyleSheetsData.cpp
	mkdir -p $(@D); cp $< $@
$(gyp_intermediate_dir)/WMLNames.cpp: $(gyp_shared_intermediate_dir)/blink/core/WMLNames.cpp
	mkdir -p $(@D); cp $< $@
...
$(gyp_intermediate_dir)/StyleBuilderFunctions.cpp: $(gyp_shared_intermediate_dir)/blink/core/StyleBuilderFunctions.cpp
	mkdir -p $(@D); cp $< $@
$(gyp_intermediate_dir)/WMLElementFactory.cpp: $(gyp_shared_intermediate_dir)/blink/core/WMLElementFactory.cpp
	mkdir -p $(@D); cp $< $@
...
LOCAL_GENERATED_SOURCES := \
	...
	$(gyp_intermediate_dir)/WMLNames.cpp \
	...
	$(gyp_intermediate_dir)/WMLElementFactory.cpp \
