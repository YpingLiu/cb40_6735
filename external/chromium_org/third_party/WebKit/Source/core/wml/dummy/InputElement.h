...
protected:
    ...
    static void parseSizeAttribute(InputElementData&, Element*, const AtomicString&);
    static void parseMaxLengthAttribute(InputElementData&, InputElement*, Element*, const AtomicString&);
