...
WMLRefreshElement::WMLRefreshElement(Document& document)
    : WMLTaskElement(refreshTag, document)
{
}

PassRefPtr<WMLRefreshElement> WMLRefreshElement::create(Document& document)
{
    return adoptRef(new WMLRefreshElement(document));
}
