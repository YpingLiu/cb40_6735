...
public:
    ...
    void setPendingLoadType(FrameLoadType loadType);
    FrameLoadType getPendingLoadType();

    void setPreviuosURL(KURL url) { m_previousURL = url; };
...
private:
    ...
    FrameLoadType m_pendingLoadType;
    KURL m_previousURL;
};
