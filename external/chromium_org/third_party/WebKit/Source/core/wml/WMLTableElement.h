...
public:
    static PassRefPtr<WMLTableElement> create(Document&);
...
private:
    Vector<WMLElement*> scanTableChildElements(WMLElement* startElement, const WMLQualifiedName& tagName) const;
