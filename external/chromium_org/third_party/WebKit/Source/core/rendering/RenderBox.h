...
protected:
    ...
    /// M: Support text-reflow in chromium @{
    mutable int m_visibleWidth;
    mutable bool m_isVisibleWidthChangedBeforeLayout;
    void setVisibleWidth(int newWidth) const;
    bool checkAndSetRelayoutChildren(bool* relayoutChildren) const;
    /// @}
