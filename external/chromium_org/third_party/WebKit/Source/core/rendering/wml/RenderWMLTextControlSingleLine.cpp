...
PassRefPtr<RenderStyle> RenderWMLTextControlSingleLine::createInnerEditorStyle(const RenderStyle* startStyle) const
{
...
LayoutUnit RenderWMLTextControlSingleLine::scrollWidth() const
{
...
LayoutUnit RenderWMLTextControlSingleLine::scrollHeight() const
{
    if (innerEditorElement())
...
LayoutUnit RenderWMLTextControlSingleLine::scrollLeft() const
{
    if (innerEditorElement())
...
LayoutUnit RenderWMLTextControlSingleLine::scrollTop() const
{
    if (innerEditorElement())
...
void RenderWMLTextControlSingleLine::setScrollLeft(LayoutUnit newLeft)
{
    if (innerEditorElement())
        innerEditorElement()->setScrollLeft(newLeft);
}

void RenderWMLTextControlSingleLine::setScrollTop(LayoutUnit newTop)
{
    if (innerEditorElement())
