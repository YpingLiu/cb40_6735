...
#ifndef RenderWMLMenuList_h
#define RenderWMLMenuList_h
...
class RenderWMLMenuList FINAL : public RenderFlexibleBox, private PopupMenuClient {

public:
    RenderWMLMenuList(Element*);
    virtual ~RenderWMLMenuList();
...
private:
    WMLSelectElement* selectElement() const;
    ...
    virtual const char* renderName() const OVERRIDE { return "RenderWMLMenuList"; }
...
DEFINE_RENDER_OBJECT_TYPE_CASTS(RenderWMLMenuList, isMenuList());

}

#endif

#endif // RenderWMLMenuList_h
