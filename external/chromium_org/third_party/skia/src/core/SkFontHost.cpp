...
/// M: for TLS cache
static bool gEnableFontHostTLSCache = false;
...
/// M: for TLS cache @{
void SkFontHost::EnableFontHostTLSCache(bool enable) {
    gEnableFontHostTLSCache = enable;
}

bool SkFontHost::IsEnableFontHostTLSCache() {
    return gEnableFontHostTLSCache;
}
/// @}
