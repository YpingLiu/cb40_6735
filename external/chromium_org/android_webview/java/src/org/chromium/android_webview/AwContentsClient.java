...
public abstract class AwContentsClient {
    ...
    //--------------------------------------------------------------------------------------------
    //             WebView specific methods that map directly to SavePageClient
    //--------------------------------------------------------------------------------------------
    /**
     * abstract method getSaveDir for callback.
     * @param callback the method to set the save dir
     * @param canSaveAsComplete the flag of can we save the page as complete mode
     */
    public abstract void getSaveDir(ValueCallback<String> callback,
                                    boolean canSaveAsComplete);
    /**
     * abstract method onSavePageStart for callback.
     * @param id the id of the save page
     * @param path the path which the website saved
     */
    public abstract void onSavePageStart(int id, String path);
    /**
     * abstract method onSaveProgressChange for callback.
     * @param progress the progress of the save page process
     * @param id the id of the save page
     */
    public abstract void onSaveProgressChange(int progress, int id);
    /**
     * abstract method onSaveFinish for callback.
     * @param flag the flag of the save status
     * @param id the id of the save page
     */
    public abstract void onSaveFinish(int flag, int id);
    //--------------------------------------------------------------------------------------------
