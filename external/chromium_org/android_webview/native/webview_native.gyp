  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'aw_password_handler_delegate_impl.cc',
        'aw_password_handler_delegate_impl.h',
        'aw_pdf_exporter.cc',
        'aw_pdf_exporter.h',
        'aw_picture.cc',
        'aw_picture.h',
    ...
    },
    {
      ...
      'sources': [
          ...
          '../java/src/org/chromium/android_webview/AwPasswordHandler.java',
