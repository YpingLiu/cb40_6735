...
IPC_STRUCT_TRAITS_BEGIN(content::WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(double_tap_factor)   /// M: double tap factor
  ...
  IPC_STRUCT_TRAITS_MEMBER(text_fit_column_to_screen_enabled)   /// M: Support text-reflow in chromium
#endif
IPC_STRUCT_TRAITS_END()
