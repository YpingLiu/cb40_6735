...
namespace cc {
class InputHandler;
/// M: for InterruptableCompletionEvent
class InterruptableCompletionEvent;
}
...
class SynchronousCompositorImpl
 ...
 public:
  ...
  /// M: for InterruptableCompletionEvent @{
  static cc::InterruptableCompletionEvent* GetInterruptableCompletionEvent();
  static void DidBeginMainFrameScheduled();
  static void DidBeginMainFrameStarted();
  static void DidBeginMainFrameEnded();
  static void RunInterruptClosures();
  /// @}
  ...
  virtual void ReleaseHwDraw(bool lost_context) OVERRIDE;
  ...
  void SetViewIsPaused(bool paused);
  /// M: for tab performance
  virtual bool HasContentToDraw();
