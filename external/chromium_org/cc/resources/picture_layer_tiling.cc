...
PictureLayerTiling::PictureLayerTiling(float contents_scale,
  ...
  if (base::SysInfo::IsBrowserProcess()) {
    ...
    soon_border_distance_ = display_info.GetDisplayHeight() * 5;
  } else
    soon_border_distance_ = kSoonBorderDistanceInScreenPixels;
  /// @}
...
void PictureLayerTiling::UpdateTilePriorities(
  ...
  /// M: adjust border distance
  float border = soon_border_distance_ / content_to_screen_scale;
