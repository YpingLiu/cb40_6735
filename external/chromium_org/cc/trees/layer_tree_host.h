...
class CC_EXPORT LayerTreeHost {
 public:
  ...
  /// M: For Optimization @{
  void RegisterPictureLayer(PictureLayer* layer);
  void UnregisterPictureLayer(PictureLayer* layer);
  int GetPictureLayerNum() {
    return picture_layers_.size();
  }
  void PictureLayerUpdated() {
    picture_layer_updated_ = true;
  }
  bool IsPictureLayerUpdated() { return picture_layer_updated_; }

  void RegisterTextureLayer(TextureLayer* layer);
  void UnregisterTextureLayer(TextureLayer* layer);
  int GetTextureLayerNum() {
    return texture_layers_.size();
  }
  /// @}
 ...
 private:
  ...
  /// M: For Optimization @{
  std::vector<PictureLayer*> picture_layers_;
  std::vector<TextureLayer*> texture_layers_;
  bool picture_layer_updated_;
  /// @}
