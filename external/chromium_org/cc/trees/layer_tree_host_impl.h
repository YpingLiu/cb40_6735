...
class LayerTreeHostImplClient {
 public:
  ...
  /// M: For Optimization
  virtual bool HasPendingTreeToActivate() { return true; }

  /// M: For sina flash
  virtual bool IsPendingTreeInManage() { return false; }
...
class CC_EXPORT LayerTreeHostImpl
 ...
 public:
  ...
  virtual void SetViewIsPaused(bool paused) OVERRIDE;
  /// @}
  /// M: for tab performance
  virtual bool HasContentToDraw() OVERRIDE;
