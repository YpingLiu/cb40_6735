...
int ThreadNiceValue(ThreadPriority priority) {
  ...
  /// M: adjust the thread prority for raster thread
  static const int threadPriorityRaster = 6;
  static const int threadPriorityUrgentDisplay = -12;
  ...
  switch (priority) {
    ...
    /// M: adjust the thread prority for raster thread @{
    case kThreadPriority_Raster:
      return threadPriorityRaster;
    /// @}
    case kThreadPriority_Normal:
      return threadPriorityDefault;
    case kThreadPriority_Display:
      return threadPriorityDisplay;
    case kThreadPriority_UrgentDisplay:
      return threadPriorityUrgentDisplay;
    default:
