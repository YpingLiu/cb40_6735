...
LANG_SOURCE = af.txt agq.txt ak.txt am.txt\
 ...
 ks_Arab.txt ksb.txt ksf.txt kw.txt ky.txt\
 ky_Cyrl.txt lag.txt lg.txt lkt.txt ln.txt\
 lo.txt lt.txt lu.txt luo.txt luy.txt\
 lv.txt mas.txt mer.txt mfe.txt mg.txt\
 mgh.txt mgo.txt mk.txt ml.txt mn.txt\
 mn_Cyrl.txt mr.txt ms.txt ms_Latn.txt mt.txt\
 mua.txt my.txt my_ZG.txt naq.txt nb.txt nd.txt\
 ne.txt nl.txt nl_BE.txt nmg.txt nn.txt\
 nnh.txt nus.txt nyn.txt om.txt or.txt\
 pa.txt pa_Arab.txt pa_Arab_PK.txt pa_Guru.txt pl.txt\
 ...
 ru_UA.txt rw.txt rwk.txt saq.txt sbp.txt\
 seh.txt ses.txt sg.txt shi.txt shi_Latn.txt\
 shi_Tfng.txt shi_Tfng_MA.txt si.txt sk.txt sl.txt\
 ...
 uz_Cyrl.txt uz_Latn.txt uz_Latn_UZ.txt vai.txt vai_Latn.txt\
 vai_Latn_LR.txt vai_Vaii.txt vi.txt vun.txt xog.txt\
 yav.txt yo.txt yo_BJ.txt zgh.txt zh.txt\
