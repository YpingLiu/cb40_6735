...
LOCAL_C_INCLUDES += \
	...
	$(TOP)/$(MTK_ROOT)/frameworks/av/include/drm
LOCAL_SHARED_LIBRARIES += libdrmmtkutil
endif

LOCAL_C_INCLUDES += $(TOP)/$(MTK_ROOT)/external/midiSeektable

LOCAL_STATIC_LIBRARIES := libMST
