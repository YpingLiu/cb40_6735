...
public class HttpURLConnectionImpl extends HttpURLConnection {
  ...
  private HttpEngine getResponse() throws IOException {
    ...
    ///M: avoid blocking connection time
    long stopTime = System.currentTimeMillis() + 4 * 60 * 1000;
...
///M: Support Telcel Requirement @{
        try {        
            String tmpLocation = getHeaderField("Location");
            Socket.notifyHttpRedirect(tmpLocation);
        } catch (Exception e) {
