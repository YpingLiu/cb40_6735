...
PRODUCT_PACKAGES += MTKSystemInfo
...
# meta tool
PRODUCT_PROPERTY_OVERRIDES += ro.mediatek.version.branch=L1.MP3.EE.WFC.DEV
...
#ifeq (true,$(WITH_DEXPGO))
ifeq (true,$(MTK_ARTSLIM_ENABLE))
# ART PGO app list
$(call add-product-dex-preopt-module-config,Email,--profile-file=art/profile/com.android.email)
$(call add-product-dex-preopt-module-config,Gallery2,--profile-file=art/profile/com.android.gallery3d)
$(call add-product-dex-preopt-module-config,Exchange2,--profile-file=art/profile/com.android.exchange)
$(call add-product-dex-preopt-module-config,EngineerMode,--profile-file=art/profile/com.mediatek.engineermode)
$(call add-product-dex-preopt-module-config,Mms,--profile-file=art/profile/com.android.mms)
endif
