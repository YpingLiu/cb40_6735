...
# PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/simcom/sim6735m_35c_a_l1/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif
...
# thermal policy
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/thermal.conf:system/etc/.tp/thermal.conf
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/thermal.off.conf:system/etc/.tp/thermal.off.conf
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/ht120.mtc:system/etc/.tp/.ht120.mtc
...
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/sim6735m_35c_a_l1/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/sim6735m_35c_a_l1/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/sim6735m_35c_a_l1/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/sim6735m_35c_a_l1/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/sim6735m_35c_a_l1/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png

#media_codecs.xml for video codec support
PRODUCT_COPY_FILES += device/simcom/sim6735m_35c_a_l1/media_codecs.xml:system/etc/media_codecs.xml

# overlay has priorities. high <-> low.

DEVICE_PACKAGE_OVERLAYS += device/mediatek/common/overlay/sd_in_ex_otg

DEVICE_PACKAGE_OVERLAYS += device/simcom/sim6735m_35c_a_l1/overlay
