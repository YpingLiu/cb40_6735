...
std::ostream& operator<<(std::ostream& os, const MIROptimizationFlagPositions& rhs) {
  switch (rhs) {
    ...
    case kMIRNullCheckOnly: os << "MIRNullCheckOnly"; break;
    case kMIRIgnoreRangeCheck: os << "MIRIgnoreRangeCheck"; break;
    case kMIRRangeCheckOnly: os << "MIRRangeCheckOnly"; break;
    case kMIRIgnoreClInitCheck: os << "MIRIgnoreClInitCheck"; break;
...
std::ostream& operator<<(std::ostream& os, const ExtendedMIROpcode& rhs) {
  switch (rhs) {
    ...
    case kMirOpCheckPart2: os << "MirOpCheckPart2"; break;
...
std::ostream& operator<<(std::ostream& os, const FixupKind& rhs) {
  switch (rhs) {
    ...
    case kFixupPushPop: os << "FixupPushPop"; break;
...
std::ostream& operator<<(std::ostream& os, const LIRPseudoOpcode& rhs) {
  switch (rhs) {
    ...
    case kPseudoMethodEntry: os << "PseudoMethodEntry"; break;
    case kPseudoMethodExit: os << "PseudoMethodExit"; break;
