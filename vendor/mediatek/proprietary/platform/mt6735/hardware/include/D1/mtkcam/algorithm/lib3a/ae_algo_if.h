...
public:
     ...
     * @param [out] a_StrobeAEPlineTable strobe AE Pline table pointer; please refer to camera_custom_AEPlinetable.h
     */    
    virtual MRESULT getPlineTable(strAETable &a_PrvAEPlineTable, strAETable &a_CapAEPlineTable, strAETable &a_StrobeAEPlineTable) = 0;
    /**  
     * @brief get AE preview and capturePline table information
     * @param [out] eTableID table ID for search; please refer to camera_custom_AEPlinetable.h
     * @param [out] a_AEPlineTable current AE Pline table pointer; please refer to camera_custom_AEPlinetable.h
     */        
    virtual MRESULT getOnePlineTable(eAETableID eTableID, strAETable &a_AEPlineTable) = 0;
    /**  
    ...
    */        
     ...
     * @param [out] pAEHistogram AE histgoram value pointer
    */
    virtual MRESULT getAESWHdrInfo(SW_HDR_AE_INFO_T &rSWHdrInfo) = 0;
    /**
