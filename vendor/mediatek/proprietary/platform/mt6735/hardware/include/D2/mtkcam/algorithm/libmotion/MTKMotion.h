...
struct MTKMotionTuningPara
{
    ...
    MINT32  DirDecideRatioMvX;          // 1~100, threshold ratio for when to decide and fix the direction after first image
    MINT32  DirDecideRatioMvY;          // 1~100, threshold ratio for when to decide and fix the direction after first image
};
