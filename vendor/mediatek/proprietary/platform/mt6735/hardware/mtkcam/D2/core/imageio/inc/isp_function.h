...
#include "camera_isp_D2.h" //For Isp function ID
...
//interrupt timeout time (for supporting manual long exposure time control)
#define CAM_INT_WAIT_TIMEOUT_MS 10000
#define CAM_INT_PASS2_WAIT_TIMEOUT_MS 10000
...
class IspDrvShell:virtual public IspDrv_B
{
    ...
    public://commandQ operation
        ...
        //tpipe
        IMEM_BUF_INFO tpipeBufInfo[ISP_DRV_CQ_NUM];
};
...
public: //isp driver operation
    ...
    /**
      *@brief  Dump register
      */
    inline int dumpRegister( int mode ){ (void)mode; return (int)m_pPhyIspDrv->dumpReg();}
...
protected:
    ...
    virtual int     _write2CQ( int cq ) { (void)cq; return 0;}
...
public: /*[IspFunction_B]*/
    ...
    /**
      ...
      */
    virtual int checkBusy( unsigned long* param ){ (void)param; return 0;}
private: /*[IspFunction_B]*/
    ...
    /**
      *@brief  Enable
      */
    virtual int _enable( void* pParam ){ (void)pParam; return 0;}
