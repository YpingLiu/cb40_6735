...
public:
    /////
    static ZSDScenario*     createInstance(EScenarioFmt rSensorType, MUINT32 const &dev, ERawPxlID const &bitorder);
    virtual MVOID           destroyInstance();
    virtual                 ~ZSDScenario();

protected:
                            ZSDScenario(EScenarioFmt rSensorType, MUINT32 const &dev, ERawPxlID const &bitorder);
...
public:
    ...
    virtual MBOOL           deque(EHwBufIdx port, vector<PortQTBufInfo> *pBufIn, bool triggerAEE = true);
...
private:
            ...
            MBOOL           unmapPhyAddr( MUINT32 size, MINT32 id, MUINTPTR va,
                                        MINT32 secu, MINT32 cohe, MUINTPTR& pa );
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Data Members.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
