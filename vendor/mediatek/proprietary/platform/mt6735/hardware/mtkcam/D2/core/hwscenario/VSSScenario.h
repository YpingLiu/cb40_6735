...
public:
    /////
    static VSSScenario*     createInstance(EScenarioFmt rSensorType, MUINT32 const &dev, ERawPxlID const &bitorder);
    virtual MVOID           destroyInstance();
    virtual                 ~VSSScenario();

protected:
                            VSSScenario(EScenarioFmt rSensorType, MUINT32 const &dev, ERawPxlID const &bitorder);
