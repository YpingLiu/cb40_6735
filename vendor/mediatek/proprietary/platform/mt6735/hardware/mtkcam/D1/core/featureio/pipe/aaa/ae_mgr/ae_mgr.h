...
public:
    ...
    // Manual control
    MRESULT setShutterValue(int value); 
    MINT32  getShutterValue(); 
    MRESULT getMShutterCaptureParams(AE_MODE_CFG_T &a_rCaptureInfo);
    // CCT feature APIs.
...
private:
    ...
    MRESULT startSensorPerFrameControl(MUINT32 uTestidx);
