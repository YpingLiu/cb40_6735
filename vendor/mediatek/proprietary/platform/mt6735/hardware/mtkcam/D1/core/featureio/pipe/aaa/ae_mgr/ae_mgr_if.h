...
public:
    ...
    */    
	...
	/**
     * @brief switch Capture different EV value
     * @param [in] i4SensorDev sensor device; please refer to ESensorDev_T in isp_tuning.h
     * @param [in] iDiffEV different EV (1 = 0.1 EV)
     * @param [out] strAEOutput pointer Y value
    */
    MRESULT switchCapureDiffEVState(MINT32 i4SensorDev, MINT8 iDiffEV, strAEOutput &aeoutput);
	
	/**
     * @brief save AE manager information
     * @param [in] i4SensorDev sensor device; please refer to ESensorDev_T in isp_tuning.h
     * @param [in] fname file name
    */    
    MBOOL SaveAEMgrInfo(MINT32 i4SensorDev, const char * fname);
    /**
    ...
    */    
    ...
    /**
     * @brief : set shutter value dirrectly
     * @param : [in] input is sensor device id and shutter value
    */    
    MRESULT setShutterValue(MINT32 i4SensorDev, MINT32 i4ShutterValue);
    /**
     * @brief : get manual shutter information dirrectly
     * @param : [in]  input  is sensor device id
     * @param : [out] output is exposure setting structure
    */ 
    MVOID getMShutterCaptureParams(MINT32 i4SensorDev, AE_MODE_CFG_T &a_rCaptureInfo);
    /**
     * @brief : get shutter value dirrectly
     * @param : [in]  input  is sensor device id and return shutter value
    */ 
    MINT32  getShutterValue(MINT32 i4SensorDev);
