...
class AudioALSAStreamManager
{
    public:
        ...
        status_t routingOutputDevice(const audio_devices_t current_output_devices, audio_devices_t output_devices);
         ...
         */
        status_t setAllOutputStreamsSuspend(const bool suspend_on);
        status_t setAllInputStreamsSuspend(const bool suspend_on);
        status_t setAllStreamsSuspend(const bool suspend_on);


        /**
         * standby all input/output stream
         */
        status_t standbyAllOutputStreams();
        status_t standbyAllInputStreams();
        status_t standbyAllStreams();
