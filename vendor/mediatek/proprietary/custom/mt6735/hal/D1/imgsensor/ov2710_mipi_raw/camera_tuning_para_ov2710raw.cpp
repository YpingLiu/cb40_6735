...
#include "camera_AE_PLineTable_ov2710raw.h"
#include "camera_info_ov2710raw.h"
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            7330000, -1602500, -612500, -1122500, 6622500, -380000, -637500, -4245000, 10005000
        },
        {  // i4P10[9]
            1020609, -1308869, 278613, -133805, -312265, 438077, 231496, 1001332, -1247884
        },
        {  // i4P01[9]
            756124, -880166, 121971, -226967, -634927, 865447, -102193, -437854, 535246
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rCCTConfig
        {
            ...
            TRUE,    // bEnableAntiOverExposure  edit by 20151209
            TRUE,    // bEnableTimeLPF
            ...
            55,    // u4AETarget    edit by 20151209
            47,    // u4StrobeAETarget
            50,    // u4InitIndex
            4,    // u4BackLightWeight
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    297,    // PCloudyRightBound
                    122,    // PCloudyLeftBound
                    -296,    // PCloudyUpperBound
                    -425    // PCloudyLowerBound
                },
                // Shade
                {
                    397,    // PShadeRightBound
                    122,    // PShadeLeftBound
                    -296,    // PShadeUpperBound
                ...
                // Warm fluorescent
                {
                    -169,    // PWFluoRightBound
                    -369,    // PWFluoLeftBound
                    -306,    // PWFluoUpperBound
                    -520    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -169,    // PIncaRightBound
