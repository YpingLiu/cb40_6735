...
//                MtkCameraParameters::EFFECT_F1977 ,
...
#endif
    //==========================================================================
#if defined(ACER_Z630)	//acer camera 3.2
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "1600x1200",     "2048x1536",    "2560x1920",    "3264x2448",
                "1280x720",      "1792x1008",	 "2560x1440",	 "3328x1872",
            )
        ),
    )
#else
...
else
{
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "480x320",      "640x480",
                "720x480",	"864x480",      "1280x720",     "1280x736",	"1920x1088",
            )
        ),
    )
#else
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::CAPTURE_MODE_ASD_SHOT,
                   ...
                   #endif
                #if defined(ACER_Z630)	//acer camera 3.2
                MtkCameraParameters::CAPTURE_MODE_BRIGHT_MAGIC,	//qiaoxiujun,bright magic mode
                #endif
            )
        ),
    )
