 ...
 *
 * Send call control by SIM alpha id to show the
 * message.
 *
 */
...
#define RIL_REQUEST_DEACTIVATE_LINK_DOWN_PDN (RIL_REQUEST_VENDOR_BASE + 126)
///@}
/// M: IMS feature. @{
#define RIL_REQUEST_HOLD_CALL (RIL_REQUEST_VENDOR_BASE + 127)
/// @}

/// M: [C2K][SVLTE] Set the STK UTK mode. @{
#define RIL_REQUEST_SET_STK_UTK_MODE (RIL_REQUEST_VENDOR_BASE + 128)
/// M: [C2K][SVLTE] Set the STK UTK mode. @}

#define RIL_REQUEST_SWITCH_ANTENNA (RIL_REQUEST_VENDOR_BASE + 129)
/// M: [C2K] Switch ruim to sim or sim to ruim @{
#define RIL_REQUEST_SWITCH_CARD_TYPE (RIL_REQUEST_VENDOR_BASE + 130)
/// @}

/// M: [C2K] Enable or disable MD3 Sleep @{
#define RIL_REQUEST_ENABLE_MD3_SLEEP (RIL_REQUEST_VENDOR_BASE + 131)
/// @}
...
#define RIL_LOCAL_REQUEST_VSIM_NOTIFICATION (RIL_LOCAL_REQUEST_VENDOR_BASE + 9)
#define RIL_LOCAL_REQUEST_VSIM_OPERATION (RIL_LOCAL_REQUEST_VENDOR_BASE + 10)
...
#define RIL_UNSOL_CNAP (RIL_UNSOL_VENDOR_BASE + 44)
/* M: call control part end */
...
/// M: not used in GSM, just here for keep order
...
/// M: For 3G VT only @{
#define RIL_UNSOL_VT_STATUS_INFO (RIL_UNSOL_VENDOR_BASE + 68)
#define RIL_UNSOL_VT_RING_INFO (RIL_UNSOL_VENDOR_BASE + 69)
/// @}

//External SIM [Start]
#define RIL_UNSOL_VSIM_OPERATION_INDICATION (RIL_UNSOL_VENDOR_BASE + 70)
//External SIM [End]
