...
*/
#ifdef MTK_C2K_DATA_PPP_SUPPORT
#define DATA_AT_CHANNEL RIL_CHANNEL_1
#define MISC_AT_CHANNEL RIL_CHANNEL_1
#else
#define DATA_AT_CHANNEL RIL_CHANNEL_2
#define MISC_AT_CHANNEL RIL_CHANNEL_3
#endif
    ...
    {RIL_REQUEST_LAST_CALL_FAIL_CAUSE, dispatchVoid, responseInts, RIL_CHANNEL_1},
    ...
    {RIL_REQUEST_STK_SET_PROFILE, dispatchString, responseVoid, RIL_CHANNEL_3},
    {RIL_REQUEST_STK_SEND_ENVELOPE_COMMAND, dispatchString, responseString, RIL_CHANNEL_1},
    {RIL_REQUEST_STK_SEND_TERMINAL_RESPONSE, dispatchString, responseVoid, RIL_CHANNEL_3}, //70
    ...
    {NULL,NULL,NULL, RIL_CHANNEL_1},    //132~145 Todo: Replace ingenic commands with null now,
    ...
    {RIL_REQUEST_ENABLE_MD3_SLEEP, dispatchInts, responseVoid, RIL_CHANNEL_1},	 //244: 2131
#endif
