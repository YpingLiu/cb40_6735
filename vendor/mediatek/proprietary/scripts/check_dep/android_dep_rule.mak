...
ifeq (yes, $(strip $(MTK_HETCOMM_SUPPORT)))
  ifneq (yes, $(strip $(MTK_LTE_SUPPORT)))
    $(call dep-err-ona-or-offb, MTK_LTE_SUPPORT, MTK_HETCOMM_SUPPORT)
  endif
endif
...
ifeq (OP09_SPEC0212_SEGDEFAULT,$(OPTR_SPEC_SEG_DEF))
  ifneq (yes,$(strip $(MTK_DEVREG_APP)))
    $(call dep-err-common,pelease set OPTR_SPEC_SEG_DEF as non OP09_SPEC0212_SEGDEFAULT or turn on MTK_DEVREG_APP)
  endif
  ifneq (yes,$(strip $(MTK_CT4GREG_APP)))
    $(call dep-err-common,pelease set OPTR_SPEC_SEG_DEF as non OP09_SPEC0212_SEGDEFAULT or turn on MTK_CT4GREG_APP)
  endif
  ifneq (yes,$(strip $(MTK_CTPPPOE_SUPPORT)))
    $(call dep-err-common,pelease set OPTR_SPEC_SEG_DEF as non OP09_SPEC0212_SEGDEFAULT or turn on MTK_CTPPPOE_SUPPORT)
  endif
  ifeq (yes,$(strip $(MTK_FLIGHT_MODE_POWER_OFF_MD)))
  ...
  ifeq (yes,$(strip $(MTK_WORLD_PHONE)))
...
ifneq (yes,$(strip $(MTK_IRAT_SUPPORT)))
  ifeq (yes,$(strip $(MTK_MD_IRAT_SUPPORT)))
    $(call dep-err-ona-or-offb, MTK_IRAT_SUPPORT, MTK_MD_IRAT_SUPPORT)
  endif
endif
##############################################################
ifneq (yes,$(strip $(MTK_SVLTE_SUPPORT)))
  ifeq (yes,$(strip $(MTK_IRAT_SUPPORT)))
    $(call dep-err-ona-or-offb, MTK_SVLTE_SUPPORT, MTK_IRAT_SUPPORT)
  endif
endif
##############################################################
...
#######################################################
ifneq (yes,$(strip $(TRUSTONIC_TEE_SUPPORT)))
  ifeq (yes,$(strip $(MTK_TEE_TRUSTED_UI_SUPPORT)))
    $(call dep-err-ona-or-offb, TRUSTONIC_TEE_SUPPORT,MTK_TEE_TRUSTED_UI_SUPPORT)
  endif
endif
#######################################################
ifeq (yes,$(CT6M_SUPPORT))
  ifneq (yes,$(strip $(MTK_C2K_SLOT2_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_C2K_SLOT2_SUPPORT,CT6M_SUPPORT)
  endif
  ifneq (yes,$(strip $(MTK_DEVREG_APP)))
    $(call dep-err-ona-or-offb,MTK_DEVREG_APP,CT6M_SUPPORT)
  endif
  ifneq (yes,$(strip $(MTK_CT4GREG_APP)))
    $(call dep-err-ona-or-offb,MTK_CT4GREG_APP,CT6M_SUPPORT)
  endif
endif
