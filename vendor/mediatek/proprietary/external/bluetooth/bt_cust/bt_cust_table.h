...
const bt_config_item g_config_table[] = {
    ...
    /*********************************************
    *  range : 0~1 (default: 0)
    *  0     : Let host to decide
    *  1     : Always request to be master when accept link req
    **********************************************/ 
    {
        .name = "acceptConnRoleSwitchReq",
        .value = (void*)0,
    },
    {
    ...
    *  Bit 2 : HSP(HS) support
    *  Bit 3 : HFP(HF) support    
    **********************************************/      
    {
        .name = "HFPSupportMask",
#ifdef __BT_WEARABLE_SETTINGS__          
        .value = (void*)15,
#else
        .value = (void*)11,
#endif        
    ...
    **********************************************/    
    {
        .name = "HFPInBandRingtone",
        .value = (void*)0,
    },     
    /*********************************************
    *  range : 0~3000 (default: 0 ms)
    **********************************************/     
    {
        .name = "HFPSCODelayTimeout",
        .value = (void*)0,
    },
	/*********************************************
	*  range : 0~3000 (default: 0 ms)
	*  note : In order to keep the SCO disconnect execute
	*         after SCO connect, select a larger number
	*         than HFPSCODelayTimeout.
	**********************************************/ 	
	{	
		.name = "HFPSCODiscDelayTimeout",
		.value = (void*)0,
	},
    {   
        .name = "30HSSupported",
    ...
    },
    {
        ...
        .value = (void*)1,
#else
        .value = (void*)1, // Temporarily enable LE feature.
#endif
    },
    {
    ...
    {
        .name = "LEBGInitiateInterval",    /* slot (0x625) */
        #ifdef __USE_CUST_INT_WIN__
        .value = (void*)0x50,
        #else
        .value = (void*)0x0800,
    ...
    **********************************************/    
    ...
    /*********************************************
    *  TX Power mapping table for the LE multi-adv.     
    *  range : 70~ 20
    *  Unit = dbm  
    **********************************************/    
    {
        .name = "LEMulitAdvTxPower",    
        .value = (void *)(int[]){-21, -15, -7, 1, 9},
    }, 
    {
        ...
        *******************************************************/
    {
        .name = "ClassOfDevice",
#ifdef __BT_WEARABLE_SETTINGS__        
        .value = (void*){0x002E0704},
#else
        .value = (void*){0x005A020C},  /*default cod=0x004A020C add OPP support 0x005A020C*/
#endif
    },
    {
		.name = "L2capLowPriorityMaxAcceptTimeoutMs",
		.value = (void *)500,
    },
    {
        .name = "ManufactureID",
        .value = (void*)0x0046,  /* 0x0046 MediaTek Inc. */
    },
    {
        .name = "ProductID",
        .value = (void*)0x0802,  /* Vendor specific */
    },
    {
        .name = "AvrcpTgVersion",
        .value = (void*)0x0013,  /* Vendor specific */
    },
    {
        .name = "AvrcpAbsVolume",
        .value = (void*)0x0001,  /* Vendor specific */
    },    
    /*default BtSnoopPath.value=0  /data/@btmtk folder
              otherwise, BtSnoopPath.value=($FilePath) such as: (void *)"/sdcard/mtklog/" */
    {
        .name = "BtSnoopPath",
        .value = (void*)0,             
    },
    {
        .name = "TC1FeatureSupport",
#ifdef __BT_USE_CUST_TC1__
        .value = (void*)1,
#else
        .value = (void*)0,
#endif
    ...
    {
        .name = "SCMS-T",
        .value = (void*)1,  /* 0: disable, non 0: enable, default 1 */
    },
    ...
    **********************************************/      
    {
    	.name = "EnableLEScanDupFilter",
		.value = (void *)1,
    },	
    {
        .name = "DisconnectACLLink",    
        .value = (void*)3000,
    },
    {
        /* Set default to 10 mins */
        .name = "LERotateAddrTO",    
        .value = (void*)900,
    },
    /*********************************************
    *  OPP throughput limited switch.
    *  range : 0~1 (default: 0)
    *  0     : Disabled OPP throughput limited function.
    *  1     : Enable OPP throughput limited function.
    **********************************************/
    {
        .name = "EnableOPPThroughputLimited",
#ifdef __OPP_THROUGHPUT_LIMITING_FEATURE__
        .value =(void *)1,
#else
        .value =(void *)0,
#endif
    ...
    /*default A2dpPcmDumpPath.value=0  /data/@btmtk folder
              otherwise, BtSnoopPath.value=($FilePath) such as: (void *)"/sdcard/mtklog/" */
    {
        .name = "A2dpPcmDumpPath",
        .value = (void*)0,
    },
};
