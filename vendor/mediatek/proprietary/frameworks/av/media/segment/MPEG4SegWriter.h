...
#ifndef MPEG4_SEG_WRITER_H_

#define MPEG4_SEG_WRITER_H_
...
class MPEG4SegWriter : public MediaWriter {
public:
    MPEG4SegWriter(const char *filename);
    MPEG4SegWriter(int fd);
    ...
    // qidongran add
    void switchNewSegmentedVideo(int fd);
    // qidongran add

protected:
    virtual ~MPEG4SegWriter();
...
private:
    ...
    int  mswitchFd;
    bool mRestart;
    bool mAudiotrackRestart;
    bool mtrackRestart;
    bool mAudioDone;
    bool mVedioDone;
    int vediosamplecount;
    int audiosamplecount;
    sp<MetaData> mRestartParam;
    int64_t mStartTimestampUs_Restart;
    bool mTrackRestartDone;
    // qidongran add
    ...
    bool getflagRestart();
    void setflagTrackRestart(bool flag);
    bool getflagTrackRestart();
    void setflagAudioTrackRestart(bool flag);
    bool getflagAudioTrackRestart();
    void setflagAudioDone(bool flag);
    bool getflagAudioDone();
    void setflagVedioDone(bool flag);
    bool getflagVedioDone();
    // qidongran add
    void setStartTimestampUs(int64_t timeUs);
    int64_t getStartTimestampUs();  // Not const
    // qidongran add
    int64_t getStartTimestampUsRestart();  // Not const
    void setStartTimestampUsRestart(int64_t timeUs);
    void writeMoovBoxforRestart();
    void ResetStartTimestampUs(int64_t timeUs);
    // qidongran add
    ...
    MPEG4SegWriter(const MPEG4SegWriter &);
    MPEG4SegWriter &operator=(const MPEG4SegWriter &);
#ifdef MTK_AOSP_ENHANCEMENT
public:
...
private:
	void		init();
	void		releaseEx();  // release in ~MPEG4SegWriter
...
private:
	...
	friend class VideoSegQualityController;
	VideoSegQualityController *mVideoQualityController;
	void		notifyEstimateSize(int64_t nTotalBytesEstimate);
#ifdef USE_FILE_CACHE
	friend class MPEG4SegFileCacheWriter;
	MPEG4SegFileCacheWriter *mCacheWriter;
