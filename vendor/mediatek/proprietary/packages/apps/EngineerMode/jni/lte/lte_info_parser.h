...
//#endif
   ...
   ERRC_EM_INFO_END = ERRC_EM_ERRC_KPI_INFO,
   ...
   EM_CSR_STATUS_IND,
    EM_TDD_TAS_INFO_IND = 495,
    EM_GSM_TAS_INFO_IND = 950,
   NUM_OF_EM_INFO
} em_info_enum;
...
typedef struct
{
    kal_uint32 on_duration_timer_index;
    kal_uint32 drx_inactivity_timer_index;
    kal_uint32 drx_retx_timer_index;
    kal_uint32 long_drx_cycle_index;
    kal_uint32 short_drx_cycle_index;
